...
::: conceito
titulo: O que é e do que depende
texto: |
  Pressão arterial (PA) é a força que o sangue exerce contra a parede das artérias.

  Dois valores são registrados a cada medida:

  - **Sistólica (PAS)**: o pico de pressão durante a ejeção ventricular.
  - **Diastólica (PAD)**: o menor valor, imediatamente antes da sístole seguinte.

  A diferença entre elas é a **pressão diferencial** (ou amplitude de pulso), habitualmente entre 30 e 60 mmHg. Amplitude reduzida ("pressão convergente") aparece em hipovolemia, estenose aórtica, tamponamento e insuficiência cardíaca grave. Amplitude aumentada ("pressão divergente") aparece em insuficiência aórtica, hipertireoidismo, fístula arteriovenosa e enrijecimento senil da aorta.

  Os determinantes da PA são o débito cardíaco e a resistência periférica, modulados pela elasticidade dos grandes vasos, pela volemia e pela viscosidade do sangue. Por isso a queda da PA na hemorragia e na desidratação, e a elevação da PAS isolada no idoso com aorta pouco complacente.

  **A PA não é um número fixo.** É uma variável fisiológica contínua, que muda ao longo do dia (ritmo circadiano, com queda de cerca de 10% durante o sono), com a postura, a emoção, a dor, o esforço e a refeição. A ideia popular de "12 por 8" como valor ideal não tem base científica: o que interessa é a curva pressórica, e ela só se aproxima do valor verdadeiro quando a aferição é repetida.

  O método indireto é impreciso por natureza: aceita-se margem de erro em torno de 8 mmHg, e a PAS obtida por ausculta é, em média, 3 a 4 mmHg menor que a intra-arterial. O papel do examinador é não acrescentar erro a esse erro.

  Quando PAS e PAD caem em faixas diferentes da tabela de classificação, vale sempre a categoria mais alta.
:::
...
observar: |
  Fases de Korotkoff: I (surgimento de som claro, em pancada), II (batimentos com murmúrio), III (murmúrio desaparece e os batimentos ficam mais nítidos), IV (abafamento súbito) e V (silêncio).

  Se os sons persistirem até zero — comum em gestantes, anemia grave e estados hipercinéticos —, use a fase IV como diastólica e registre os três números, por exemplo 150 × 70 × 0 mmHg.

  Durante a fase I, atente à intensidade dos batimentos: alternância de um som forte e um fraco sugere pulso alternante (disfunção ventricular esquerda); desaparecimento dos sons na inspiração sugere pulso paradoxal.

  No idoso, meça em decúbito, sentado e em pé, pela frequência de hipotensão ortostática. A queda superior a 20 mmHg na PAS ou 10 mmHg na PAD após 3 minutos em pé caracteriza hipotensão postural. Se a artéria radial continuar palpável com o manguito insuflado acima da sistólica (sinal ou manobra de Osler), considere pseudo-hipertensão — lembrando que a sensibilidade e a especificidade dessa manobra são baixas.
:::
...
::: perola
texto: |
  Nunca pule o método palpatório. Até 20% dos idosos hipertensos têm **hiato auscultatório**: os sons somem no fim da fase I e reaparecem depois, num intervalo que pode chegar a 30 a 40 mmHg. Quem insufla só até "parar de ouvir" registra uma sistólica falsamente baixa (ou uma diastólica falsamente alta). Como o pulso distal persiste durante o hiato, estimar a sistólica pela palpação antes de auscultar resolve o problema em dez segundos.

---
titulo: Temperatura e frequência respiratória
ordem: 3
tags:
  - sinais vitais
  - temperatura
...
::: tabela
titulo: Valores normais da temperatura corporal por local de aferição
colunas: ["Local", "Faixa normal", "Observação"]
linhas:
  - ["Axilar", "35,5 a 37 °C (média de 36 a 36,5 °C)", "Local tradicional no Brasil; exige axila seca"]
...
legenda: "Quatro padrões de curva térmica; a linha tracejada marca a temperatura normal. O padrão recorrente e o irregular estão descritos em \"Aprofundar\"."
:::
...
::: fluxograma
titulo: Abordagem inicial do paciente com febre
etapas:
  - texto: "Paciente refere febre ou apresenta temperatura axilar acima da faixa normal"
    formato: inicio
  - texto: "Confirmar com termômetro, registrando local, valor e horário; abrir o quadro térmico"
    formato: acao
  - texto: "Caracterizar a febre - início, intensidade, duração, modo de evolução e término - e procurar os demais elementos da síndrome febril"
    formato: acao
  - texto: "Há sinais de gravidade? (hipotensão, taquipneia, rebaixamento de consciência, rigidez de nuca, petéquias, hipotermia paradoxal)"
    formato: decisao
  - texto: "Se sim - tratar como emergência: estabilizar, coletar culturas e iniciar antimicrobiano precocemente"
    formato: acao
  - texto: "Se não - há sinais focais na anamnese e no exame físico? (tosse, disúria, dor abdominal, sinais flogísticos na pele, artrite)"
    formato: decisao
  - texto: "Se sim - investigar o foco identificado e tratar conforme o sítio"
    formato: acao
  - texto: "Se não - a febre dura mais de 1 semana?"
    formato: decisao
  - texto: "Se sim - conduzir como febre prolongada e investigar endocardite infecciosa, tuberculose, linfomas, colagenoses, septicemia, pielonefrite, malária, esquistossomose, brucelose e febre tifoide"
    formato: acao
  - texto: "Se não - reavaliar em 24 a 72 h mantendo o registro da curva térmica"
    formato: acao
  - texto: "Reler a curva térmica e a resposta ao tratamento antes de rever o diagnóstico"
    formato: fim
:::
...
perguntas:
  ...
  - id: temp-fr-4
    enunciado: Curva térmica com períodos de temperatura elevada alternados com períodos de apirexia caracteriza qual padrão de febre?
    alternativas:
      - "Febre contínua"
      - "Febre remitente"
      - "Febre intermitente"
      - "Febre recorrente"
    corretaIndex: 2
    explicacao: A febre intermitente alterna períodos febris com períodos de apirexia e é clássica da malária, além de ocorrer em infecções urinárias, septicemia e linfomas. Na febre remitente há variação diária maior que 1 °C, mas sem apirexia.
  - id: temp-fr-5

---
titulo: Frequência cardíaca e pulso
ordem: 2
tags:
  - sinais vitais
  - pulso
...
::: manobra
titulo: Palpação do pulso radial
passos:
  - "Deixe a mão do paciente em completa supinação, apoiada no leito ou na mesa de exame."
  - "Examine cada lado com a sua mão contralateral: mão direita no punho esquerdo do paciente, mão esquerda no punho direito."
...
::: checklist
titulo: Avaliação do pulso em 60 segundos
itens:
  - "Mão do paciente em supinação e apoiada, examinador usando a mão contralateral."
  - "Estado da parede arterial: lisa e depressível ou endurecida e tortuosa?"
  - "Frequência contada durante 60 segundos completos."
  - "Ritmo: regular ou irregular? Se irregular, é totalmente irregular ou há pausas isoladas?"
  - "Amplitude: ampla, mediana ou pequena?"
  - "Tensão: pulso duro, mediano ou mole?"
  - "Tipo de onda: normal, célere, parvus, filiforme, alternante, paradoxal?"
...
perguntas:
  ...
  - id: pulso-2
    ...
    alternativas:
      - "Queda inspiratória da PAS maior que 10 mmHg, medida com o esfigmomanômetro"
      - "Queda inspiratória da PAS maior que 30 mmHg, detectada pela palpação"
      - "Elevação inspiratória da PAD maior que 10 mmHg, medida com o esfigmomanômetro"
      - "Qualquer variação da amplitude do pulso radial com a respiração, detectada pela palpação"
    corretaIndex: 0
    explicacao: "Define-se pulso paradoxal pela queda inspiratória da pressão sistólica maior que 10 mmHg (alguns usam 12 mmHg). Como só é palpável acima de 15 a 20 mmHg, a medida com o manguito é mais sensível e ainda quantifica o achado."
  - id: pulso-3
    ...
    corretaIndex: 1
    explicacao: A diferença entre a frequência cardíaca e a frequência de pulso é o déficit de pulso, causado por contrações ventriculares ineficazes. As causas principais são fibrilação atrial e extrassistolia frequente.
  - id: pulso-4
    enunciado: Pulso que aparece e desaparece rapidamente, comparado ao martelo d'água, com pressão diferencial aumentada, é típico de qual condição?
    alternativas:
      ...
      - "Choque hipovolêmico"
    corretaIndex: 2
    explicacao: O pulso célere ou em martelo d'água decorre do aumento da pressão diferencial e é característico da insuficiência aórtica, podendo também ocorrer em fístulas arteriovenosas, anemias graves e hipertireoidismo. Na estenose aórtica grave o pulso é parvus, de ascensão lenta.
  - id: pulso-5
    ...
    corretaIndex: 0
    explicacao: A alternância de uma onda ampla e outra fraca, com intervalos iguais entre elas, caracteriza o pulso alternante, sinal de insuficiência ventricular esquerda. O intervalo regular é o que o distingue do pulso bigeminado, no qual a onda prematura vem próxima da anterior.
:::

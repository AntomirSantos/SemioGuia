...
tags:
  ...
  - ducto torácico
  - coalescência
  - consistência do linfonodo
  - mobilidade do linfonodo
  - linfonodo aderido
...
::: tabela
titulo: Cadeias acessíveis e o que drenam
colunas:
  - "Cadeia"
  - "Onde fica"
  - "Território drenado"
linhas:
  - - "Occipitais"
    - "Sobre os processos occipitais externos, na parte posterior do crânio"
    - "Parte posterior do couro cabeludo e do pescoço"
  - - "Pré-auriculares e parotídeos"
    - "À frente da orelha, junto às artérias temporal superficial e facial e nas glândulas parótidas"
    - "Porção superior da face, região temporal, parótidas, parte posterior das bochechas e parte do couro cabeludo"
  - - "Retroauriculares (mastóideos)"
    - "Atrás da orelha, próximo à inserção do esternocleidomastóideo"
    - "Metade posterolateral do couro cabeludo"
  - - "Submentonianos e submandibulares (nível I)"
    - "Entre a mandíbula, os músculos digástricos e o osso hioide"
    - "Cavidade oral, lábios, língua, glândulas submandibular e sublingual, seios paranasais, face"
  - - "Cervicais profundos (níveis II, III e IV)"
    - "Ao longo da bainha carotídea, em grande parte cobertos pelo esternocleidomastóideo"
    - "Couro cabeludo, nasofaringe, faringe, laringe, tireoide, esôfago, língua e, indiretamente, todas as estruturas da cabeça e do pescoço"
  - - "Cervicais posteriores (nível V)"
    - "No trígono cervical posterior, ao longo do nervo acessório"
  ...
  - - "Axilares"
    - "Nas paredes anterior, medial e posterior da fossa axilar e no seu ápice"
  ...
  - - "Poplíteos"
    - "Na fossa poplítea"
    - "Perna e pé; raramente palpáveis"
:::
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="86" y="14">cadeias acessíveis à palpação</text>
    </g>
    <!-- silhueta -->
    <circle cx="86" cy="38" r="16" stroke-width="1.8" />
    <path d="M 78 53 L 78 60" stroke-width="1.6" />
    <path d="M 94 53 L 94 60" stroke-width="1.6" />
    <path d="M 58 66 C 68 60, 104 60, 114 66" stroke-width="1.8" />
    <path d="M 58 66 L 54 112" stroke-width="1.8" />
    <path d="M 114 66 L 118 112" stroke-width="1.8" />
    <path d="M 54 112 L 60 118 L 112 118 L 118 112" stroke-width="1.8" />
    <!-- braços -->
    <path d="M 58 68 C 46 78, 40 96, 38 116 C 37 128, 36 138, 36 146" stroke-width="1.6" />
    <path d="M 114 68 C 126 78, 132 96, 134 116 C 135 128, 136 138, 136 146" stroke-width="1.6" />
    <!-- pernas -->
    <path d="M 72 118 L 70 152 L 68 186" stroke-width="1.6" />
    ...
    <g stroke-width="1.4">
      ...
      <circle cx="66" cy="64" r="3.4" />
      <circle cx="52" cy="76" r="3.4" />
      <circle cx="39" cy="112" r="3.4" />
      <circle cx="76" cy="124" r="3.4" />
    ...
    <g font-family="sans-serif" font-size="8.5" fill="currentColor" stroke="none">
      ...
      <text x="52" y="62">5</text>
      <text x="40" y="74">6</text>
      <text x="26" y="112">7</text>
      <text x="86" y="128">8</text>
      <text x="58" y="152">9</text>
    </g>
    <!-- legenda -->
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none">
      ...
      <text x="160" y="98">5 supraclaviculares</text>
      <text x="160" y="114">6 axilares</text>
      <text x="160" y="130">7 epitrocleanos</text>
      <text x="160" y="146">8 inguinais</text>
      <text x="160" y="162">9 poplíteos</text>
...
texto: |
  ...
  - na **cadeia cervical superficial**, apoia-se o polegar no esternocleidomastóideo e movimentam-se os tecidos moles contra o músculo com os outros quatro dedos;
  - nas cadeias **submandibular e submentoniana**, deslocam-se os tecidos moles daquela região contra a borda inferior da mandíbula;
  - na **axila**, desliza-se a pele contra o gradil costal;
  - na **goteira epitrocleana**, comprime-se e desliza-se em pinça sobre o sulco.

  O restante é padronização: polpas digitais e face ventral dos dedos indicador, médio e anular, movimentos circulares curtos, **comparação sistemática com o lado contralateral**, e boa iluminação, porque a inspeção precede e complementa a palpação em toda região que possa estar aumentada.
:::

::: manobra
titulo: Palpação das cadeias linfonodais
passos:
  - "Inspecione, com boa iluminação e a região despida, cada território antes de palpar; compare sempre com o lado oposto."
  - "Cabeça e pescoço: paciente sentado, pescoço levemente fletido; posicione-se atrás dele e palpe as duas cadeias contralaterais ao mesmo tempo, com as polpas digitais em movimentos circulares."
  - "Incline levemente a cabeça do paciente para o lado examinado, para relaxar a musculatura daquele lado."
  - "Cadeia jugular: com uma das mãos, apreenda o esternocleidomastóideo entre o polegar de um lado e os dedos indicador e médio do outro."
  - "Cadeias bucal, parotídea, pré-auricular, retroauricular e occipital: compressão bidigital com as polpas do indicador e do médio, em movimentos giratórios."
  - "Fossas supraclaviculares: procure atrás da clavícula, sob ou por trás do esternocleidomastóideo; peça uma manobra de Valsalva, que empurra o ápice pleural para cima e torna os linfonodos mais salientes."
  - "Axila: de frente para o paciente sentado ou de pé, sustente o membro superior dele ligeiramente fletido com a mão heteróloga e examine a fossa com a outra mão em garra, deslizando a pele contra o gradil costal nas paredes anterior, medial e posterior e no ápice."
  - "Retropeitorais: com a mão em pinça, comprima e deslize por toda a face posterior acessível do músculo grande peitoral."
  - "Epitrocleanos: mantenha o membro superior fletido, segure o antebraço com a mão heteróloga e, com a outra em pinça, deslize sobre a goteira epitrocleana, 2 a 3 cm acima do epicôndilo medial."
  - "Inguinais: paciente deitado, região despida, coxa estendida e ligeiramente abduzida; palpe com os dedos estendidos em movimentos circulares ou lineares, cobrindo o grupo horizontal e o vertical."
...
::: checklist
titulo: Exame dos linfonodos em 10 passos
itens:
  - "Região despida, boa iluminação e inspeção antes da palpação."
  - "Cadeias da cabeça e do pescoço palpadas bilateralmente e comparadas entre os lados."
  - "Cadeia jugular examinada apreendendo o esternocleidomastóideo entre polegar e dedos."
  - "Fossas supraclaviculares palpadas atrás da clavícula, com manobra de Valsalva."
  - "Cadeias axilares examinadas com o membro superior sustentado e a mão em garra."
  - "Goteira epitrocleana palpada acima do epicôndilo medial."
  - "Cadeias inguinais palpadas com o paciente deitado e a coxa ligeiramente abduzida."
  - "Cada linfonodo encontrado descrito por localização, tamanho em centímetros, consistência, mobilidade, sensibilidade e coalescência."
  - "Pele sobrejacente inspecionada quanto a sinais flogísticos e fistulização."
  - "Registro de quais cadeias foram examinadas, inclusive as sem linfonodos palpáveis."
:::

::: secao
titulo: Como descrever um linfonodo
:::

::: conceito
titulo: Sete características e um linfonodo normal
texto: |
  Em condições normais, os linfonodos palpáveis são **individualizados, móveis, indolores e de consistência borrachosa**. Toda descrição parte desse padrão e anota o que se afasta dele.
  ...
  **Coalescência.** É a junção de dois ou mais linfonodos em uma massa de limites imprecisos, produzida por comprometimento inflamatório ou neoplásico da cápsula. Ela informa **tempo**: indica doença com alguma duração de evolução.

  **Alterações da pele.** Edema, calor, rubor e dor sobre o linfonodo apontam processo inflamatório; a presença de **fístula** sugere micose profunda ou tuberculose, e a secreção que flui por ela deve ser descrita.
:::
...
::: conceito
titulo: Antes dos sinais, a probabilidade pré-teste
texto: |
...
linhas:
  - - "Linfonodos fixos, aderidos a estruturas adjacentes"
    - "10,9"
  - - "Tamanho ≥ 9 cm² (equivalente a 3 × 3 cm ou mais)"
    - "8,4"
  ...
  - - "Idade abaixo de 40 anos"
    - "0,4"
  - - "Tamanho < 4 cm² (equivalente a 2 × 2 cm ou menos)"
    - "0,4"
  - - "Linfonodo doloroso à palpação"
    - "0,4"
  - - "Dor de garganta"
    - "0,2"
  - - "Exantema, febre, baço palpável, fígado palpável, adenopatia generalizada"
    - "sem significância"
:::
...
linhas:
  - - "Localização"
    - "Qualquer cadeia"
    - "Qualquer cadeia, com destaque para a supraclavicular"
    - "Qualquer cadeia"
  - - "Tamanho"
    - "Área abaixo de 1 cm²"
    - "Área acima de 2,25 cm²"
    - "Variável"
  - - "Consistência"
    - "Fibroelástica"
    - "Endurecida, chegando a pétrea"
    - "Firme e elástica; pode haver coalescência"
  - - "Fixação"
    - "Móvel sobre os planos profundos"
    - "Fixo, invadindo os planos profundos"
...
texto: |
  ...
  **Pontuação**
  ...
  - Idade acima de 40 anos: **+5**
  - Linfonodo doloroso à palpação: **−5**
  - Tamanho do linfonodo: menor que 1 cm², **0**; de 1 a 3,99 cm², **+4**; de 4 a 8,99 cm², **+8**; de 9 cm² ou mais, **+12**
  - Prurido generalizado: **+4**
  - Linfonodos supraclaviculares presentes: **+3**
  - Linfonodo endurecido: **+2**
  - **Fator de correção: −6**, incluído no escore de todo paciente
...
texto: |
  ...
  5. **Deixar a fossa supraclavicular de fora do exame.** É a cadeia de maior valor de alarme, a mais fácil de esquecer e a que pede uma manobra própria.
  6. **Registrar só o que se achou.** Anote também as cadeias examinadas sem linfonodos palpáveis: sem isso, o próximo examinador não sabe se você procurou.
:::

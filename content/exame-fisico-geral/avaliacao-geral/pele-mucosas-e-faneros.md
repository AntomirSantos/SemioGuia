...
texto: |
  ...
  O exame se organiza em três perguntas.

  1. **Que cor tem esta pele, e esta mucosa?** Palidez, vermelhidão, cianose, icterícia e discromias.
  2. **Que lesões existem, e de que tipo?** As lesões elementares, seu formato e sua distribuição.
  3. **O que dizem os anexos?** Cabelos, pelos e unhas.
...
::: checklist
titulo: Pele, mucosas e fâneros em 10 passos
itens:
  - "Iluminação adequada e exposição da região examinada, uma de cada vez."
  - "Inspeção a distância seguida de inspeção a curta distância."
  - "Coloração da pele avaliada em comparação com o registro inicial e entre regiões homólogas."
  - "Palidez pesquisada nas conjuntivas, nas palmas e nas pregas palmares."
  - "Icterícia pesquisada na esclera e conjuntiva, no freio da língua e no palato duro."
  - "Cianose pesquisada em lábios, língua, mucosa oral e extremidades."
  - "Digitopressão ou vitropressão aplicada a toda lesão avermelhada."
  - "Lesões elementares descritas por tipo, tamanho, formato e distribuição."
  - "Turgor, elasticidade, umidade, textura e temperatura da pele avaliados."
  - "Cabelos, pelos, unhas e regiões periungueais examinados."
:::

::: secao
titulo: Lesões elementares
:::
...
texto: |
  ...
  1. alterações de cor (as manchas ou máculas);
  2. elevações edematosas;
  3. formações sólidas (da pápula à goma);
  4. coleções líquidas;
...
::: tabela
titulo: Resumo operacional das lesões elementares
colunas:
  - "Grupo"
  - "Lesão"
  - "Como reconhecer"
linhas:
  - - "Alterações de cor"
    - "Mancha ou mácula"
    - "Área circunscrita de cor diferente, no mesmo plano da pele e sem alteração de superfície; subdivide-se em pigmentar, vascular, hemorrágica e por depósito de pigmentos"
  - - "Elevações edematosas"
    - "Lesão urticada"
    - "Elevação de formato variável, em geral eritematosa e pruriginosa, por edema circunscrito da derme; a urticária é a causa mais comum"
  - - "Formações sólidas"
    - "Pápula"
    - "Elevação sólida, superficial, bem delimitada, até 1 cm; a borda é percebida ao deslizar a polpa digital"
  - - "Formações sólidas"
    - "Tubérculo"
    - "Elevação sólida e circunscrita, maior que 1 cm, situada na derme; costuma evoluir com cicatriz"
  - - "Formações sólidas"
    - "Nódulo, nodosidade e goma"
    - "Formações sólidas da hipoderme, mais perceptíveis à palpação do que à inspeção; a goma é a nodosidade que amolece e ulcera, eliminando substância semissólida"
  - - "Formações sólidas"
    - "Vegetação e verrucosidade"
    - "Lesões salientes, lobulares ou em couve-flor, de consistência mole; quando a camada córnea espessa, tornam-se endurecidas (verrucosidade)"
  - - "Coleções líquidas"
    - "Vesícula e bolha"
    - "Elevações com conteúdo líquido; até 1 cm são vesículas, acima disso, bolhas. A punção resolve a dúvida com a pápula"
  - - "Coleções líquidas"
    - "Pústula e abscesso"
  ...
  - - "Perdas e reparações"
    - "Escara, cicatriz e queloide"
    - "Escara é a porção de tecido necrosado por pressão, isolada ou somada a fricção e cisalhamento, insensível, escurecida e separada do tecido sadio por um sulco; cicatriz é a reposição por tecido fibroso; queloide é a formação fibrosa saliente, firme, róseo-avermelhada, de bordas nítidas e ramificações curtas"
:::

::: conceito
titulo: Digitopressão, vitropressão e puntipressão
texto: |
  Uma única manobra resolve a dúvida mais frequente do exame da pele: **a cor vem do sangue dentro do vaso ou do sangue fora dele?**
  ...
  A mesma manobra serve a outras perguntas: separa mancha hipocrômica de nevo anêmico, e revela nas lesões granulomatosas a coloração característica descrita como geleia de maçã.
:::
...
linhas:
  - - "Rima conjuntival (método da rima)"
    - "16,7"
  - - "Pregas palmares"
    - "7,9"
  - - "Palma da mão"
    - "5,6"
  - - "Conjuntiva, sem o método da rima"
    - "4,7"
  - - "Palidez em qualquer sítio"
    - "3,8"
  - - "Face (apenas em pessoas de pele clara)"
    - "3,8"
  - - "Língua"
    - "3,7"
  - - "Leito ungueal"
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="58" y="14">pálpebra inferior</text>
    ...
    <path d="M 132 45 C 146 40, 174 40, 188 45" stroke-width="1.2" />
    <path d="M 160 52 C 152 56, 150 66, 154 74" stroke-width="1.4" />
    <path d="M 160 52 C 168 56, 170 66, 166 74" stroke-width="1.4" />
    <path d="M 160 54 L 160 74" stroke-width="1.2" stroke-dasharray="3 3" />
    ...
    <path d="M 252 74 L 252 44 C 252 39, 258 39, 258 44 L 258 74" stroke-width="1.6" />
    <path d="M 258 74 L 258 42 C 258 37, 264 37, 264 42 L 264 74" stroke-width="1.6" />
    <path d="M 264 74 L 264 46 C 264 41, 270 41, 270 46 L 270 76" stroke-width="1.6" />
    <path d="M 270 76 L 274 54 C 275 49, 281 50, 280 56 L 278 82" stroke-width="1.6" />
    <path d="M 240 96 C 246 108, 274 108, 278 82" stroke-width="1.6" />
    <g stroke-width="1.2">
      <path d="M 246 82 C 254 76, 264 76, 272 80" />
      <path d="M 246 90 C 256 84, 266 84, 274 88" />
    </g>
    <g stroke-width="1.2">
      <path d="M 252 44 C 254 42, 257 42, 258 44" />
...
::: conceito
titulo: A partir de que nível a icterícia se vê
texto: |
...
texto: |
  ...
  **A progressão craniocaudal.** No recém-nascido, a avaliação clínica da icterícia é decisiva, porque níveis muito elevados de bilirrubina não conjugada podem atravessar a barreira hematoencefálica e produzir kernicterus. Um dos métodos difundidos correlaciona zonas dérmicas com níveis séricos, apoiado na progressão tipicamente craniocaudal: cabeça em torno de 6 mg/dL, abdome e coxas em torno de 12 mg/dL, mãos e pés em torno de 16 mg/dL. A ressalva vem da mesma fonte: trabalhos mais recentes encontraram **correlação pobre entre a bilirrubina dosada e a progressão cefalocaudal usada de forma isolada**.
  ...
  A lição comum às duas escalas é a mesma que atravessa este guia: registre com precisão o que viu e onde viu; use a dosagem para quantificar.
:::

::: conceito
titulo: Icterícia × carotenodermia e outras cores amarelas
nivel: avancado
texto: |
  ...
  **Depósito de outros pigmentos.** O grupo das manchas por depósito abrange hemossiderina, bilirrubina, pigmento carotênico, corpos estranhos (tatuagem) e pigmentos metálicos como prata e bismuto.

  Um resumo operacional: **pele amarela com olho e boca poupados não é icterícia**.
:::

::: secao
titulo: Cianose e manchas hemorrágicas
:::
...
texto: |
  ...
  **Generalizada ou segmentar.** A pergunta vem antes de qualquer outra, porque o raciocínio clínico é completamente diferente nos dois casos: a cianose segmentar significa obstrução de uma veia que drena aquela região.
  ...
  - aquecer a área faz a cianose periférica atenuar-se ou desaparecer, e não muda a central;
...
::: tabela
titulo: Alterações das unhas com nome próprio
colunas:
  - "Alteração"
  - "O que se vê"
  - "Contextos"
linhas:
  - - "Unhas em vidro de relógio"
    - "Unha convexa em todos os sentidos, com ângulo de implantação alargado; compõe o hipocratismo digital"
    - "Cardiopatias congênitas, bronquiectasias e as demais causas de baqueteamento"
  - - "Coiloníquia (unha em colher)"
    - "Placa ungueal fina, com depressão central"
    - "Anemia ferropriva grave; também por irritantes locais"
  - - "Leuconíquia"
    - "Manchas brancas na placa ungueal"
    - "Achado comum em pessoas sadias"
  - - "Linhas de Beau"
    - "Sulcos transversais à lúnula"
    - "Doenças renais e hepáticas, e outras doenças sistêmicas que interrompem o crescimento da unha"
  - - "Faixas de Mees"
  ...
  - - "Unhas distróficas"
    ...
    - "Traumatismos repetidos, onicomicose, isquemia crônica dos membros inferiores"
  - - "Paroníquia"
    - "Inflamação da região que circunda a unha"
    - "Frequente em quem mantém as mãos em contato constante com água; causa micótica comum"
  - - "Onicofagia"
    - "Sinais do hábito de roer as unhas"
    - "Indicativo de ansiedade"
:::

::: entendimento
titulo: Dois ângulos diferentes na mesma unha
texto: |
...
texto: |
  ...
  - **Fácies e estado geral**, que dependem em parte da cor do tegumento, estão no tópico de ectoscopia.
:::

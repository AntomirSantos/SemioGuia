---
titulo: Pares cranianos VII a XII
ordem: 3
tags:
  - pares cranianos
  - nervos cranianos
  ...
  - estação OSCE
referencias:
  - "Porto — Exame Clínico, 8ª ed., cap. 20 (Exame Neurológico) — Nervos cranianos: nervo facial (VII), exame da mímica, paralisia unilateral, prosopoplegia e diplegia facial, paralisia a frigore, distinção entre paralisia periférica e central (Figuras 20.27 e 20.28), nervo intermédio de Wrisberg e a gustação dos dois terços anteriores da língua; nervo vestibulococlear, raiz coclear (voz cochichada, atrito das polpas digitais, prova de Rinne) e raiz vestibular (nistagmo, desvio postural, sinal de Romberg, provas calórica e rotatória); nervos glossofaríngeo (IX) e vago (X), desvio do véu palatino, sinal da cortina e reflexo velopalatino; nervo acessório (XI); nervo hipoglosso (XII) e o exame da língua (Figura 20.29)"
  - "Porto — Semiologia Médica, 8ª ed., Parte 18 (Sistema Nervoso), cap. 172 (Exame Clínico) — Nervos cranianos VII a XII; distúrbios auditivos e a caracterização da vertigem entre os sinais e sintomas; nervo facial e a distinção infranuclear × supranuclear (Figura 172.25); raiz coclear e raiz vestibular do VIII; sinal da cortina e disfonia na lesão do X; hipoglosso e o desvio da língua"
  - "Porto — Semiologia Médica, 8ª ed., Parte 18 (Sistema Nervoso), cap. 174 (Doenças do Sistema Nervoso) — Paralisia facial periférica: quadro clínico, sinal de Bell, distúrbio sensitivo do conduto auditivo, hiperacusia, lacrimejamento e hipogeusia conforme o nível da lesão; paralisia de Bell, sua evolução e as sincinesias por reinervação aberrante; associação com diabetes melito"
  - "Semiologia Clínica, 1ª ed., cap. 19 (O exame do sistema nervoso) — Exame da função auditiva: hipoacusia de condução e neurossensorial, uso do diapasão, provas de Rinne e de Weber, e a raridade da hipoacusia unilateral por lesão cortical; acometimento motor da face e a distinção entre lesão do neurônio motor superior e inferior; exame da coordenação e do equilíbrio: equilíbrio estático e dinâmico, desvios vestibulares e cerebelares, manobra de Fukuda e marcha em estrela, reflexo oculovestibular ou manobra de Halmagyi; Tabela 5 (roteiro do exame neurológico)"
...
::: conceito
titulo: Os seis pares que sobram — e onde eles já apareceram
texto: |
  Este tópico fecha os doze pares cranianos. Ele examina os nervos que comandam **a expressão do rosto, a audição e o equilíbrio, o palato e a faringe, o pescoço e a língua** — e boa parte desses achados o leitor já encontrou, cada um pela porta do segmento em que aparece.

  O trabalho deste tópico, portanto, é menos o de apresentar achados novos e mais o de **ligar o que já está espalhado a uma topografia**. Vale dizer isso explicitamente, porque evita repetição e evita contradição:

  - a **paralisia facial** como achado de assimetria, com a regra da testa que a separa em central e periférica, está no tópico de crânio e face. Aqui se ensina o **exame** que produz esse achado — a mímica por andares — e o que fazer depois dele;
  - as **provas de Weber, de Rinne e do sussurro**, com técnica e razões de verossimilhança, estão no tópico de boca, nariz e ouvidos. Aqui só se acrescenta o **enquadramento neurológico**: por que perda condutiva e perda neurossensorial correspondem a lugares diferentes da via, e o que isso muda;
  - o **desvio da língua na protrusão** foi registrado como achado no tópico de boca, nariz e ouvidos, com a interpretação reservada a este capítulo. É aqui que ela é paga;
  - a **rouquidão persistente** aparece no tópico de tireoide e pescoço como sinal de alarme de massa cervical. Aqui ela aparece como sinal de nervo craniano — e as duas leituras se somam.
...
::: perola
texto: "Três dos seis nervos deste tópico se examinam pedindo ao paciente que faça uma careta, diga \"a\" e ponha a língua para fora. Nenhum instrumento, nenhum aparelho — e, feito com método, um mapa razoável do tronco encefálico."
:::
...
::: manobra
titulo: Exame dos pares cranianos de VII a XII
passos:
  - "Paciente sentado à sua frente, com boa iluminação; tenha à mão uma lanterna, um abaixador de língua e um diapasão."
  - "Observe o rosto em repouso: profundidade dos sulcos nasolabiais, largura das fendas palpebrais, posição das comissuras labiais e frequência do piscar."
  - "Peça, um comando de cada vez, que o paciente enrugue a testa, franza os supercílios e feche os olhos com força, e compare os dois lados."
  - "Peça que mostre os dentes, encha a boca de ar, assobie e contraia o platisma, comparando novamente os dois lados."
  - "Registre em que andares da face há déficit — testa e supercílio, pálpebra, boca — e se ele é completo ou parcial."
  - "Audição: aplique à beira do leito os testes que o tópico de boca, nariz e ouvidos ensina, e classifique a perda, quando houver, em condutiva ou neurossensorial."
...
observar: |
  O exame da mímica funciona melhor com **um comando por vez e demonstração**. Pedir "faça caretas" produz um paciente confuso; imitar o movimento na frente dele produz o movimento certo — e, sobretudo, produz movimentos **voluntários**, que é o que se está testando.

  Duas armadilhas de ordem. O **reflexo do vômito** encerra a cooperação: deixe-o para o fim do exame da boca e da faringe. E a **sensibilidade faríngea** deve ser testada **antes** dele, porque um paciente que acabou de ter ânsia não vai aceitar o cotonete de novo — e, como se verá adiante, a sensibilidade rende muito mais que o reflexo.

  Ao testar o esternocleidomastóideo, lembre-se de que ele **gira a cabeça para o lado oposto**: para testar o músculo direito, peça que o paciente vire a cabeça para a esquerda contra a sua mão.
:::

::: checklist
titulo: Pares cranianos VII a XII em 10 passos
itens:
  - "Rosto observado em repouso, com registro de sulcos nasolabiais, fendas palpebrais e comissuras."
  - "Mímica testada por andares: testa e supercílio, oclusão palpebral, e boca com os dentes à mostra."
  - "Déficit da mímica registrado por andar e como completo ou parcial."
  - "Audição avaliada à beira do leito, com a perda classificada em condutiva ou neurossensorial quando presente."
  - "Equilíbrio estático testado de olhos abertos e fechados, com registro de desvio e do lado para onde ocorre."
  - "Nistagmo espontâneo procurado no olhar para a frente e para cada lado, evitando o olhar lateral extremo."
  - "Elevação do véu palatino observada durante a emissão prolongada da vogal, com atenção à posição da úvula."
  - "Sensibilidade faríngea testada de cada lado antes da pesquisa do reflexo do vômito."
  - "Trapézio e esternocleidomastóideo testados contra resistência, dos dois lados."
  - "Língua inspecionada em repouso e na protrusão, com registro de atrofia, fasciculações e desvio."
:::

::: secao
titulo: VII — o nervo facial
:::
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none">
      <text x="46" y="16">A · periférica</text>
      <text x="204" y="16">B · central</text>
    </g>
    <!-- FACE A -->
    <path d="M 45 82 C 45 53, 63 30, 85 30 C 107 30, 125 53, 125 82 C 125 111, 107 134, 85 134 C 63 134, 45 111, 45 82 Z" stroke-width="1.5" />
    <path d="M 90 42 Q 104 38, 118 42" stroke-width="1.1" />
    <path d="M 92 50 Q 104 46, 116 50" stroke-width="1.1" />
    <path d="M 58 58 L 78 58" stroke-width="1.4" />
    <path d="M 92 58 Q 104 52, 116 58" stroke-width="1.4" />
    <path d="M 46 66 L 124 66" stroke-width="1" stroke-dasharray="3 2" />
    <path d="M 54 84 C 60 76, 76 76, 82 84 C 76 92, 60 92, 54 84 Z" stroke-width="1.4" />
    <circle cx="68" cy="84" r="3" stroke-width="1.3" />
    <path d="M 90 82 Q 102 89, 114 82" stroke-width="1.4" />
    <path d="M 46 98 L 124 98" stroke-width="1" stroke-dasharray="3 2" />
    <path d="M 85 84 L 81 96 L 89 96" stroke-width="1.3" />
    <path d="M 97 102 Q 101 111, 99 118" stroke-width="1.2" />
    <path d="M 60 118 Q 85 127, 110 110" stroke-width="1.5" />
    ...
    <path d="M 206 42 Q 220 38, 232 42" stroke-width="1.1" />
    <path d="M 240 42 Q 254 38, 266 42" stroke-width="1.1" />
    <path d="M 208 58 Q 220 52, 232 58" stroke-width="1.4" />
    <path d="M 240 58 Q 252 52, 264 58" stroke-width="1.4" />
    <path d="M 196 66 L 274 66" stroke-width="1" stroke-dasharray="3 2" />
    <path d="M 206 82 Q 218 89, 230 82" stroke-width="1.4" />
    <path d="M 240 82 Q 252 89, 264 82" stroke-width="1.4" />
    <path d="M 196 98 L 274 98" stroke-width="1" stroke-dasharray="3 2" />
    <path d="M 235 84 L 231 96 L 239 96" stroke-width="1.3" />
    <path d="M 247 102 Q 251 111, 249 118" stroke-width="1.2" />
    <path d="M 210 118 Q 235 127, 260 110" stroke-width="1.5" />
    <path d="M 282 98 L 287 98 L 287 134 L 282 134" stroke-width="1.3" />
    <!-- legenda -->
    <g font-family="sans-serif" font-size="8.5" fill="currentColor" stroke="none">
      <text x="12" y="152">A · periférica: os três andares do mesmo lado — a testa não enruga</text>
      <text x="12" y="166">B · central: só o andar inferior, do lado oposto à lesão</text>
      <text x="12" y="180">1 testa e supercílio · 2 oclusão palpebral · 3 boca e sulco nasolabial</text>
    </g>
  </svg>
legenda: "As duas faces estão tentando fechar os olhos. Examinar a mímica por andares transforma uma impressão de assimetria em um achado com endereço: se o andar de cima participa do déficit — a testa que não enruga, o olho que não fecha —, a lesão é do nervo ou do seu núcleo; se ele é poupado, a lesão está acima, e do lado oposto ao da face comprometida."
:::
...
texto: |
  ...
  - **andar superior** — enrugar a testa e franzir os supercílios;
...
::: secao
titulo: VIII — audição e equilíbrio
:::
...
::: secao
titulo: IX e X — palato, faringe e voz
:::
...
texto: |
  ...
  **E daí sai a topografia**, com uma inversão que vale memorizar:
  ...
  - **lesão de hemisfério cerebral** enfraquece o genioglosso **contralateral**; a língua desvia, portanto, **para o mesmo lado do braço e da perna fracos**;
  - **lesão do bulbo** — a síndrome bulbar medial — produz paralisia hipoglossa **ipsilateral** com hemiparesia **contralateral**; a língua desvia, portanto, **para o lado oposto ao do braço e da perna fracos**.
...
linhas:
  - - "Sonolência"
    - "3,4"
    - "0,5"
  - - "Teste de deglutição de água alterado"
    - "3,2"
    - "0,4"
  - - "Queda da saturação de oxigênio de 2% ou mais após deglutir líquido"
    - "3,1"
    - "0,3"
  - - "Sensibilidade faríngea ausente"
    - "2,4"
    - "0,03"
  - - "Tosse voluntária anormal"
    - "1,9"
    - "0,6"
  - - "Disartria"
    - "1,6"
  ...
  - - "Disfonia"
    - "1,5"
    - "0,5"
  - - "Reflexo do vômito anormal"
    - "1,4"
    - "0,6"
  - - "Fraqueza da língua"
    - "não significativa"
    - "0,6"
  - - "Alteração da sensibilidade da face e da língua"
    - "não significativa"
    - "não significativa"
:::

::: conceito
titulo: Lendo a tabela — e por que o reflexo do vômito decepciona
nivel: avancado
texto: |
  O padrão de referência desses estudos é o exame **fibroscópico** ou a **videofluoroscopia** da deglutição, e as definições importam:

  - **teste de deglutição de água**: beber de 5 a 90 mL de água em goles de 5 a 10 mL, considerando-se alterado quando surgem tosse, engasgo ou alteração da voz;
  - **dessaturação após deglutição**: queda de 2% ou mais na saturação, de zero a dois minutos depois de engolir o líquido;
  ...
  **E o achado mais decepcionante é justamente o mais famoso.** O **reflexo do vômito anormal** rende quase nada: 1,4 quando presente, 0,6 quando ausente. McGee dá duas razões, e as duas fazem sentido assim que são ditas. A primeira: os músculos faríngeos envolvidos no reflexo **não são necessariamente os mesmos** que se ativam durante a deglutição normal para proteger a via aérea. A segunda: **o reflexo do vômito está frequentemente ausente em pessoas normais**, sobretudo em idosos.
  ...
  Os demais achados se distribuem em uma faixa modesta. Sonolência (3,4), teste de deglutição de água alterado (3,2) e dessaturação após a deglutição (3,1) são os que mais elevam a probabilidade. Disfonia, disartria e tosse voluntária anormal ficam entre 1,5 e 1,9. E dois achados **não têm valor preditivo**: fraqueza da língua e alteração da sensibilidade da face e da língua.

  Vale reter também a lição de método que a tabela ensina, e que este guia repete em vários capítulos: um sinal clássico e um sinal pouco conhecido podem trocar de lugar quando alguém os mede.
:::

::: conceito
titulo: Bulbar × pseudobulbar
nivel: avancado
texto: |
  Quando os núcleos motores dos nervos cranianos baixos falham, o resultado é o mesmo conjunto de sintomas — **disartria, disfagia e paralisia dos movimentos voluntários da face** —, mas a lesão pode estar em dois lugares muito diferentes. Distinguir os dois é um dos poucos diagnósticos que se fazem inteiramente pela observação de nervos cranianos.
  ...
  **Paralisia bulbar** é a lesão dos próprios núcleos motores no tronco encefálico. **Paralisia pseudobulbar** é a lesão **supranuclear**: lesões bilaterais acima do nível da ponte, que interrompem as vias piramidais descendentes destinadas a esses núcleos.
  ...
  - os outros achados são **reflexo mandibular hiperativo em 70%**, **reflexo do vômito ausente em 70%** e, em **24%**, reflexos emocionais hiperativos que produzem choro e riso espasmódicos e muitas vezes inadequados.
...
colunas:
  ...
  - "Se ausente"
linhas:
  - - "Ataxia troncular grave"
    - "17,9"
    - "0,7"
  - - "Teste do impulso cefálico normal (sem sacada corretiva)"
    - "9,6"
    - "0,2"
  - - "Desvio oblíquo dos olhos"
    - "5,3"
    - "0,7"
  - - "Perseguição sacádica"
    - "4,6"
    - "0,2"
  - - "Nistagmo que muda de direção"
    - "3,5"
    - "0,7"
  - - "Pelo menos um dos três: impulso cefálico normal, nistagmo que muda de direção, desvio oblíquo"
    - "10,8"
    - "0,02"
:::

::: conceito
titulo: Lendo a tabela — e a inversão que ela ensina
nivel: avancado
texto: |
...
texto: |
  ...
  - **teste de dessaturação** para risco de aspiração: **0,60**;
  - **força anormal da língua**: **0,55 a 0,63**;
  - **paralisia facial**, presente ou ausente: **0,57**;
  - **disartria**, presente ou ausente: **0,41 a 0,77**.

  Compare essa lista com a tabela de razões de verossimilhança da aspiração e o quadro fica coerente de um jeito raro: **a sensibilidade faríngea é o achado mais reprodutível e o de melhor desempenho negativo**. Os dois atributos aparecem juntos, e por um motivo que não é coincidência — um achado que dois examinadores encontram do mesmo jeito é um achado com pouca margem de interpretação.

  No outro extremo, a **disartria** varia de 0,41 a 0,77 entre estudos: um intervalo largo, atravessando concordância apenas razoável até substancial. É a mesma lição que o tópico de crânio e face registra para o capítulo de cabeça e pescoço, e que se repete aqui: **onde a técnica não está padronizada, a concordância desaba** — e o remédio é descrever em vez de rotular.

  Um último cruzamento vale a pena. A **paralisia facial** tem concordância de 0,57 e é um dos achados mais ensinados da semiologia. Isso não a torna inútil; torna obrigatório o registro por andares, com os comandos usados, em vez do rótulo isolado.
:::

::: conceito
titulo: Onde este tópico encontra os outros
texto: |
  Este é o tópico do guia que mais se apoia no que outros capítulos já ensinaram — e é assim de propósito.

  - **A paralisia facial como achado**, com a regra da testa, as causas de cada tipo e o sinal de Bell, está no tópico de crânio e face. Aqui se ensina o exame que a produz e os critérios que a completam.
  - **As provas de Weber, de Rinne e do sussurro**, com técnica e razões de verossimilhança, e o **atrito das polpas digitais** estão no tópico de boca, nariz e ouvidos, que também nomeia a otoscopia como exame instrumental.
  - **O exame da língua** — cor, superfície, macroglossia, marca dos dentes — e a **inspeção da orofaringe** com o abaixador estão no tópico de boca, nariz e ouvidos; o desvio na protrusão foi lá registrado e é aqui interpretado.
  - **A rouquidão persistente e a disfagia** como sinais de alarme de massa cervical estão no tópico de tireoide e pescoço, que recomenda examinar a tireoide diante de disfonia; a **mobilidade cervical** e a posição da cabeça também estão lá.
  - **A ptose palpebral** e a **motricidade ocular**, que entram no diagnóstico diferencial da assimetria facial, estão no tópico de pares cranianos de I a VI, junto com a via aferente do reflexo córneo-palpebral e o vocabulário do nistagmo.
  - **A prova de Romberg** e o exame da coordenação estão no tópico de sensibilidade e coordenação; **a marcha em estrela, a marcha de pequenos passos** e as demais marchas com nome estão no tópico de marcha e sinais meníngeos.
  - **A sonolência e os demais níveis de consciência**, que entram na avaliação do risco de aspiração, estão no tópico de consciência e estado mental.
  - **A gustação como exame formal, as provas vestibulares calóricas, rotatórias e posicionais e as escalas especializadas de graduação da paralisia facial** são nomeadas aqui e ficam fora deste guia por enquanto.
:::
...
perguntas:
  ...
  - id: neu-pc2-2
    ...
    alternativas:
      - "Paralisia facial periférica direita incompleta, do tipo ramuscular, que poupa o ramo temporofacial e explica a preservação do enrugamento da testa"
      - "Achado sem valor localizatório, já que movimentos emocionais e voluntários usam a mesma via"
  ...
  - id: neu-pc2-4
    ...
    alternativas:
      - "No nervo hipoglosso esquerdo em seu trajeto periférico, provavelmente por trauma ou por doença metastática de base de crânio"
      - "No núcleo hipoglosso esquerdo, no bulbo, caracterizando a síndrome bulbar medial, que soma paralisia da língua a déficit proprioceptivo contralateral"
      - "No hemisfério cerebral direito: a lesão hemisférica enfraquece o genioglosso contralateral, e a língua desvia para o mesmo lado dos membros fracos"
      - "Em qualquer um dos dois, pois o desvio da língua não distingue lesão hemisférica de lesão do tronco encefálico"
    corretaIndex: 2
    explicacao: "Cada genioglosso empurra a língua para fora e para o lado oposto, e a língua desvia para o lado fraco. Lesão de hemisfério cerebral enfraquece o genioglosso contralateral, de modo que a língua desvia para o mesmo lado do braço e da perna fracos — exatamente o padrão descrito. Na síndrome bulbar medial ocorre o inverso: paralisia hipoglossa ipsilateral com hemiparesia contralateral, e a língua desvia para o lado oposto ao dos membros fracos. Atrofia ou fasciculações da língua indicariam lesão do núcleo ou do nervo, e não do hemisfério — e aqui elas estão ausentes."
  - id: neu-pc2-5
    enunciado: Ao pedir que um paciente diga "a" de forma prolongada, você observa que o véu palatino se eleva menos do lado direito e a úvula é tracionada para a esquerda. Qual é a leitura topográfica correta?
    alternativas:
      - "Lesão do hemisfério cerebral esquerdo, cujo comando corticobulbar cruzado seria o único responsável pela elevação velar do lado direito, sem contribuição do hemisfério oposto"
      - "Lesão do bulbo do lado direito ou dos nervos glossofaríngeo e vago daquele lado, já que doença hemisférica unilateral não costuma causar fraqueza do palato"
  ...
  - id: neu-pc2-6
    ...
    alternativas:
      - "Contratura, que corresponde a cicatriz fibrosa dos músculos da mímica e ocorre em 3% a 36% dos pacientes"
      - "Lágrimas de crocodilo, por regeneração de fibras salivares em direção à glândula lacrimal"

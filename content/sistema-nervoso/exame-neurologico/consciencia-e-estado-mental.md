---
titulo: Consciência e estado mental
ordem: 1
tags:
  - consciência
  ...
  - estação OSCE
referencias:
  - "Porto — Exame Clínico, 8ª ed., cap. 10 (Exame Físico Geral) — Avaliação do nível de consciência: vigília e sistema reticular ativador ascendente, obnubilação, sonolência, confusão mental, torpor ou estupor e coma; Quadro 10.1 (escala de coma de Glasgow) e a interpretação da pontuação; Fala e linguagem: disfonia, dislalia, disartria e disfasia"
  - "Porto — Exame Clínico, 8ª ed., cap. 20 (Exame Neurológico) — objetivo do exame neurológico e as perguntas que ele responde; Avaliação do nível de consciência e Quadro 20.2 (escala de coma de Glasgow); Miniexame do estado mental (Quadros 20.3 e 20.4); Principais síndromes neurológicas, com os sinais e sintomas da hipertensão intracraniana"
  - "Porto — Semiologia Médica, 8ª ed., Parte 18 (Sistema Nervoso), cap. 172 (Exame Clínico) — Sinais e sintomas: distúrbios da consciência; uso da escala de coma de Glasgow, o estímulo doloroso aplicado no leito ungueal, a ressalva sobre o estímulo supraorbital e a variação de pontuação entre observadores; Avaliação do estado mental"
  - "Porto — Semiologia Médica, 8ª ed., Parte 18 (Sistema Nervoso), cap. 174 (Doenças do Sistema Nervoso), Estado de coma — Quadro 174.1 (classificação etiológica), outros estados de alteração da consciência (estado confusional agudo, estado vegetativo persistente, estado minimamente consciente, síndrome do cativeiro), Quadro 174.2 (escala da consciência vígil de Jouvet e Dechaume), Quadro 174.3 (escala de coma de Glasgow) e interpretação dos valores, posturas de descerebração e de descorticação, exame ocular e função respiratória no paciente comatoso"
  - "Semiologia Clínica, 1ª ed., cap. 23 (Alterações da consciência) — conceito de nível e de conteúdo da consciência, o sistema reticular ativador ascendente, os cinco estados (alerta, letargia, obnubilação, torpor e coma), caracterização e anamnese com terceiros, sinais localizatórios, Tabela 1 (escala de coma de Glasgow), causas estruturais e metabólicas, ilusão, alucinação e delirium"
  - "Semiologia Clínica, 1ª ed., cap. 19 (O exame do sistema nervoso) — exame das funções cognitivas: atenção, linguagem e as áreas de Broca e de Wernicke, tipos de afasia, agnosias e apraxias; Tabela 5 (roteiro do exame neurológico)"
  - "McGee — Evidence-Based Physical Diagnosis, 4ª ed., cap. 5 (Reliability of Physical Findings), p. 29 e p. 33-34, Tabela 5.1 — concordância entre observadores para consciência comprometida, estado mental alterado, miniexame do estado mental e método de avaliação de confusão para delirium"
...
texto: |
  ...
  A consequência prática é imediata. Um paciente perfeitamente desperto pode estar profundamente alterado — é o caso do delirium. Um paciente sonolento pode, ao despertar, responder com coerência total. Registrar só um dos eixos descreve metade do doente.

  **O que este tópico ensina:** os dois eixos e o vocabulário de cada um; a **escala de coma de Glasgow** por inteiro, componente por componente, com o que ela mede bem e o que ela não mede; o que são **sinais localizatórios** e por que eles mudam a hipótese; a leitura neurológica do **padrão respiratório**; e a triagem de orientação, atenção e linguagem que cabe à beira do leito.
...
::: perola
texto: "A escada da consciência — obnubilação, sonolência, confusão mental, torpor, coma — já está no tópico de ectoscopia, e é lá que se aprende a subir e descer por ela. Aqui a pergunta muda de natureza: não em que degrau o paciente está, mas o que o degrau significa, e o que mais examinar depois de nomeá-lo."
:::
...
::: manobra
titulo: Nível de consciência e triagem do estado mental
passos:
  - "Antes de tocar o paciente, observe: postura no leito, movimentos espontâneos, simetria entre os dois hemicorpos, padrão da respiração e se os olhos estão abertos."
  - "Fale em tom normal e observe se há resposta; passando a haver, converse antes de estimular mais."
  - "Não havendo resposta, chame pelo nome em voz alta; depois toque e sacuda o ombro com firmeza suave, como quem desperta alguém."
  - "Persistindo a ausência de resposta, aplique estímulo doloroso padronizado: compressão do leito ungueal com um objeto rígido, como um lápis ou uma caneta."
  - "Registre a abertura ocular pelo menor estímulo que ainda a produz: espontânea, ao chamado ou à dor."
  - "Registre a melhor resposta verbal obtida, do orientado ao silêncio, sem somar tentativas de estímulos diferentes."
  - "Registre a melhor resposta motora, e do melhor lado: obediência a ordem, localização da dor, retirada, flexão anormal, extensão ou ausência."
  - "Some os três componentes e anote também cada um deles em separado, junto do estímulo usado."
  - "Com o paciente responsivo, teste orientação no tempo e no espaço, atenção em uma tarefa breve e compreensão de uma ordem simples."
  - "Escute a fala enquanto ele responde e classifique a alteração, se houver: rouquidão, articulação arrastada ou perda da elaboração da linguagem."
...
::: checklist
titulo: Consciência e estado mental em 10 passos
itens:
  - "Observação inicial feita antes de qualquer estímulo, com registro de postura, movimentos espontâneos e simetria."
  - "Estímulos aplicados em escala crescente, do tom de voz normal ao estímulo doloroso padronizado."
  - "Menor estímulo capaz de produzir resposta anotado em palavras, e não apenas como pontuação."
  - "Abertura ocular pontuada de 1 a 4."
  - "Melhor resposta verbal pontuada de 1 a 5."
  - "Melhor resposta motora pontuada de 1 a 6, considerando o melhor lado."
  - "Total anotado junto dos três componentes em separado."
  - "Orientação no tempo e no espaço, atenção e compreensão de ordem simples testadas no paciente responsivo."
  - "Alteração da fala caracterizada como problema de voz, de articulação ou de elaboração da linguagem."
  - "Assimetrias entre os hemicorpos procuradas e registradas ao lado do nível de consciência."
:::

::: secao
titulo: A escala de coma de Glasgow
:::
...
::: tabela
titulo: Escala de coma de Glasgow — os três componentes
colunas:
  - "Componente"
  - "Resposta observada"
  - "Pontos"
linhas:
  ...
  - - "Melhor resposta verbal"
    ...
    - "4"
  - - "Melhor resposta verbal"
    - "Palavras inapropriadas ou desconexas"
    - "3"
  - - "Melhor resposta verbal"
  ...
  - - "Melhor resposta motora"
    - "Obedece a ordem verbal"
    - "6"
  - - "Melhor resposta motora"
    - "Localiza o estímulo doloroso"
    - "5"
  - - "Melhor resposta motora"
    - "Retirada inespecífica do membro estimulado"
    - "4"
  - - "Melhor resposta motora"
    - "Flexão anormal (postura de descorticação)"
    - "3"
  - - "Melhor resposta motora"
    - "Extensão (postura de descerebração)"
    - "2"
  - - "Melhor resposta motora"
    - "Ausente"
    - "1"
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M 64 54 L 100 54 L 97 104 L 67 104 Z" stroke-width="1.5" />
    <!-- A: bracos fletidos sobre o torax -->
    <path d="M 65 60 L 50 80 L 74 88" stroke-width="1.6" />
    <path d="M 99 60 L 114 80 L 90 92" stroke-width="1.6" />
    <circle cx="74" cy="88" r="3" stroke-width="1.3" />
    <circle cx="90" cy="92" r="3" stroke-width="1.3" />
    <!-- A: pernas estendidas -->
    <path d="M 71 104 L 69 134 L 68 158" stroke-width="1.6" />
    ...
    <path d="M 222 54 L 258 54 L 255 104 L 225 104 Z" stroke-width="1.5" />
    <!-- B: bracos estendidos e aduzidos -->
    <path d="M 223 60 L 216 84 L 213 110" stroke-width="1.6" />
    <path d="M 257 60 L 264 84 L 267 110" stroke-width="1.6" />
    <circle cx="213" cy="112" r="3" stroke-width="1.3" />
    <circle cx="267" cy="112" r="3" stroke-width="1.3" />
    <!-- B: marca de hiperpronacao -->
    <path d="M 205 96 A 8 8 0 0 1 213 90" stroke-width="1.2" />
    <path d="M 275 96 A 8 8 0 0 0 267 90" stroke-width="1.2" />
    <!-- B: pernas estendidas, pes em flexao plantar -->
    <path d="M 229 104 L 227 134 L 226 158" stroke-width="1.6" />
...
::: entendimento
titulo: Por que o total sozinho engana
texto: |
...
::: conceito
titulo: O que muda quando o achado tem endereço
texto: |
  ...
  **Que achados são esses?** Semiologia Clínica os nomeia como sinais localizatórios que habitualmente indicam acometimento cortical específico: **hemiparesia, hemiplegia, hemianopsia, heminegligência e afasia**. E acrescenta dois grupos vizinhos, com endereços diferentes: alterações no padrão de resposta motora, respiratória e da motricidade ocular podem indicar sofrimento do sistema reticular por compressão; e **paralisias de nervos cranianos** apontam para acometimento direto do tronco encefálico.
  ...
  - a **hemiparesia** e sua graduação, o tônus e os reflexos que a acompanham são o tópico de força, tônus e reflexos, neste mesmo capítulo;
  - a **hemianopsia** e a técnica dos campos por confrontação estão no tópico de pares cranianos de I a VI;
  - as **paralisias de nervos cranianos** ocupam os dois tópicos de pares cranianos;
  - a **paralisia facial** como achado de assimetria, com a regra da testa, está no tópico de crânio e face;
...
::: conceito
titulo: O padrão respiratório como dado neurológico
texto: |
...
::: secao
titulo: Orientação, atenção e linguagem à beira do leito
:::
...
::: perola
texto: "Antes de escrever \"desorientado\", pergunte-se se o paciente ouviu a pergunta. Hipoacusia não corrigida é uma das causas mais frequentes de paciente rotulado como confuso — e o tópico de boca, nariz e ouvidos ensina como medir a audição à beira do leito em menos de um minuto."
:::
...
texto: |
  ...
  A última é a que mais custa caro quando passa despercebida: um paciente plenamente consciente, examinado como comatoso. A defesa é simples e cabe no exame de rotina — antes de concluir que não há resposta, **peça um movimento ocular vertical** e espere.
:::
...
texto: |
  ...
  - **Método de avaliação de confusão para delirium**: kappa de **0,70 a 0,91** — ou seja, quando existe um método explícito, a concordância sobe e se mantém alta.

  Contraste com a linha vizinha do **miniexame do estado mental**, cujo kappa vai de **0,28 a 0,80**: um intervalo largo, que atravessa desde concordância fraca até boa. A lição não é que o instrumento seja ruim, e sim a mesma que este guia vem repetindo em outros capítulos: **a reprodutibilidade depende de padronizar a aplicação**, não da existência do instrumento.

  E há uma leitura menos óbvia. O achado grosseiro — "este paciente está rebaixado" — é reprodutível; o julgamento fino — quanto e de que tipo — é que não é. Isso justifica a escolha editorial deste tópico: ensinar a **registrar o que se viu e com que estímulo**, e reservar os adjetivos para quem os definiu.
:::
...
colunas:
  ...
  - "Se ausente"
linhas:
  - - "Consciência comprometida sem trauma craniano: pressão sistólica de 160 mmHg ou mais, para lesão estrutural"
    - "7,3"
    - "0,6"
  - - "Paciente em coma: anisocoria acima de 1 mm, para lesão estrutural intracraniana"
    - "9,0"
    - "0,6"
  - - "Paciente em coma: reação fotomotora ausente em pelo menos um olho, para lesão estrutural intracraniana"
    - "3,6"
    - "0,2"
:::

::: conceito
titulo: Lendo a tabela — a pressão arterial e as pupilas como sinais neurológicos
nivel: avancado
texto: |
...
texto: |
  Este é o primeiro tópico do capítulo neurológico, e boa parte do que ele nomeia já foi ensinada em outros lugares do guia — ou será ensinada logo adiante, neste mesmo capítulo.

  - **A escada da consciência** — obnubilação, sonolência, confusão mental, torpor e coma —, o princípio de aumentar o estímulo até obter resposta e a distinção entre perceptividade e reatividade estão no tópico de ectoscopia, que prometeu este capítulo para o detalhamento da escala de Glasgow.
  - **O padrão respiratório**, com a definição de cada ritmo e a técnica de contagem em um minuto inteiro, está no tópico de temperatura e frequência respiratória; o **esforço respiratório** e seus sinais visíveis estão no tópico de inspeção do tórax.
  - **A pressão arterial**, sua técnica de medida e seus erros estão no tópico de pressão arterial; **a bradicardia** e as arritmias, no tópico de frequência cardíaca e pulso.
  - **A semiotécnica das pupilas** — luz oblíqua, ambiente escurecido, fotomotor direto e consensual — está no tópico de olhos; a **interpretação neurológica das pupilas**, com a manobra da luz alternante, é o tópico de pares cranianos de I a VI.
...
perguntas:
  - id: neu-con-1
    enunciado: Dois pacientes têm 9 pontos na escala de coma de Glasgow. O primeiro abre os olhos ao chamado, emite palavras desconexas e responde com flexão anormal. O segundo não abre os olhos, emite sons incompreensíveis e obedece a ordens verbais com o membro direito. Que conclusão o total permite?
    alternativas:
      - "Ambos estão em coma superficial, e a conduta inicial é a mesma nos dois casos"
      - "O segundo está mais grave, pois a ausência de abertura ocular é o componente de maior peso prognóstico da escala"
  ...
  - id: neu-con-2
    ...
    alternativas:
      - "Rebaixamento isolado do nível de consciência, cuja causa mais provável é lesão estrutural do sistema reticular ativador ascendente"
      - "Delirium hipoativo: há alteração do conteúdo da consciência com déficit de atenção, de etiologia orgânica, e a apresentação quieta é a que mais passa despercebida"
  ...
  - id: neu-con-5
    ...
    alternativas:
      - "Os achados oscilam com as fases do ciclo respiratório: na hiperpneia as pupilas dilatam e os reflexos ficam vivos; na apneia ocorre o oposto"
      - "Houve deterioração neurológica no intervalo, com progressão de uma herniação transtentorial"
  ...
  - id: neu-con-6
    ...
    alternativas:
      - "O sistema reticular determina o conteúdo da consciência, e o córtex, o nível; por isso lesões corticais causam coma com mais frequência"
      - "Ambos determinam apenas o nível de consciência, e o conteúdo depende exclusivamente de estruturas subcorticais profundas"

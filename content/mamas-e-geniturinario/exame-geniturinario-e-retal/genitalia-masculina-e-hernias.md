---
titulo: Genitália masculina e hérnias
ordem: 1
tags:
  - genitália masculina
  - exame geniturinário
...
::: checklist
titulo: Genitália masculina e hérnias em 10 passos
itens:
  - "Contrato feito: explicação prévia, consentimento verbal, oferta de acompanhante, luvas calçadas e exposição mínima."
  - "Pênis inspecionado com retração completa do prepúcio; glande e sulco balanoprepucial vistos por inteiro."
  - "Meato uretral entreaberto pela compressão anteroposterior da glande; secreção caracterizada se presente."
  - "Corpo do pênis palpado à procura de placas e endurecimentos."
  - "Bolsa escrotal inspecionada: pele, formato, simetria, sinais flogísticos."
  - "Testículos palpados com delicadeza e comparados; epidídimos individualizados pela manobra de Chevassu."
  - "Deferentes e cordões seguidos até o anel inguinal externo."
  - "Regiões inguinais examinadas de pé, em repouso e ao esforço (tosse ou Valsalva); redutibilidade testada e efeito do decúbito verificado."
  - "Varicocele procurada de pé, com Valsalva; transiluminação feita em toda bolsa escrotal aumentada."
  - "Reflexo cremastérico pesquisado e linfonodos inguinais palpados; achados registrados lado a lado."
:::
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M 196 138 L 208 144" stroke-width="1.4" />
    <circle cx="104" cy="88" r="7" stroke-width="1.6" />
    <circle cx="176" cy="120" r="7" stroke-width="1.6" />
    <path d="M 110 92 L 170 117" stroke-width="1" stroke-dasharray="3 3" />
    <path d="M 120 94 L 150 30" stroke-width="1.2" stroke-dasharray="5 3" />
    <path d="M 88 56 Q 97 74 104 88 L 176 120 Q 188 152 179 180" stroke-width="2.4" />
    <path d="M 175 172 L 179 180 L 183 173" stroke-width="1.6" />
    <path d="M 146 96 L 146 106" stroke-width="2.4" />
    <path d="M 142 102 L 146 106 L 150 102" stroke-width="1.6" />
    <circle cx="172" cy="148" r="6" stroke-width="1.4" stroke-dasharray="2 2" />
    <path d="M 160 172 Q 179 198 198 172" stroke-width="1.2" />
    <path d="M 72 100 L 96 90" stroke-width="0.8" />
    <path d="M 158 134 L 170 125" stroke-width="0.8" />
    <g font-family="sans-serif" font-size="7" fill="currentColor" stroke="none">
      <text x="8" y="38">espinha ilíaca</text>
      <text x="8" y="47">anterossuperior</text>
      <text x="206" y="156">púbis</text>
      <text x="30" y="97">anel inguinal</text>
      <text x="30" y="106">profundo</text>
      <text x="118" y="140">anel inguinal</text>
      <text x="118" y="149">superficial</text>
      <text x="128" y="24">vasos epigástricos</text>
      <text x="128" y="33">inferiores</text>
      <text x="62" y="70">indireta</text>
      <text x="152" y="90">direta</text>
      <text x="186" y="168">femoral</text>
      <text x="164" y="194">escroto</text>
      <text x="52" y="126">ligamento inguinal</text>
    </g>
    <g font-family="sans-serif" font-size="7" fill="currentColor" stroke="none">
      <text x="228" y="60">indireta: entra pelo anel</text>
      <text x="228" y="69">profundo, lateral aos vasos,</text>
      <text x="228" y="78">percorre o canal e pode</text>
      <text x="228" y="87">descer ao escroto</text>
      <text x="228" y="102">direta: abaúla a parede</text>
      <text x="228" y="111">medialmente aos vasos</text>
      <text x="228" y="126">femoral: abaixo do</text>
...
linhas:
  - - "Edema escrotal"
    - "Pele tensa com cacifo à compressão; acompanha edema generalizado (insuficiência cardíaca, síndrome nefrótica)"
    - "Não"
  - - "Orquite"
    - "Processo agudo; testículo doloroso e hipersensível, pele avermelhada"
    - "Não"
  - - "Torção do cordão"
  ...
  - - "Epididimite tuberculosa"
    ...
    - "Não"
  - - "Varicocele"
    - "Sensação de saco de minhocas à palpação, consistência mole, testículo individualizável; predomínio esquerdo (95%)"
    - "Não"
  - - "Espermatocele"
    - "Cística, indolor e móvel, imediatamente acima do testículo"
    - "Sim"
  - - "Tumor testicular"
    - "Nódulo duro e irregular no início; pode substituir o testículo inteiro"
    - "Não"
  - - "Hidrocele"
    - "Massa indolor na túnica vaginal; os dedos passam acima dela na bolsa"
    - "Sim"
  - - "Hérnia escrotal"
    - "Em geral inguinal indireta; sai pelo anel superficial e os dedos não penetram acima da massa; pode ser reduzida"
    - "Não"
:::
...
::: conceito
titulo: Seis erros no exame da genitália masculina
texto: |
...
perguntas:
  - id: gu-genitalia-1
    enunciado: Homem de 28 anos nota, no banho, uma área endurecida e indolor no testículo direito. A transiluminação da bolsa é negativa. Qual é a leitura correta do achado?
    alternativas:
      - "Espermatocele, porque as massas dessa topografia são quase sempre benignas e a conduta é expectante, com reavaliação em algumas semanas para documentar estabilidade"
      - "Hidrocele incipiente, dado que o acúmulo de líquido na túnica vaginal começa como endurecimento localizado antes de se tornar cístico"
  ...
  - id: gu-genitalia-2
    ...
    alternativas:
      - "Os dedos não conseguem passar acima da massa, a transiluminação é negativa e a tumoração diminui no decúbito, podendo ser reduzida por manobras"
      - "A massa é tensa, com brilho avermelhado à transiluminação, e o testículo não pode ser palpado separadamente dela, porque o conteúdo envolve a gônada por completo e afasta os planos"
  ...
  - id: gu-genitalia-4
    ...
    alternativas:
      - "Nada além de acompanhamento, porque varicocele é achado da puberdade sem repercussão após os 40 anos"
      - "Procurar tumor retroperitoneal: varicocele direita, de aparecimento súbito e que não esvazia no decúbito, é o padrão da varicocele secundária"

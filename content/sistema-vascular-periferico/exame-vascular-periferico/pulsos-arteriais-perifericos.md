...
perguntas:
  ...
  - id: vasc-pul-3
    ...
    corretaIndex: 2
    explicacao: "Porto separa os sopros arteriais por duração: os sistólicos aparecem nas estenoses e nas dilatações arteriais, e os sistodiastólicos ou contínuos, nas fístulas e nas malformações arteriovenosas. O mesmo vale para o frêmito, que é o correspondente tátil: sistólico nas estenoses e nos aneurismas, contínuo nas fístulas. Os estados hipercinéticos produzem sopros sistólicos, não contínuos. McGee registra o mesmo raciocínio para o cenário exato desta pergunta: em pacientes com hematoma inguinal ou sopro novo após cateterismo, o sopro femoral contínuo aponta fístula arteriovenosa."
  - id: vasc-pul-4
  ...
  - id: vasc-pul-5
    ...
    corretaIndex: 0
    explicacao: "McGee registra que a oclusão completa de um vaso deve fazer o sopro desaparecer: sem passagem estreitada não há turbilhonamento. Um sopro que some entre consultas é, portanto, ambíguo — pode corresponder tanto a melhora quanto a fechamento do vaso —, e é o pulso distal, não o estetoscópio, que resolve a dúvida. A compressão do receptor produz o efeito oposto, cria sopro onde não havia, e é por isso que Porto orienta auscultar sem comprimir."
  - id: vasc-pul-6
    enunciado: Em um paciente com membro inferior frio e pálido, você tem a impressão de sentir um pulso tibial posterior fraco. Que cuidado Porto recomenda antes de registrar esse achado?
    alternativas:

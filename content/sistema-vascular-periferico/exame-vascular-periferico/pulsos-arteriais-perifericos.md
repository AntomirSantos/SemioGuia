---
titulo: Pulsos arteriais periféricos
ordem: 1
tags:
  ...
  - simetria dos pulsos
  - palpação simultânea
  - graduação da amplitude
  - retardo radiofemoral
  - coarctação da aorta
  - sopro arterial
  - sopro femoral
  - frêmito
  ...
  - pulsos anômalos
  - circulação colateral arterial
  - ausência congênita de pulso
  - concordância entre observadores
  - razão de verossimilhança
  - estação OSCE
referencias:
  - "Porto, Exame Clínico, 8ª ed., cap. 13 (Exame dos Pulsos Radial, Periféricos e Venoso), pulsos periféricos: finalidade do exame, lista das artérias a examinar (Figura 13.3) e semiotécnica de cada uma (Figuras 13.4 a 13.7); comparação com o lado homólogo pela palpação simultânea das radiais; manobras especiais de Allen, de Adson, costoclavicular e de hiperabdução; manobra da isquemia provocada; boxe Dados semiológicos mais importantes da palpação das artérias periféricas, com o frêmito e a parede endurecida e tortuosa"
  - "Porto, Semiologia Médica, 8ª ed., Parte 10 (Sistema Cardiovascular), Seção 2 (Artérias), cap. 51 (Exame Clínico), exame físico das artérias: inspeção, palpação da temperatura, elasticidade, umidade e frêmito; palpação sistematizada dos pulsos com a polpa dos 2º a 5º dedos e a advertência sobre o polegar (Figura 51.5); artérias acessíveis à palpação (Figura 51.4) e o conjunto de rotina; graduação da amplitude; sinal de Cowie e pulsos anômalos; ausculta dos trajetos arteriais e graduação dos sopros; manobras de Adson, costoclavicular, costoclavicular passiva, de hiperabdução e de Allen (Figuras 51.7 a 51.10)"
  - "Semiologia Clínica, 1ª ed., cap. 12 (Exame do sistema vascular periférico), parâmetros da palpação arterial (ritmo, frequência, amplitude e simetria) e a graduação da amplitude de 0 a 3+; localização de cada pulso; cuidados com o bulbo carotídeo e a proibição de palpar as duas carótidas ao mesmo tempo; padrões de pulso descritos em doenças específicas; ausculta em busca de sopros cervicais, femorais e abdominais; Tabela 1 (reconhecimento de síndromes clínicas pelos achados de exame)"
...
::: conceito
titulo: Dez segundos de mão que substituem um exame
texto: |
  ...
  **O que este tópico não reensina.** A técnica do **pulso radial**, a contagem, o ritmo, a irregularidade da fibrilação atrial, o déficit de pulso e o vocabulário dos tipos de onda (célere, parvus, alternante, bisferiens, paradoxal) pertencem ao tópico de frequência cardíaca e pulso, no capítulo de sinais vitais. Aqui a radial aparece apenas como um dos pontos da sequência e como o **par comparativo** de outras artérias.
  ...
  - **carótidas e jugulares**, com a distinção entre pulsação arterial e pulso venoso, estão no tópico de pulso venoso jugular e turgência;
  - **sopros sobre a aorta abdominal, as renais e as ilíacas** estão no tópico de inspeção e ausculta do abdome, com a frequência de sopros em pessoas sadias;
  - **a palpação da aorta abdominal e a pulsação expansiva** estão no tópico de palpação do abdome;
...
::: perola
texto: "Pulso periférico não se descreve sozinho, descreve-se aos pares. A frase útil não é pedioso fino, é pedioso fino à direita e cheio à esquerda, porque é a diferença entre os dois lados, e não a impressão absoluta de um deles, que localiza a artéria doente."
:::
...
::: manobra
titulo: Sequência dos pulsos arteriais periféricos
passos:
  - "Aqueça as mãos e exponha os quatro membros e o pescoço; deixe o paciente em decúbito dorsal, com a cabeceira baixa e a musculatura relaxada."
  - "Palpe sempre com as polpas do indicador, do médio e do anular, encostadas lado a lado; evite o polegar, que tem pulso próprio e engana o examinador."
  - "Na dúvida entre o pulso do paciente e o seu, palpe ao mesmo tempo o seu próprio pulso e conte: frequências iguais denunciam que o que você sente é a sua mão."
  - "Comece pelas carótidas, uma de cada vez, afastando a borda anterior do esternocleidomastóideo com o paciente sentado ou deitado; nunca comprima as duas ao mesmo tempo."
  - "Siga pelos membros superiores: braquial no sulco entre os músculos do braço, radial no punho e ulnar na borda oposta do mesmo punho."
  - "Palpe a aorta abdominal entre o apêndice xifoide e o umbigo, com as coxas semifletidas, e depois as ilíacas ao longo da linha que vai do umbigo ao meio do ligamento inguinal."
  - "Nos membros inferiores, palpe femoral, poplítea, tibial posterior e pediosa, nessa ordem, de proximal para distal."
  - "Palpe simultaneamente os pares homólogos (as duas radiais, as duas femorais, as duas pediosas) e compare a amplitude de cada par antes de passar ao seguinte."
  - "Palpe ao mesmo tempo a radial e a femoral do mesmo lado e verifique se os dois impulsos chegam juntos."
  - "Ao encontrar pulso diminuído ou ausente, procure o pulso imediatamente proximal e defina entre quais dois pontos o fluxo se perde."
  - "Deslize os dedos ao longo do trajeto palpável de cada artéria avaliando a parede: lisa e depressível, ou endurecida e tortuosa."
  - "Procure frêmito no mesmo trajeto, sem comprimir o vaso, e gradue-o em cruzes de + a ++++."
...
::: checklist
titulo: Exame dos pulsos periféricos em 10 passos
itens:
  - "Membros e pescoço expostos, paciente em decúbito dorsal relaxado e mãos do examinador aquecidas."
  - "Palpação feita com as polpas do indicador, médio e anular, sem uso do polegar."
  - "Carótidas palpadas uma de cada vez, com delicadeza e nunca simultaneamente."
  - "Pulsos dos membros superiores palpados dos dois lados: braquial, radial e ulnar."
  - "Aorta abdominal e ilíacas palpadas com as coxas semifletidas."
  - "Pulsos dos membros inferiores palpados dos dois lados: femoral, poplíteo, tibial posterior e pedioso."
  - "Cada par homólogo comparado por palpação simultânea, com registro da amplitude de cada lado."
  - "Radial e femoral do mesmo lado palpadas ao mesmo tempo para verificar retardo."
  - "Parede arterial avaliada quanto a endurecimento e tortuosidade, e trajetos pesquisados quanto a frêmito."
  - "Ausculta de carótidas, aorta abdominal, ilíacas e femorais realizada sem comprimir o vaso."
:::
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none">
      <text x="8" y="13">Pontos de palpação dos pulsos</text>
    </g>
    <!-- silhueta -->
    <circle cx="120" cy="34" r="13" stroke-width="1.5" />
    <path d="M 120 47 L 120 60" stroke-width="1.4" />
    <path d="M 99 62 L 141 62" stroke-width="1.5" />
    <path d="M 103 62 L 100 116" stroke-width="1.5" />
    <path d="M 137 62 L 140 116" stroke-width="1.5" />
    <path d="M 100 116 L 140 116" stroke-width="1.5" />
    <path d="M 101 68 L 84 104" stroke-width="1.5" />
    <path d="M 84 104 L 80 134" stroke-width="1.5" />
    <path d="M 139 68 L 156 104" stroke-width="1.5" />
    <path d="M 156 104 L 160 134" stroke-width="1.5" />
    <path d="M 106 116 L 100 178" stroke-width="1.5" />
    <path d="M 134 116 L 140 178" stroke-width="1.5" />
    <path d="M 100 178 L 92 184" stroke-width="1.3" />
    <path d="M 140 178 L 148 184" stroke-width="1.3" />
    <!-- pontos -->
    <g stroke-width="1.6">
      <circle cx="110" cy="30" r="3.2" />
      <circle cx="112" cy="52" r="3.2" />
      <circle cx="104" cy="60" r="3.2" />
      <circle cx="92" cy="86" r="3.2" />
      <circle cx="81" cy="126" r="3.2" />
      <circle cx="79" cy="133" r="3.2" />
      <circle cx="120" cy="88" r="3.2" />
      <circle cx="120" cy="104" r="3.2" />
      <circle cx="110" cy="118" r="3.2" />
      <circle cx="104" cy="150" r="3.2" />
      <circle cx="103" cy="172" r="3.2" />
      <circle cx="98" cy="180" r="3.2" />
    </g>
    <!-- rotulos esquerda -->
    <g font-family="sans-serif" font-size="8" fill="currentColor" stroke="none" text-anchor="end">
      <text x="74" y="32">temporal superficial</text>
    ...
    <g font-family="sans-serif" font-size="8" fill="currentColor" stroke="none">
      <text x="170" y="90">aórtico abdominal</text>
      <text x="170" y="106">ilíaco</text>
      <text x="170" y="120">femoral</text>
      <text x="170" y="152">poplíteo (atrás)</text>
      <text x="170" y="174">tibial posterior</text>
      <text x="170" y="184">pedioso</text>
    </g>
    <g stroke-width="0.9">
      <path d="M 123 88 L 168 88" />
      <path d="M 123 104 L 168 104" />
      <path d="M 113 118 L 168 118" />
      <path d="M 107 150 L 168 150" />
      <path d="M 106 172 L 168 172" />
      <path d="M 101 181 L 168 181" />
    </g>
    <g font-family="sans-serif" font-size="7.5" fill="currentColor" stroke="none">
      <text x="8" y="196">Cada ponto existe dos dois lados; os nomes foram separados só para caber na figura.</text>
    </g>
  </svg>
legenda: "Os pontos de palpação, do alto para baixo. A figura mostra os nomes de um lado por vez, mas o exame é sempre bilateral: cada artéria só significa alguma coisa quando comparada com a sua homóloga. Repare que a sequência desce de proximal para distal em cada membro: é assim que se descobre entre quais dois pontos o fluxo se perde."
:::

::: secao
titulo: Ponto por ponto
:::

::: tabela
titulo: Onde encostar os dedos
colunas:
  - "Pulso"
  - "Reparo anatômico"
  - "Detalhe da técnica"
linhas:
  - - "Temporal superficial"
    - "Acima da articulação temporomandibular, logo adiante do trago; também acima da arcada supraorbitária, no ramo frontal"
    - "Indicador e médio; é o pulso que fica espessado e tortuoso na arterite temporal"
  - - "Carotídeo"
    - "Borda anterior do esternocleidomastóideo, na altura da laringe ou no terço inferior do pescoço"
    - "Um lado de cada vez, com delicadeza; a compressão do bulbo carotídeo pode provocar bradicardia e síncope"
  - - "Subclávio"
    - "Fossa supraclavicular, profundamente e por trás da clavícula"
    - "Paciente sentado, com leve flexão da cabeça para o lado examinado; difícil em obesos e brevilíneos"
  - - "Axilar"
    - "Oco axilar, comprimindo a artéria contra o colo do úmero"
  ...
  - - "Ulnar"
    - "Mesma face do punho, entre os tendões do flexor superficial dos dedos e do flexor ulnar do carpo"
    - "Polegar apoiado no dorso do punho como ponto de fixação"
  - - "Aórtico abdominal"
    - "Entre o apêndice xifoide e a cicatriz umbilical, comprimindo contra a coluna"
    - "Coxas semifletidas; uma mão sobre a outra; difícil em obesos e musculosos"
  - - "Ilíaco"
    - "Ao longo da linha traçada do umbigo até o meio do ligamento inguinal"
    - "Usa-se a mão do mesmo lado, com indicador, médio e anular, e a outra apoiada por cima"
  - - "Femoral"
    - "Logo abaixo do ligamento inguinal, a meio caminho entre a sínfise púbica e a espinha ilíaca anterossuperior"
...
::: entendimento
titulo: Por que a amplitude vale mais que a presença
texto: |
  Pulso é onda de pressão, não é sangue passando. A onda gerada pela sístole corre pela parede arterial muito mais depressa do que a coluna de sangue e chega ao punho antes dele.

  Daí duas consequências práticas.
...
causas:
  ...
  - "Aneurisma"
  - "Fístula arteriovenosa, congênita, traumática ou cirúrgica"
...
::: secao
titulo: O retardo radiofemoral
:::

::: conceito
titulo: Duas mãos, dois pulsos, uma pergunta
texto: |
...
::: conceito
titulo: O pulso pedioso ausente na pessoa saudável
nivel: avancado
texto: |
  ...
  **Os números compilados**, reunidos de estudos com grandes números de pessoas saudáveis:
  ...
  - os **dois pulsos do pé** faltam ao mesmo tempo em apenas **0% a 2%** das pessoas saudáveis.

  A explicação do terceiro número está nos dois primeiros: quando uma dessas artérias é congenitamente pequena ou ausente, **a outra aumenta e compensa a diferença**. É raro que as duas faltem por acaso.
...
colunas:
  ...
  - "Estatística kappa"
linhas:
  - - "Pulso periférico presente ou ausente"
    - "0,52 a 0,92"
  - - "Pulso periférico normal ou diminuído"
    - "0,01 a 0,15"
  - - "Extremidades frias ou não"
    - "0,46"
:::

::: conceito
titulo: "Lendo a tabela: o achado que se reproduz e o que não se reproduz"
nivel: avancado
texto: |
  Esta tabela é curta e diz uma coisa desconfortável.
  ...
  **Perguntar se o pulso está diminuído não é.** A concordância para normal ou diminuído vai de **0,01 a 0,15**, o que é praticamente concordância por acaso. É um dos piores números de toda a tabulação de concordância, e ele convive com o fato de que a amplitude comparada é justamente o parâmetro considerado o principal do exame.
  ...
  Vale a mesma cautela para as **extremidades frias** (concordância 0,46), achado que reaparece no tópico seguinte com desempenho diagnóstico próprio.
:::
...
texto: |
  Este é o tópico de abertura do capítulo vascular, e quase tudo o que ele usa foi ensinado antes.

  - **A técnica do pulso radial**, a contagem em 60 segundos, o ritmo, a fibrilação atrial, o déficit de pulso e os tipos de onda de pulso estão no tópico de frequência cardíaca e pulso. Aqui a radial só aparece como ponto da sequência e como par comparativo.
  - **A palpação das carótidas em relação ao pulso venoso**, com a distinção entre pulsação arterial e pulso venoso e a turgência jugular, está no tópico de pulso venoso jugular e turgência.
  - **A medida da pressão nos quatro membros**, a pressão diferencial e a fístula arteriovenosa como causa de pressão divergente estão no tópico de pressão arterial.
  - **Os sopros abdominais** (sobre a aorta, as renais e as ilíacas) com os pontos de referência e a frequência em pessoas sadias, estão no tópico de inspeção e ausculta do abdome. **A palpação da aorta abdominal, a pulsação expansiva e o aneurisma** estão no tópico de palpação do abdome, e voltam ao capítulo no tópico de isquemia aguda e aneurismas apenas pela leitura vascular.
  - **A graduação de Levine e a irradiação dos sopros cardíacos** estão no tópico de sopros cardíacos; os sopros arteriais periféricos usam a escala de cruzes, como o frêmito e o edema.
  - **O enchimento capilar**, achado de moldura comparativo entre os lados, está no tópico de antropometria e hidratação, e reaparece com desempenho medido no tópico de insuficiência arterial crônica.
  - **A marcha claudicante** como tipo de marcha está no tópico de ectoscopia e no de marcha e sinais meníngeos; a **claudicação intermitente** como sintoma vascular é do tópico seguinte.
  - **O Doppler portátil e a fluxometria** são nomeados aqui como moldura e não são ensinados neste guia.
:::
...
perguntas:
  - id: vasc-pul-1
    enunciado: Em um homem de 68 anos com dor na panturrilha ao caminhar, você não palpa o pulso pedioso nem o tibial posterior à direita, e ambos estão presentes à esquerda. Qual é o peso desse achado?
    alternativas:
      - "Peso grande: a ausência dos dois pulsos do pé ocorre em apenas 0% a 2% das pessoas saudáveis, porque, quando uma dessas artérias é pequena, a outra costuma compensar"
      - "Peso pequeno, porque o pulso pedioso está ausente em 3% a 14% das pessoas saudáveis e o achado é compatível com variação anatômica"
  ...
  - id: vasc-pul-2
    ...
    corretaIndex: 1
    explicacao: "Uma escala gradua de 0 a ++: 0 ausente, + diminuído, ++ normal, três degraus, nenhum deles para o pulso aumentado. Outra gradua de 0 a 3+: 0 ausente, 1+ reduzido, 2+ normal, 3+ aumentado. As duas concordam nos três primeiros degraus, e é no topo que se separam: ++ é o teto de uma escala e 2+ é o meio da outra. Daí as duas consequências: o pulso hipercinético é irregistrável na primeira notação, e quem lê ++ não sabe se o autor o considerou normal ou se apenas não dispunha do degrau seguinte. Uma terceira referência sequer propõe escala numérica: pede a comparação da amplitude entre artérias homólogas. A saída é nomear a escala ou, melhor, descrever a comparação entre os lados. O ritmo e a frequência pertencem ao exame do pulso radial, no capítulo de sinais vitais, e não se avaliam nos pulsos do pé."
  - id: vasc-pul-3
    ...
    alternativas:
      - "Estenose aterosclerótica crítica da femoral superficial"
      - "Estado hipercinético, como na anemia ou depois de exercício intenso"
      - "Comunicação anômala entre artéria e veia: uma fístula arteriovenosa"
      - "Compressão extrínseca do vaso por hematoma, sem lesão da parede"
    corretaIndex: 2
    explicacao: "Os sopros arteriais se separam por duração: os sistólicos aparecem nas estenoses e nas dilatações arteriais, e os sistodiastólicos ou contínuos, nas fístulas e nas malformações arteriovenosas. O mesmo vale para o frêmito, que é o correspondente tátil: sistólico nas estenoses e nos aneurismas, contínuo nas fístulas. Os estados hipercinéticos produzem sopros sistólicos, não contínuos. O mesmo raciocínio vale para o cenário exato desta pergunta: em pacientes com hematoma inguinal ou sopro novo após cateterismo, o sopro femoral contínuo aponta fístula arteriovenosa."
  - id: vasc-pul-4
    enunciado: Ao palpar simultaneamente a artéria radial e a artéria femoral do mesmo lado em um jovem hipertenso, você percebe que o impulso femoral chega depois do radial. Como interpretar?
    alternativas:
      - "Achado normal e sem valor semiológico: como a onda de pulso percorre até a femoral uma distância bem maior do que até o punho, o atraso do impulso femoral é esperado em qualquer pessoa examinada dessa forma"
      - "Achado sem valor isolado, porque a percepção de retardo depende de cronômetro e não é reprodutível à palpação"
      - "Sinal de doença arterial periférica aortoilíaca, cujo achado inicial é o retardo do pulso femoral"
      - "Sinal de coarctação da aorta, em que o pulso femoral é retardado tanto pela demora em alcançar as pernas quanto pela condução mais rápida da onda até os braços"
    corretaIndex: 3
    explicacao: "Define-se o normal pela impossibilidade de distinguir qual pulso chega primeiro durante a palpação simultânea de femoral e radial em pessoas saudáveis. Na coarctação da aorta o femoral é retardado, por dois mecanismos somados: a onda demora mais a alcançar as pernas e é conduzida aos braços mais depressa que o normal. O quadro completo inclui hipertensão nos braços, 96% com pressão acima de 140/90, pulsos femorais ausentes ou diminuídos e retardados em 100% dos casos, pulsações carotídeas aumentadas, sopros e colaterais visíveis ao redor da escápula, nos intercostais ou na axila. Na doença aterosclerótica aortoilíaca o pulso femoral está diminuído ou ausente, e não caracteristicamente retardado."
  - id: vasc-pul-5
    enunciado: Um paciente em acompanhamento por claudicação tinha sopro femoral direito há seis meses; hoje o sopro desapareceu. Qual é a leitura correta?
    alternativas:
      - "O desaparecimento do sopro pode significar oclusão completa do vaso, já que o sopro nasce do turbilhonamento na passagem estreitada; quem separa melhora de oclusão é o pulso distal"
      - "O desaparecimento do sopro indica regressão da placa e melhora do fluxo, e permite espaçar o seguimento"
      - "O desaparecimento do sopro é irrelevante, porque os sopros arteriais periféricos são achados inconstantes, que dependem sobretudo da pressão exercida pelo receptor do estetoscópio e não guardam correlação com o calibre da luz do vaso"
      - "O desaparecimento do sopro indica que houve erro na ausculta anterior, provavelmente por compressão do receptor sobre o vaso"
    corretaIndex: 0
    explicacao: "Sabe-se que a oclusão completa de um vaso deve fazer o sopro desaparecer: sem passagem estreitada não há turbilhonamento. Um sopro que some entre consultas é, portanto, ambíguo, pode corresponder tanto a melhora quanto a fechamento do vaso, e é o pulso distal, não o estetoscópio, que resolve a dúvida. A compressão do receptor produz o efeito oposto, cria sopro onde não havia, e é por isso que se orienta auscultar sem comprimir."
  - id: vasc-pul-6
    enunciado: Em um paciente com membro inferior frio e pálido, você tem a impressão de sentir um pulso tibial posterior fraco. Que cuidado se recomenda antes de registrar esse achado?
    alternativas:
      - "Repetir a palpação com o polegar, mais sensível para pulsos de pequena amplitude"
      - "Aceitar o achado, porque na oclusão arterial o pulso desaparece proximalmente e se mantém distalmente por circulação colateral"
      - "Confirmar com atenção, porque a sensação pode corresponder à transmissão da onda de um pulso proximal através dos tecidos"
      - "Elevar o membro a 90 graus para aumentar a amplitude do pulso antes da nova palpação"
    corretaIndex: 2
    explicacao: "Sabe-se que a palpação dos pulsos na oclusão arterial deve ser feita atentamente, porque às vezes os dedos julgam ter encontrado um pulso, e o que chegou até eles foi a onda de um pulso proximal transmitida pelos tecidos. O polegar é justamente o dedo a evitar, por ter pulso próprio. Na oclusão arterial os pulsos desaparecem distalmente à obstrução, podendo estar apenas diminuídos proximalmente por espasmo: o inverso do que a segunda alternativa afirma. Elevar o membro isquêmico não aumenta a amplitude: produz palidez plantar, que é a base da manobra de isquemia provocada, tratada no tópico seguinte."
:::

...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <g stroke-width="1.5">
      ...
      <path d="M 120 128 C 138 133, 154 147, 162 166" />
    </g>
    <!-- linha hemiclavicular esquerda -->
    <path d="M 150 40 L 150 188" stroke-width="1.5" stroke-dasharray="5 4" />
    <!-- ictus cordis normal -->
    <circle cx="150" cy="122" r="6" fill="currentColor" stroke="none" />
    <!-- ictus deslocado para baixo e para fora -->
    <circle cx="166" cy="150" r="8" stroke-width="1.5" stroke-dasharray="4 3" />
    <!-- legenda -->
    <circle cx="204" cy="48" r="5" fill="currentColor" stroke="none" />
    <circle cx="204" cy="100" r="6" stroke-width="1.5" stroke-dasharray="4 3" />
    <g font-family="sans-serif" font-size="10" fill="currentColor" stroke="none">
      <text x="216" y="46">ictus normal</text>
      <text x="216" y="60">5º EIC, na LHC</text>
      <text x="216" y="98">ictus deslocado</text>
      <text x="216" y="112">dilatação do VE</text>
      <text x="196" y="156">LHC = linha</text>
      <text x="196" y="169">hemiclavicular</text>
    </g>
  </svg>
legenda: "O ictus cordis normal cruza a linha hemiclavicular esquerda no 5º espaço intercostal. A dilatação do ventrículo esquerdo o empurra para baixo e para fora."
:::
...
passos:
  ...
  - "Repouse a palma da mão sobre a área de batimentos para julgar a intensidade e o tipo de impulsão."
  - "Se o ictus não for encontrado, peça ao paciente que role para o decúbito lateral esquerdo, expire por completo e fique alguns segundos sem respirar; em mulheres, pode ser necessário afastar a mama esquerda."
  - "Ausculte as bulhas enquanto palpa, para saber se cada movimento da parede é sistólico ou diastólico."
  - "Palpe a borda esternal esquerda baixa com a região hipotenar, o 2º espaço intercostal de cada lado, o epigástrio e a fúrcula esternal."
  - "Pesquise frêmito com a face palmar dos dedos sobre as áreas de ausculta e determine, para cada frêmito, localização, situação no ciclo e intensidade."
observar: |
  Palpar o precórdio é tocar o corpo de alguém em um momento de fragilidade. Avise o que vai fazer, aqueça as mãos e descubra apenas o necessário. O gesto que para o examinador é rotina, para o paciente é a prova de que ele está sendo cuidado.
:::

::: checklist
titulo: Inspeção e palpação do precórdio em 10 passos
itens:
  - "Paciente em decúbito dorsal, tórax descoberto, examinador do lado direito."
  - "Inspeção tangencial e frontal da região precordial em busca de abaulamento ou retração."
  - "Localização do ictus cordis: espaço intercostal e relação com a linha hemiclavicular."
  - "Extensão do ictus medida em polpas digitais."
  - "Intensidade e tipo de impulsão avaliados com a palma da mão apoiada."
  - "Decúbito lateral esquerdo em apneia expiratória quando o ictus não for palpável em decúbito dorsal."
  - "Pesquisa de levantamento em massa do precórdio na borda esternal esquerda baixa."
  - "Pesquisa de retração sistólica apical, com ausculta simultânea para cronometrar o movimento."
  - "Pesquisa de pulsação epigástrica e de pulsação na fúrcula esternal."
  - "Pesquisa de frêmito nas áreas de ausculta, com registro de localização, tempo no ciclo e intensidade."
:::

::: secao
titulo: O ictus cordis
:::

::: conceito
titulo: Localização
texto: |
  O ictus cordis, ou choque da ponta, corresponde ao contato da ponta do ventrículo esquerdo com o gradil costal. Na maioria das pessoas, ele cruza a linha hemiclavicular esquerda entre o 4º e o 5º espaço intercostal.

  O biotipo desloca esse ponto de referência.
...
::: conceito
titulo: Propulsivo, difuso e globoso
nivel: avancado
texto: |
  A linguagem semiológica consagrou dois adjetivos que vale a pena usar com precisão.
  ...
  - **Insuficiência aórtica** (sobrecarga de volume): hipertrofia associada à dilatação. Ictus vigoroso, propulsivo, difuso, deslocado para o 6º, 7º ou 8º espaço, podendo alcançar a linha axilar anterior.
  - **Hipertensão arterial e estenose aórtica** (sobrecarga de pressão, sem dilatação inicial): ictus recoberto por duas polpas, com deslocamento pequeno, raramente além do 6º espaço, mas nitidamente propulsivo e musculoso.
:::

::: conceito
titulo: Hipercinético, sustentado e retrátil
nivel: avancado
texto: |
...
causas:
  ...
  - "Estenose pulmonar"
  - "Cardiopatias congênitas com sobrecarga de câmaras direitas"
:::
...
perguntas:
  ...
  - id: precordio-2
    ...
    alternativas:
      ...
      - "Insuficiência aórtica com dilatação do ventrículo esquerdo"
      - "Derrame pericárdico volumoso"
    corretaIndex: 0
    explicacao: "Levantamento em massa do precórdio, retração sistólica apical e pulsação epigástrica formam o conjunto da sobrecarga de câmaras direitas. O ictus permanece no lugar porque o ventrículo direito não participa da ponta do coração."
  - id: precordio-3
  ...
  - id: precordio-5
    ...
    alternativas:
      - "Cor, temperatura e sensibilidade da pele suprajacente"

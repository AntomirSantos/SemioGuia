...
::: conceito
titulo: Sete características a descrever
texto: |
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <!-- marcadores de B1 e B2 no topo -->
    <g font-family="sans-serif" font-size="10" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="48" y="14">B1</text>
      <text x="150" y="14">B2</text>
      <text x="282" y="14">B1</text>
    </g>
    <!-- faixa 1: sistólico de ejeção -->
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none">
      <text x="6" y="30">sistólico de ejeção</text>
    </g>
    <g stroke-width="1.5">
      <path d="M 40 46 L 292 46" stroke-dasharray="3 3" />
      <path d="M 48 32 L 48 46" stroke-width="2" />
    ...
    <g stroke-width="1.5">
      <path d="M 40 82 L 292 82" stroke-dasharray="3 3" />
      <path d="M 48 68 L 48 82" stroke-width="2" />
    ...
    <g stroke-width="1.5">
      <path d="M 40 118 L 292 118" stroke-dasharray="3 3" />
      <path d="M 48 104 L 48 118" stroke-width="2" />
    ...
    <g stroke-width="1.5">
      <path d="M 40 154 L 292 154" stroke-dasharray="3 3" />
      <path d="M 48 140 L 48 154" stroke-width="2" />
    ...
    <g stroke-width="1.5">
      <path d="M 40 190 L 292 190" stroke-dasharray="3 3" />
      <path d="M 48 176 L 48 190" stroke-width="2" />
...
::: secao
titulo: Como caracterizar um sopro
:::

::: manobra
titulo: Caracterização de um sopro à beira do leito
passos:
...
::: checklist
titulo: Descrição completa de um sopro
itens:
  - "Fase do ciclo determinada com a palpação simultânea do pulso carotídeo."
  - "Momento dentro da fase: proto, meso, tele ou holo."
  - "Mecanismo provável: ejeção (começa após B1, termina antes de B2) ou regurgitação (recobre B1 e ocupa toda a sístole)."
  - "Ponto de maior intensidade identificado no precórdio."
  - "Irradiação pesquisada para pescoço, axila, dorso e epigástrio."
  - "Intensidade graduada de 1 a 6, com pesquisa de frêmito."
  - "Timbre, tonalidade e configuração descritos."
  - "Comportamento na inspiração profunda (Rivero-Carvallo) registrado."
  - "Ausculta repetida em decúbito lateral esquerdo e sentado inclinado para a frente."
...
::: entendimento
titulo: Duas regurgitações que não são a mesma coisa
texto: |
...
linhas:
  - - "1/6"
    - "Muito fraco; só é ouvido com esforço deliberado e em ambiente silencioso"
  - - "2/6"
    - "Fraco, porém reconhecido logo que o receptor é apoiado no tórax"
  - - "3/6"
    - "Alto, sem frêmito"
  - - "4/6"
    - "Alto, com frêmito palpável; exige contato completo do receptor com a pele"
  - - "5/6"
    - "Muito alto; ainda audível com apenas a borda do receptor tocando a pele"
  - - "6/6"
    - "Audível mesmo com o receptor afastado da parede torácica"
:::

::: conceito
titulo: Sobre a graduação e as cruzes
nivel: avancado
texto: |
  A escala de 1 a 6 nasceu do trabalho de Freeman e Levine, depois modificado por Constant e Lippschutz, e é conhecida como sistema de graduação de Levine. Foi concebida para sopros sistólicos, mas na prática é aplicada a todos.
...
texto: |
  ...
  - O sopro da **persistência do canal arterial** é mais bem ouvido na região interescapulovertebral esquerda.
...
::: tabela
titulo: O que cada manobra faz e o que ela responde
colunas:
  - "Manobra"
  - "Como fazer"
  - "Efeito hemodinâmico"
  - "Interpretação"
linhas:
  - - "Rivero-Carvallo (inspiração)"
    - "Receptor na área tricúspide; pedir inspiração profunda com respiração regular"
    - "Aumenta o retorno venoso ao coração direito"
    - "Sopro que aumenta é de origem direita (tricúspide ou pulmonar); se não muda ou diminui, é propagação de um sopro esquerdo"
  - - "Expiração forçada"
    - "Pedir que o paciente esvazie o peito e mantenha a apneia"
    - "Favorece o enchimento das câmaras esquerdas"
    - "Torna mais audíveis os sopros das lesões aórticas"
  - - "Valsalva"
  ...
  - - "Elevação passiva das pernas"
    - "Elevar as pernas a 45° com o paciente deitado; avaliar 15 a 20 segundos depois"
    - "Aumenta o retorno venoso"
    - "Sopro que diminui sugere cardiomiopatia hipertrófica; é a manobra praticável no paciente frágil"
  - - "Prensão palmar sustentada (handgrip)"
  ...
  - - "Decúbito lateral esquerdo (Pachón)"
    ...
    - "Acentua o ruflar da estenose mitral e as bulhas diastólicas da ponta"
  - - "Exercício físico"
    - "Sentar e deitar repetidamente ou exercício equivalente"
    - "Aumenta a velocidade do fluxo e o tônus adrenérgico"
    - "Intensifica sopros discretos, em especial o ruflar da estenose mitral"
:::

::: conceito
titulo: O peso das manobras
nivel: avancado
texto: |
  As manobras não são simetricamente úteis. Vale conhecer o poder de cada uma.
...
texto: |
  ...
  Antes de fechar o rótulo, descarte febre e anemia, as duas causas mais frequentes desses sopros em crianças.
:::
...
::: secao
titulo: Correlação com as quatro valvopatias principais
:::

::: tabela
titulo: Estenose aórtica, insuficiência aórtica, estenose mitral e insuficiência mitral
colunas:
  - "Lesão"
  - "Sopro"
  - "Local e irradiação"
  - "Achados que acompanham"
linhas:
  - - "Estenose aórtica"
    - "Sistólico de ejeção, em crescendo-decrescendo, rude e granuloso"
    - "Foco aórtico e aórtico acessório, irradiando para os vasos do pescoço; em muitos pacientes é mais intenso na ponta"
    - "Pulso de pequena amplitude e ascensão lenta (parvus et tardus, anacrótico); componente aórtico de B2 diminuído; ictus propulsivo pouco deslocado; B4; frêmito sistólico"
  - - "Insuficiência aórtica"
    - "Diastólico aspirativo, de alta frequência, em decrescendo"
    - "Foco aórtico acessório, irradiando para a ponta; melhor com o paciente sentado, inclinado para a frente, em apneia expiratória, com o diafragma"
    - "Pulso célere em martelo d'água; pressão diferencial alargada; ictus deslocado, amplo e propulsivo; pulsações visíveis na fúrcula e nas carótidas"
  - - "Estenose mitral"
    - "Ruflar diastólico, de baixa frequência, com reforço pré-sistólico"
    - "Foco mitral, com pouca irradiação; melhor em decúbito lateral esquerdo, com a campânula"
    - "B1 hiperfonética de timbre metálico; estalido de abertura mitral; ictus normal ou reduzido; fibrilação atrial é complicação frequente"
  - - "Insuficiência mitral"
    - "Sistólico de regurgitação, holossistólico, em platô, suave"
    - "Foco mitral, irradiando para a axila e o dorso"
    - "B1 mascarada pelo sopro; B3; aumenta com a prensão palmar sustentada; ictus deslocado quando há dilatação ventricular"
:::
...
nivel: avancado
texto: |
  Reconhecer o sopro é o primeiro passo; estimar a gravidade é o segundo, e nem sempre é a intensidade que ajuda.
...
::: conceito
titulo: Cinco erros que mudam o diagnóstico
texto: |
  1. **Deduzir gravidade da intensidade.** Sopros intensos podem vir de defeitos pequenos e sopros discretos de lesões graves. A intensidade orienta, não decide.
...
perguntas:
  ...
  - id: sopros-2
    ...
    alternativas:
      - "Entre 2 e 3, marcada pela presença de irradiação"
      - "Entre 3 e 4, marcada pela presença de frêmito palpável"
      - "Entre 4 e 5, marcada pela audibilidade com o receptor afastado do tórax"
      - "Entre 1 e 2, marcada pela necessidade de ambiente silencioso"
    corretaIndex: 1
    explicacao: "Sopros de graus 1 a 3 não têm frêmito; de 4 a 6, têm. O grau 5 ainda é audível com apenas a borda do receptor tocando a pele e o grau 6 é audível com o receptor afastado da parede torácica."
  - id: sopros-3
  ...
  - id: sopros-4
    ...
    alternativas:
      ...
      - "Insuficiência tricúspide"
    corretaIndex: 2
    explicacao: "A cardiomiopatia hipertrófica se comporta ao contrário da maioria dos sopros sistólicos: menos retorno venoso aproxima o folheto anterior da mitral do septo hipertrofiado e agrava a obstrução subaórtica, aumentando o sopro; mais retorno venoso afasta as estruturas e o alivia."
  - id: sopros-5

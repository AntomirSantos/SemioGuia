---
titulo: Pulso venoso jugular e turgência
ordem: 4
tags:
  - pulso venoso
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <g stroke-width="1.5" stroke-dasharray="3 4">
      ...
      <path d="M 140 100 L 140 156" />
      <path d="M 250 92 L 250 156" />
    </g>
    <!-- régua das bulhas cardíacas -->
    <path d="M 24 168 L 306 168" stroke-width="1.5" />
    <g stroke-width="2">
      <path d="M 78 158 L 78 178" />
      <path d="M 140 158 L 140 178" />
      <path d="M 250 158 L 250 178" />
    </g>
    <!-- rótulos das ondas -->
    <g font-family="sans-serif" font-size="12" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="55" y="58">a</text>
    ...
    <g font-family="sans-serif" font-size="10" fill="currentColor" stroke="none" text-anchor="middle">
      ...
      <text x="140" y="192">B2</text>
      <text x="250" y="192">B1</text>
    </g>
...
::: checklist
titulo: Pescoço e sinais de congestão em 10 passos
itens:
  - "Cabeceira ajustada até tornar visível o topo da coluna venosa."
  - "Lado direito do pescoço examinado, cabeça levemente voltada para a esquerda, com luz tangencial."
  - "Pulsação identificada como venosa pelos critérios que a separam da carotídea."
  - "Topo da coluna localizado e distância vertical até o ângulo esternal estimada."
  - "Turgência classificada como presente ou ausente na posição semissentada."
  - "Descensos cronometrados com a ausculta das bulhas ou com o pulso carotídeo."
  - "Refluxo hepatojugular pesquisado com compressão abdominal sustentada por 10 segundos."
  - "Sinal de Kussmaul pesquisado durante respiração tranquila."
  - "Edema pesquisado em membros inferiores, face e região pré-sacra, com intensidade, consistência, elasticidade, temperatura e sensibilidade descritas."
  - "Perfusão periférica avaliada de forma comparativa entre os lados: temperatura, coloração e retorno da cor após compressão."
:::
...
::: conceito
titulo: Estimar a pressão pelo método de Lewis
nivel: avancado
texto: |
...
texto: |
  O número 45 virou sinônimo de exame das jugulares, mas o que importa é enxergar o topo da coluna. Se a pressão é normal, ele só aparece com o paciente quase deitado; se a pressão é alta, ele só aparece com o paciente bem sentado.

  Ajustar a cabeceira até encontrar o topo é o exame. Fixar o ângulo e concluir "sem turgência" quando a coluna estava acima da mandíbula, ou "com turgência" quando ela ainda estava colabada, é registrar o ângulo em vez do paciente.
:::

::: secao
titulo: As ondas do pulso venoso
:::

::: tabela
titulo: Componentes do flebograma
colunas:
  - "Componente"
  - "Momento"
  - "Origem"
linhas:
  - - "Onda a"
    - "Pré-sístole, precedendo B1"
    - "Contração do átrio direito, que dificulta o escoamento do sangue jugular"
  - - "Onda c"
  ...
  - - "Deflexão y (colapso diastólico)"
    - "Início da diástole, logo após B2"
    - "Abertura da tricúspide e esvaziamento do átrio no ventrículo"
:::
...
::: tabela
titulo: Alterações do pulso venoso
colunas:
  - "Achado"
  - "Significado"
linhas:
...
::: sinal
nome: Refluxo hepatojugular (teste abdominojugular)
descricao: |
...
causas:
  ...
  - "Estenose tricúspide"
  - "Insuficiência ventricular direita e insuficiência cardíaca grave"
...
linhas:
  - - "Cardíaca"
    - "Predomina nos membros inferiores; vespertino, mais intenso à tarde após horas em pé; na região pré-sacra em quem está acamado"
    - "Intensidade variável (+ a ++++), mole, inelástico, indolor; pele lisa e brilhante; acompanha-se de turgência jugular, refluxo hepatojugular e hepatomegalia"
  - - "Renal"
    - "Generalizado com predomínio facial, sobretudo subpalpebral; mais evidente pela manhã"
    - "Mole, inelástico, indolor, pele de temperatura normal ou discretamente reduzida; intenso na síndrome nefrótica (+++ a ++++), discreto na síndrome nefrítica e na pielonefrite"
  - - "Hepática"
    - "Generalizado com predomínio nos membros inferiores, habitualmente com ascite"
    - "Quase sempre discreto (+ a ++), mole; pressão venosa central normal, o que o separa do edema cardíaco"
  - - "Venosa localizada"
    - "Assimétrico, em um membro; piora com a permanência em pé"
    - "No edema varicoso, pouco intenso e progressivamente mais duro, com escurecimento da pele; na trombose venosa, mole e podendo ser intenso, com pele pálida ou cianótica"
  - - "Inflamatória"
    - "Localizada"
    - "Leve a mediana, elástica, dolorosa, com pele lisa, brilhante, vermelha e quente"
  - - "Linfática"
    - "Localizada, geralmente em membro inferior"
    - "Duro, inelástico, indolor, com pele espessa e áspera; nos casos avançados configura elefantíase"
:::

::: entendimento
titulo: Por que o edema cardíaco é vespertino
texto: |
...
::: secao
titulo: Perfusão periférica
:::

::: conceito
titulo: Perfusão como moldura, não como número
nivel: avancado
texto: |
...
texto: |
  O pescoço não se examina isolado. Três achados vizinhos completam o raciocínio e estão detalhados em outros tópicos do guia.

  - **Pulso paradoxal.** Queda inspiratória exagerada da pressão sistólica, quantificada com o esfigmomanômetro. Ao lado da turgência jugular e da taquicardia, compõe o quadro do tamponamento cardíaco. Técnica e limiares estão no tópico de frequência cardíaca e pulso.
  - **Pulsos arteriais e pulso carotídeo.** Amplitude, tipo de onda e comparação entre os lados também estão no tópico de frequência cardíaca e pulso.
  - **Pressão arterial.** A técnica de aferir a PA e os valores de referência estão no tópico de pressão arterial. Na insuficiência aórtica, a pressão diastólica e a pressão diferencial ajudam a graduar a lesão, como discutido no tópico de sopros.
:::
...
::: conceito
titulo: Seis erros que falseiam o pescoço
texto: |
  1. **Examinar o lado esquerdo.** A jugular esquerda cruza o mediastino e pode ser comprimida por uma aorta tortuosa; a distensão isolada à esquerda muitas vezes desaparece após uma inspiração profunda. O exame é do lado direito.
  2. **Fixar o ângulo em 45° e não procurar o topo da coluna.** Se o topo não é visível, o ângulo está errado, não o paciente.
  3. **Ler na inspiração.** A coluna desce no pescoço durante a inspiração e a leitura sai subestimada. Prefira a expiração.
...
perguntas:
  - id: jugular-1
    ...
    corretaIndex: 1
    explicacao: "O pulso venoso é ondulante, com vários acidentes por ciclo e movimento mais marcante para dentro; é mais visível que palpável, torna-se mais evidente na horizontal, varia com a respiração e é abolido pela compressão leve na base do pescoço. O pulso carotídeo tem onda única, é palpável e não muda com essas manobras."
  - id: jugular-2
  ...
  - id: jugular-6
    ...
    alternativas:
      - "Confirma insuficiência ventricular direita como causa do edema"
      - "Indica que a causa do edema provavelmente não é cardíaca nem pulmonar"

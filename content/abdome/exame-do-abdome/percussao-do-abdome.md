...
tags:
  ...
  - estação OSCE
referencias:
  - "Porto, Exame Clínico, 8ª ed., cap. 17 (Exame do Abdome), Percussão: tipos de som no abdome; determinação do limite superior do fígado e da área de macicez hepática; boxe Sinal de Jobert; pesquisa de ascite de grande, médio e pequeno volume (Figuras 17.17 a 17.20), boxe dos semicírculos de Skoda; avaliação da sonoridade do abdome; Roteiro pedagógico para exame do abdome"
  - "Porto, Exame Clínico, 8ª ed., cap. 5 (Técnicas Básicas do Exame Físico), percussão por piparote (Figura 5.20) e percussão digitodigital"
  - "Porto, Semiologia Médica, 8ª ed., Parte 11 (Sistema Digestório), Seção 8 (Parede e Cavidade Abdominais), cap. 95 (Exame Clínico), percussão do abdome, limites do fígado, macicez circunscrita e comportamento da percussão na ascite e nos cistos de ovário"
  - "Porto, Semiologia Médica, 8ª ed., Parte 11 (Sistema Digestório), Seção 7 (Fígado e Vias Biliares), cap. 91 (Exame Clínico), percussão hepática: limite superior, borda inferior e determinação do tamanho do fígado; cap. 93 (Doenças do Fígado e das Vias Biliares), Ascite: volumes grande, médio e pequeno, percussão por piparote (Figura 93.5), pesquisa de macicez móvel (Figura 93.6), ascites septadas e diferenciação com neoplasia de ovário"
...
::: conceito
titulo: Dois sons e uma pergunta
texto: |
  O abdome tem apenas dois sons de trabalho, e a percussão pergunta o tempo todo qual deles está onde não deveria.

  **Timpanismo** é o som do ar dentro de víscera oca. É o som da maior parte do abdome normal, e fica mais nítido sobre a projeção do fundo gástrico. Quando a quantidade de gás aumenta (meteorismo, obstrução, pneumoperitônio, dilatação gástrica) fala-se em **hipertimpanismo**.
...
::: perola
texto: "Macicez circunscrita é um achado que muda a conduta: onde havia alça com gás, agora há algo. Massa inflamatória, tumor, bexiga cheia, útero: a percussão não diz qual, mas diz que existe, e diz onde."
:::
...
::: manobra
titulo: Percussão sistemática do abdome
passos:
  - "Paciente em decúbito dorsal, abdome exposto, examinador à direita; percuta depois de já ter auscultado."
  - "Use o golpe dígito-digital, mais leve do que no tórax: dois golpes secos por ponto, com o plexor retirado logo após o segundo."
  - "Percorra as nove regiões em ordem fixa, comparando sempre áreas homólogas dos dois lados."
  - "Delimite o limite superior do fígado percutindo o hemitórax direito de cima para baixo, pela linha hemiclavicular, até que a sonoridade pulmonar ceda à submacicez."
  - "Desvie a percussão para fora ao chegar às últimas cartilagens costais: sobre o plastrão não é possível contar espaços intercostais."
  - "Contorne daí a área de macicez hepática, percutindo para dentro, para baixo e para fora."
  - "Percuta o rebordo costal esquerdo pela linha axilar anterior para avaliar o espaço de Traube e a área esplênica."
  - "Se o abdome estiver globoso ou houver relato de aumento de volume, pesquise ascite pelas três manobras: macicez móvel, semicírculo de Skoda e piparote."
  - "Percuta o hipogástrio antes de concluir por massa: bexiga cheia produz macicez suprapúbica e desaparece após a micção."
  - "Deixe por último qualquer região referida como dolorosa e use nela a força mínima necessária."
observar: |
  A percussão do abdome é barulhenta e inesperada para quem nunca foi examinado. Avise antes, comece leve e observe a face do paciente: dor à percussão leve é, por si só, um sinal, e reaparece com nome próprio no tópico de abdome agudo.
:::

::: checklist
titulo: Percussão do abdome em 10 passos
itens:
  - "Paciente em decúbito dorsal, abdome exposto, percussão feita após a ausculta."
  - "Golpe dígito-digital leve, com dois golpes por ponto e retirada imediata do plexor."
  - "Percussão das nove regiões em ordem fixa, com comparação de áreas homólogas."
  - "Limite superior do fígado delimitado pela linha hemiclavicular direita, do som claro pulmonar até a submacicez."
  - "Área de macicez hepática contornada e hepatimetria registrada em centímetros."
  - "Percussão do epigástrio e da linha esternal média, pela possibilidade de aumento do lobo esquerdo."
  - "Espaço de Traube percutido pela linha axilar anterior esquerda e registrado como livre ou ocupado."
  - "Pesquisa de ascite quando houver abdome globoso: macicez móvel, semicírculo de Skoda e piparote."
  - "Percussão do hipogástrio, com atenção à bexiga cheia como causa de macicez."
  - "Regiões dolorosas percutidas por último, com a força mínima necessária."
:::
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <!-- tronco: gradil costal inferior e andar superior do abdome -->
    <path d="M 44 24 C 40 60, 42 96, 52 132 L 52 172" stroke-width="2" />
    <path d="M 176 24 C 180 60, 178 96, 168 132 L 168 172" stroke-width="2" />
    <!-- esterno e apêndice xifoide -->
    <path d="M 104 30 L 116 30 L 116 84 L 110 96 L 104 84 Z" stroke-width="1.2" />
    <!-- rebordos costais -->
    <path d="M 110 96 C 94 106, 72 116, 50 122" stroke-width="1.4" />
    <path d="M 110 96 C 126 106, 148 116, 170 122" stroke-width="1.4" />
    <!-- linha hemiclavicular direita -->
    <path d="M 74 26 L 74 166" stroke-width="1.1" stroke-dasharray="4 4" />
    <!-- limite superior da macicez hepática -->
    <path d="M 60 70 L 92 70" stroke-width="1.6" />
    <!-- borda inferior do fígado -->
    <path d="M 60 128 L 92 128" stroke-width="1.6" />
    <!-- seta dupla da hepatimetria -->
    <path d="M 82 74 L 82 124" stroke-width="1.4" />
    ...
    <g font-family="sans-serif" font-size="8.5" fill="currentColor" stroke="none">
      <text x="192" y="52">1 limite superior</text>
      <text x="200" y="65">5º a 6º espaço intercostal</text>
      <text x="192" y="86">2 borda inferior</text>
      <text x="200" y="99">palpação, junto ao rebordo</text>
      <text x="192" y="120">3 hepatimetria</text>
      <text x="200" y="133">medida na hemiclavicular</text>
      <text x="192" y="154">4 espaço de Traube</text>
      <text x="200" y="167">timpânico quando livre</text>
    </g>
    <!-- lado do paciente -->
    <g font-family="sans-serif" font-size="8.5" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="70" y="190">direita do paciente</text>
      <text x="148" y="190">esquerda</text>
    </g>
  </svg>
legenda: "A hepatimetria é a distância entre dois pontos: o limite superior, achado pela percussão sobre o tórax, e a borda inferior, alcançada pela palpação. Nenhum dos dois é encontrado no abdome propriamente dito, por isso o exame do fígado começa acima do rebordo costal."
:::
...
::: conceito
titulo: A borda inferior e a medida
texto: |
  A borda inferior é determinada pela palpação, e, quando a palpação falha, pela percussão suave de baixo para cima, do abdome em direção ao rebordo, até encontrar a macicez.
...
texto: |
  ...
  - O examinador tende a **subestimar** o tamanho: coloca o limite superior baixo demais (2 a 5 cm) e a borda inferior alta demais (mais de 2 cm em cerca de metade dos pacientes).
  - A correlação com o tamanho medido por ultrassonografia ou cintilografia é apenas modesta, com coeficientes de 0,6 a 0,7, e é melhor em fígados doentes do que em fígados saudáveis.
...
::: secao
titulo: O espaço de Traube e o baço
:::

::: conceito
titulo: Traube livre, Traube ocupado
texto: |
...
::: conceito
titulo: O que a percussão procura na ascite
texto: |
  Toda a pesquisa de ascite pela percussão repousa em um único fato físico: com o paciente em decúbito dorsal, o líquido peritoneal escorre para as partes mais baixas, os flancos e as goteiras parietocólicas, enquanto as alças cheias de ar **flutuam** e ocupam a região periumbilical.
...
::: manobra
titulo: Pesquisa de macicez móvel
passos:
  - "Com o paciente em decúbito dorsal, percuta todo o abdome a partir do ponto mais alto da parede em direção aos flancos."
  - "Registre o padrão inicial: macicez nos flancos e timpanismo na região central levantam a suspeita."
  - "Coloque o paciente em decúbito lateral direito, aguarde alguns segundos para o líquido se acomodar e percuta novamente todo o abdome."
  - "Na ascite, a percussão inverte: timpanismo no flanco esquerdo, que ficou por cima, e macicez no lado que ficou por baixo."
  - "Repita no decúbito lateral esquerdo e confirme que o resultado se inverte outra vez."
  - "Exija que a fronteira entre timpanismo e macicez se mantenha horizontal em cada posição."
observar: |
...
passos:
  - "Piparote, com o paciente em decúbito dorsal, peça a ele ou a um auxiliar que apoie a borda cubital de uma das mãos sobre a linha média do abdome, com pressão leve."
  - "Essa mão intermediária é o que impede que o impulso seja transmitido pelo tecido subcutâneo da parede, o que geraria resposta falsamente positiva."
  - "Posicione-se à direita e apoie a mão esquerda espalmada sobre o flanco esquerdo do paciente."
  - "Com a mão direita, golpeie com o dedo médio ou o indicador a face lateral do hemiabdome direito."
  - "O sinal é positivo quando a mão apoiada capta o choque das ondas líquidas atravessando a cavidade."
  - "Skoda, com o paciente em decúbito dorsal, percuta a partir do ponto mais alto do abdome, radialmente, em direção aos flancos e à sínfise púbica."
...
::: perola
texto: "No piparote, a mão do auxiliar não é detalhe de etiqueta: sem ela, a onda que você sente pode ter viajado pela gordura da parede, e não pelo líquido da cavidade. Piparote sem mão intermediária é uma manobra que responde sim com facilidade demais."
:::
...
texto: |
  ...
  **Para afastar**, os melhores achados são a **ausência de edema** (0,2) e o **timpanismo dos flancos**, isto é, a ausência de macicez de flancos (0,3). A ausência de macicez móvel reduz pouco (0,4), e o piparote negativo reduz ainda menos (0,5).

  Pouco úteis: a macicez de flancos quando presente, os flancos abaulados quando presentes e o piparote quando negativo. O umbigo plano ou evertido também não ajudou em um dos estudos. Já a percussão auscultatória do paciente em pronação, o chamado sinal da poça, foi formalmente testada e mostrou-se sem utilidade diagnóstica.

  Um achado surpreende os estudantes e merece registro: **o edema periférico é dos elementos mais informativos da lista**, nos dois sentidos. A maioria dos pacientes com ascite tem edema, seja pela hipoalbuminemia, seja pelo peso do líquido peritoneal comprimindo as veias que drenam as pernas. A semiotécnica do edema e sua graduação em cruzes estão no tópico de pulso venoso jugular e turgência.
:::
...
texto: |
  ...
  - **Macicez do espaço de Traube.** Traube propôs a macicez desse espaço como sinal de derrame pleural; foi Parrino, em 1987, quem sugeriu lê-la como sinal de aumento do baço.
...
texto: |
  ...
  - **A dor à percussão leve**, achado diferente de tudo que se discutiu aqui, pertence ao tópico de abdome agudo e sinais peritoneais.
:::
...
::: conceito
titulo: Seis erros que estragam a percussão do abdome
texto: |
  1. **Percutir o abdome com a força do tórax.** A parede abdominal é mais complacente e as vísceras estão mais próximas: golpe forte demais reduz a hepatimetria obtida e aumenta o erro.
  2. **Transformar a hepatimetria em diagnóstico.** Examinadores experientes divergem, em média, em 8 cm no mesmo paciente, e a percussão padronizada não detectou hepatomegalia com acurácia. A hepatimetria é índice, não medida.
...
perguntas:
  ...
  - id: perc-abd-3
    enunciado: Por que se pede ao paciente ou a um auxiliar que apoie a borda cubital da mão na linha média do abdome durante a pesquisa do sinal do piparote?
    alternativas:
      - "Para impedir que o impulso seja transmitido pelo subcutâneo da parede, o que daria falso-positivo"
      - "Para deslocar as alças intestinais para os flancos e concentrar o líquido ascítico na região central do abdome"
  ...
  - id: perc-abd-4
    ...
    alternativas:
      - "Ascite de grande volume, em que a macicez ocupa todo o abdome e o semicírculo de Skoda deixa de ser demarcável"
      - "Ascite de pequeno volume, detectável apenas na posição ortostática"
      - "Massa líquida de continente próprio, como um cisto gigante de ovário, e não líquido livre"
      - "Íleo paralítico com alças repletas de líquido"
    corretaIndex: 2
  ...
  - id: perc-abd-5
    ...
    alternativas:
      ...
      - "Não tem qualquer utilidade e deve ser abandonada, já que a percussão não localiza o fígado"
      - "Só serve em fígados saudáveis, pois a correlação com a imagem piora nos fígados doentes"
    corretaIndex: 1

...
tags:
  ...
  - manobra de Galambos
  - manobra de elevação da cabeça
  - teste da parede abdominal
  ...
  - estação OSCE
referencias:
  - "Porto, Exame Clínico, 8ª ed., cap. 17 (Exame do Abdome), Palpação: objetivos, palpação superficial (sensibilidade, pontos dolorosos, resistência da parede, boxe Defesa da parede abdominal, continuidade, diástase e hérnias, pulsações), palpação profunda (características das massas palpáveis), palpação do fígado e boxe Relaxamento da parede abdominal, Quadro 17.1 (características do fígado nas hepatomegalias), palpação da vesícula biliar e boxe Regra de Courvoisier, palpação do baço na posição de Schuster, palpação do ceco, do cólon transverso, do sigmoide e dos rins, boxe Manobras especiais (palpação bimanual comparativa, rechaço, vascolejo, sinal de Gersuny)"
  - "Porto, Semiologia Médica, 8ª ed., Parte 11 (Sistema Digestório), Seção 7 (Fígado e Vias Biliares), cap. 91 (Exame Clínico), palpação da borda hepática, manobra em garra (Figura 91.1), Quadro 91.1 (elementos de análise à palpação do fígado), registro esquemático (Figura 91.2), sinais de Courvoisier e de Murphy, ponto cístico (Figura 91.3), exame do baço e posição de Schuster, chanfradura esplênica"
  - "Porto, Semiologia Médica, 8ª ed., Parte 11 (Sistema Digestório), Seção 8 (Parede e Cavidade Abdominais), cap. 95 (Exame Clínico), palpação: avaliação da tensão da parede, boxe Defesa abdominal, contração psicomotora e manobra de Galambos, palpação superficial e profunda, órgãos palpáveis em condições normais, tumores-fantasmas"
...
::: conceito
titulo: A mão pergunta duas coisas
texto: |
  A palpação do abdome responde a duas perguntas em sequência, e confundi-las é a origem de boa parte dos erros.

  A primeira é **da parede**: qual é a tensão da musculatura, há dor à compressão leve, há hiperestesia da pele, há solução de continuidade, diástase, hérnia? É a **palpação superficial**, que alcança os primeiros centímetros e explora a parede e as vísceras que a tocam.
...
::: perola
texto: "Deixe a área dolorida para o fim. Palpá-la primeiro contrai a parede inteira e transforma o resto do exame em uma sucessão de achados falsos, e o paciente, que já não confiava na manobra, deixa de confiar no examinador."
:::
...
::: manobra
titulo: Palpação superficial e profunda do abdome
passos:
  - "Paciente em decúbito dorsal, cabeça em travesseiro baixo, braços e pernas estendidos, musculatura relaxada; examinador à direita, com as mãos aquecidas."
  - "Pergunte onde dói antes de tocar e planeje a ordem: a região dolorosa fica por último."
  - "Comece pela palpação superficial com a mão espalmada e os dedos em leve flexão, percorrendo todas as regiões em ordem fixa."
  - "Avalie a tensão da parede produzindo dois a três abalos leves com as pontas dos dedos em cada ponto."
  - "Pesquise hiperestesia cutânea deslizando suavemente as polpas digitais ou um objeto pontiagudo sobre a pele."
  - "Percorra toda a parede procurando áreas de menor resistência e tente insinuar as polpas nesses pontos, para reconhecer diástases e hérnias."
  - "Passe à palpação profunda aproveitando a expiração, quando a tensão da parede diminui; aprofunde a mão progressivamente, sem movimentos bruscos."
  - "Use as duas mãos sobrepostas quando precisar de mais pressão, e a palpação bimanual comparativa quando suspeitar de defesa localizada, alternando a compressão entre a área suspeita e a homóloga."
...
itens:
  - "Paciente em decúbito dorsal com a musculatura relaxada; examinador à direita, com as mãos aquecidas."
  - "Pergunta sobre a localização da dor antes do primeiro toque, com a área dolorosa deixada por último."
  - "Palpação superficial de todas as regiões, com avaliação da tensão da parede por abalos leves."
  - "Pesquisa de hiperestesia cutânea e de pontos dolorosos."
  - "Diferenciação entre contratura voluntária e involuntária, com uso de artifícios de distração."
  - "Avaliação da continuidade da parede, com pesquisa de diástase e de hérnias."
  - "Palpação profunda aproveitando a expiração, com uma ou duas mãos."
  - "Palpação do fígado, com descrição de borda, superfície, consistência e sensibilidade."
  - "Palpação do baço em decúbito dorsal e, se necessário, na posição de Schuster."
  - "Palpação das lojas renais e da aorta abdominal, com registro das medidas em centímetros."
:::

::: secao
titulo: "A parede: tensão, defesa e continuidade"
:::
...
::: manobra
titulo: Manobra de elevação da cabeça (teste da parede abdominal)
passos:
  - "Localize, pela palpação suave, a área de maior dor."
  - "Aplique pressão suficiente para provocar dor de intensidade moderada e mantenha a mão exatamente nesse ponto."
  - "Peça ao paciente que cruze os braços sobre o tórax e levante a cabeça e os ombros, como se iniciasse um abdominal."
  - "Mantendo a mesma pressão, pergunte se a dor aumentou, diminuiu ou ficou igual."
...
::: secao
titulo: Palpação do fígado
:::

::: conceito
titulo: Duas técnicas e o que descrever
texto: |
  A palpação hepática começa onde a percussão terminou: no ponto em que se encontrou a borda inferior. Se houver dúvida, começa-se mais baixo, no quadrante inferior direito, e se sobe 1 a 2 cm por vez, a cada respiração, até que a borda venha ao encontro dos dedos na inspiração.
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 220" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <!-- contorno do abdome, deslocado para a direita: a margem esquerda fica livre para os rotulos -->
    <g stroke="currentColor" stroke-width="2" fill="none">
      <path d="M 118 32 C 115 80, 113 140, 119 194" />
      <path d="M 248 32 C 251 80, 253 140, 247 194" />
      <path d="M 119 194 C 140 202, 226 202, 247 194" />
    </g>
    <!-- rebordo costal -->
    <g stroke="currentColor" stroke-width="2" fill="none">
      <path d="M 118 76 C 138 60, 162 52, 182 52" />
      <path d="M 182 52 C 202 52, 228 60, 248 76" />
    </g>
    <!-- borda hepatica, logo abaixo do rebordo direito do paciente -->
    <path d="M 120 86 C 143 74, 165 66, 181 64" stroke-width="1.5" stroke-dasharray="5 4" />
    <!-- umbigo -->
    <circle cx="184" cy="140" r="3" stroke-width="1.5" />
    <!-- linha hemiclavicular direita -->
    <path d="M 137 60 L 137 194" stroke-width="1" stroke-dasharray="2 5" />
    <!-- rota da palpacao: comeca embaixo e sobe por degraus a cada respiracao -->
    <g stroke="currentColor" stroke-width="2" fill="none">
      <circle cx="137" cy="182" r="4" fill="currentColor" fill-opacity="0.12" />
      <path d="M 137 174 L 137 96" stroke-dasharray="7 5" />
      <path d="M 131 102 L 137 94 L 143 102" />
      <path d="M 130 161 L 144 161" stroke-width="1.5" />
      <path d="M 130 141 L 144 141" stroke-width="1.5" />
      <path d="M 130 121 L 144 121" stroke-width="1.5" />
    </g>
    <g font-family="sans-serif" font-size="11" fill="currentColor" stroke="none">
      <text x="244" y="42" text-anchor="end">rebordo costal</text>
      <text x="176" y="94">borda hepática</text>
      <text x="104" y="136" text-anchor="end">1 a 2 cm por</text>
      <text x="104" y="149" text-anchor="end">respiração</text>
      <text x="142" y="213">início: quadrante inferior direito</text>
    </g>
    <g stroke="currentColor" stroke-width="1.5" fill="none">
      <path d="M 176 90 L 162 72" />
      <path d="M 169 76 L 162 72 L 165 80" />
      <path d="M 148 206 L 139 188" />
      <path d="M 146 194 L 139 188 L 140 197" />
    </g>
  </svg>
legenda: "A rota da palpação hepática: em caso de dúvida, começa no quadrante inferior direito e sobe 1 a 2 cm a cada respiração, pela linha hemiclavicular, até a borda hepática vir ao encontro dos dedos na inspiração."
:::
::: manobra
titulo: Palpação da borda hepática
passos:
  - "Localize antes, pela percussão, o limite superior e a provável borda inferior; palpe a partir dali."
  - "Se houver dúvida, comece no quadrante inferior direito e suba 1 a 2 cm a cada ciclo respiratório."
  - "Durante a expiração, ajuste a mão à parede sem comprimir e sem movimentá-la."
  - "Durante a inspiração, comprima e desloque a mão para cima, ao encontro da borda que desce."
  - "Facilite a manobra colocando a mão esquerda sob a loja renal direita e forçando-a para cima (técnica bimanual)."
  - "Como alternativa, use as mãos em garra, à altura do ombro direito do paciente."
  - "Percorra toda a extensão da borda, incluindo o lobo esquerdo, no epigástrio."
  - "Meça em centímetros a distância entre o rebordo costal e a borda, na linha hemiclavicular direita, e repita na linha esternal média."
...
::: tabela
titulo: O que descrever da borda e da superfície
colunas:
  - "Elemento"
  - "Possibilidades"
  - "Exemplos do que sugerem"
linhas:
  - - "Distância do rebordo costal"
    - "Medida em centímetros na linha hemiclavicular e na esternal média"
    - "Pequena hepatomegalia até cerca de dois dedos transversos; média em torno de quatro; grande acima disso, podendo alcançar a cicatriz umbilical"
  - - "Espessura da borda"
    - "Fina e cortante (normal) ou romba"
    - "Borda romba na congestão e nas hepatopatias crônicas"
  - - "Superfície"
    - "Lisa, granulosa ou nodular"
    - "Nódulos difusos nas cirroses; esparsos nas metástases; nódulo único no câncer primitivo"
  - - "Consistência"
    - "Diminuída, normal (elástica) ou aumentada"
    - "Firme na cirrose, pela fibrose; diminuída na esteatose aguda da gravidez"
  - - "Sensibilidade"
    - "Indolor ou dolorosa"
...
::: manobra
titulo: Palpação do baço e posição de Schuster
passos:
  - "Comece em decúbito dorsal, examinando o quadrante superior esquerdo com a mesma coordenação respiratória usada para o fígado."
  - "Coloque a mão esquerda sobre o gradil costal esquerdo, pressionando-o para cima e para diante, enquanto a mão direita palpa apontando para o rebordo."
  - "Comprima ao final da expiração e peça uma inspiração profunda, procurando a borda inferior no auge da inspiração."
  - "Se nada for encontrado, passe à posição de Schuster: decúbito lateral direito, perna direita estendida, coxa esquerda fletida sobre o abdome em ângulo de 90°."
  - "Eleve o ombro esquerdo do paciente, colocando o braço correspondente sobre a cabeça."
  - "Posicione-se diante do paciente e apoie a mão esquerda, com alguma pressão, sobre a projeção do baço, empurrando-a no sentido caudal."
  - "Palpe com a mão direita, coordenando com a respiração e avançando em direção ao rebordo costal durante a inspiração."
...
::: secao
titulo: Rins, aorta e o resto da cavidade
:::
...
texto: |
  ...
  Daí a utilidade real da consistência em quem já tem doença hepática crônica conhecida:

  - **Borda hepática firme à palpação**: razão de verossimilhança 3,3 para cirrose.
  - **Fígado palpável no epigástrio**: 2,7.
  - **Fígado aumentado e palpável**: 2,3.
  - **Baço palpável**: 2,5.

  Um dado que fecha a lógica: a avaliação da firmeza do fígado pela mão do examinador correlaciona-se muito bem com medidas não invasivas de fibrose hepática, como a elastografia por ultrassom. A mão treinada mede rigidez melhor do que mede volume.
...
texto: |
  ...
  - **Dor e sensibilidade no quadrante superior esquerdo** aumentam a probabilidade de afecção primária do baço ou de doença hematológica.
  - **Adenomegalia associada** praticamente exclui a causa hepática (razão de verossimilhança 0,04) e aponta para as demais.
  - **Fígado palpável** aumenta a probabilidade de causa hepática (2,7).
  - **Esplenomegalia maciça**, com o baço alcançando o umbigo, aumenta a probabilidade de doença hematológica (2,1).

  E o baço palpável muda o raciocínio em cenários clínicos específicos:

  - **Viajante que retorna de área tropical com febre**: razão de verossimilhança 6,5 para malária.
  - **Paciente ictérico**: 2,9 para doença hepatocelular, isto é, icterícia não obstrutiva.
  - **Doença hepática crônica**: 2,5 para cirrose.
...
texto: |
  ...
  Essa segunda variável explica por que os números de hoje diferem dos de Courvoisier: restringindo a análise aos pacientes com obstrução extra-hepática, a sensibilidade da vesícula dilatada na obstrução maligna caiu para 25% a 55%, contra os 92% de Courvoisier, ainda que a especificidade permaneça em 80% a 90%. O paciente com obstrução maligna de hoje é diagnosticado por imagem bem antes que a pressão suba o bastante para distender a vesícula.

  Um dado final sobre o alcance da mão: em uma série de 86 pacientes internados com vesícula distendida documentada por tomografia ou laparotomia, apenas 46, 53%, eram palpáveis à beira do leito. Desses, 83% tinham causa maligna e 17% causa benigna.
:::
...
texto: |
  ...
  Os números: massa epigástrica pulsátil e expansiva tem razão de verossimilhança **8,0** para aneurisma; a ausência do achado é bem menos útil (0,6), porque a sensibilidade pode ser tão baixa quanto 22%.

  Duas variáveis governam a palpabilidade: **o tamanho do aneurisma e a circunferência abdominal do paciente**. Aneurismas entre 3 e 5 cm são difíceis de detectar; se o critério passa a ser dilatação focal acima de 5 cm, o diâmetro que costuma indicar reparo cirúrgico, a sensibilidade sobe acima de 80% em quase todas as séries. Restringindo a análise a pacientes com circunferência abdominal inferior a 100 cm medida no umbigo, ou àqueles em que o examinador consegue palpar a aorta, a sensibilidade ultrapassa 88% em todos os estudos. Nesses pacientes, portanto, o exame negativo tem valor real.

  A causa mais comum de falso-positivo é a aorta anormalmente tortuosa; causas raras incluem rim em ferradura, tumor intra-abdominal e adenopatia paraórtica.

  Sobre a bexiga, um dado prático: a ausência de bexiga palpável na região suprapúbica reduz a probabilidade de haver 400 mℓ ou mais de urina retida (razão de verossimilhança 0,3).
:::

::: conceito
titulo: Onde este tópico encontra os outros
texto: |
  A palpação é o tempo do exame que mais empresta e mais devolve aos outros tópicos.

  - **A percussão vem antes e situa o alvo**: o limite superior do fígado, a borda inferior provável e o estado do espaço de Traube estão no tópico de percussão do abdome, e é de lá que se parte para palpar.
  - **A defesa da parede, a descompressão brusca, os pontos dolorosos e o sinal de Murphy** pertencem ao tópico de abdome agudo e sinais peritoneais; aqui se avalia a tensão, lá se lê o que ela significa.
  - **O refluxo hepatojugular** é pesquisado comprimindo o abdome, mas é lido no pescoço: a manobra, o tempo de compressão e o significado estão no tópico de pulso venoso jugular e turgência.
  - **O epônimo Lemos Torres** aparece duas vezes no guia com sentidos distintos: aqui, a técnica bimanual de palpação hepática; no tópico de inspeção do tórax, o abaulamento expiratório dos espaços intercostais do derrame pleural.
  - **A punho-percussão lombar (sinal de Giordano)**, que completa o exame renal, está no tópico de abdome agudo e sinais peritoneais.
  - **O linfonodo supraclavicular endurecido e aderido**, que muda inteiramente o raciocínio diante de uma massa abdominal, está no tópico de linfonodos.
  - **A caracterização da dor que motivou a palpação** (localização, irradiação, ritmicidade, fatores de melhora) pertence ao tópico de queixa principal e história da doença atual.
:::
...
::: conceito
titulo: Seis erros que comprometem a palpação
texto: |
  1. **Começar pela região dolorosa.** Contrai a parede inteira e inviabiliza o resto do exame. Pergunte onde dói e deixe esse ponto para o fim.
  2. **Chamar de hepatomegalia toda borda palpável.** Em pessoas magras e em visceroptóticos, o fígado é palpável sem estar aumentado; e no epigástrio a borda normalmente se afasta do rebordo. A borda palpável isolada tem razão de verossimilhança de apenas 1,9 para hepatomegalia.
  3. **Confundir a última costela com a ponta do baço.** Ela é flutuante e engana com frequência os examinadores iniciantes.
  4. **Registrar em dedos transversos.** A largura dos dedos varia de pessoa para pessoa. Meça em centímetros, com fita.
  5. **Tratar a contratura como um achado único.** Contração voluntária cede à distração e ao artifício; defesa por reflexo visceromotor não cede. São coisas diferentes, com consequências diferentes.
  6. **Concluir massa sem percutir e sem esvaziar a bexiga.** Bexiga em retenção, fecaloma no sigmoide, promontório e rim ptótico compõem a lista dos tumores-fantasmas: todos desfeitos por uma percussão e um reexame.
:::
...
perguntas:
  - id: palp-abd-1
    enunciado: Durante a palpação, um paciente com dor abdominal contrai fortemente a musculatura. Como se diferencia a contração voluntária da defesa por reflexo visceromotor?
    alternativas:
      - "A contração voluntária cede à distração, à respiração profunda e à flexão das pernas; a defesa por reflexo visceromotor não cede"
      - "A contração voluntária é sempre generalizada e a defesa é sempre localizada"
      - "A contração voluntária desaparece na inspiração e a defesa desaparece na expiração"
      - "A contração voluntária provoca dor à descompressão brusca e a defesa por reflexo visceromotor não provoca, por depender apenas do tônus muscular"
    corretaIndex: 0
    explicacao: "A contração psicomotora é voluntária e cede quando o paciente é tranquilizado ou distraído, conversando, respirando fundo, flexionando as pernas, ou pela manobra de Galambos, que comprime outra região enquanto se palpa a desejada. A defesa abdominal obedece a um reflexo visceromotor desencadeado pelo peritônio inflamado e não cede. Tanto a defesa quanto a contração voluntária podem ser localizadas ou generalizadas, e a tensão da parede também aumenta na inspiração em condições normais."
  - id: palp-abd-2
    enunciado: Você localiza o ponto de maior dor, mantém a pressão e pede ao paciente que cruze os braços e levante a cabeça e os ombros. A dor aumenta. O que esse resultado indica?
    alternativas:
      - "Peritonite localizada, pois a contração aproxima o peritônio inflamado da mão"
      - "Nada de útil, pois a manobra apenas mede a força da musculatura abdominal"
      - "Que a dor tem origem na parede abdominal, e não na cavidade: o teste positivo reduz a probabilidade de causa intra-abdominal"
      - "Obstrução intestinal, pois a contração comprime as alças distendidas"
    corretaIndex: 2
    explicacao: "É o teste da parede abdominal, introduzido por Carnett em 1926. Quando a dor aumenta com a contração, a origem está na própria parede; quando diminui, os músculos contraídos protegem o conteúdo da cavidade da mão do examinador. O teste positivo reduz fortemente a probabilidade de peritonite na dor aguda e de causa visceral na dor crônica. Uma causa clássica de dor de parede é a neuropatia toracoabdominal do diabetes."
  - id: palp-abd-3
  ...
  - id: palp-abd-5
    ...
    alternativas:
      - "A intensidade da pulsação, que no aneurisma é sempre maior"
      - "A presença de sopro abdominal sobre a pulsação"
      - "A pulsação expansiva, que afasta as duas mãos colocadas uma de cada lado do vaso"
      - "A localização abaixo da cicatriz umbilical, pois a aorta normal se bifurca acima dela"
    corretaIndex: 2

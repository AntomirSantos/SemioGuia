---
titulo: Inspeção e ausculta do abdome
ordem: 1
tags:
  - inspeção do abdome
  - ausculta do abdome
...
::: conceito
titulo: O abdome inverte a ordem
texto: |
...
::: perola
texto: "A inspeção do abdome não se faz de relance, e quase nunca de pé ao lado da cama. Abaixe os olhos até a altura do plano da parede: assim se veem abaulamentos, retrações e ondas peristálticas que desaparecem quando se olha de cima para baixo."
:::
...
titulo: Inspeção e ausculta do abdome
passos:
  - "Peça ao paciente que esvazie a bexiga antes do exame, sempre que for possível."
  - "Coloque-o em decúbito dorsal, com a cabeceira baixa até onde a dispneia permitir, braços ao longo do corpo e pernas estendidas e relaxadas."
  - "Exponha o abdome inteiro, do apêndice xifoide ao púbis, mantendo a genitália coberta; peça o consentimento antes de descobrir."
  - "Posicione-se à direita do paciente, com as mãos e o estetoscópio aquecidos."
  - "Inspecione primeiro de frente e depois com o olhar rasante ao plano da parede, buscando forma, simetria, abaulamentos e retrações."
  - "Percorra a pele: cicatrizes, estrias, lesões, equimoses, ostomias e fístulas; examine a cicatriz umbilical e o padrão venoso da parede."
...
::: checklist
titulo: Inspeção e ausculta do abdome em 10 passos
itens:
  - "Bexiga esvaziada quando possível e consentimento obtido antes da exposição."
  - "Decúbito dorsal com cabeceira baixa, membros relaxados, abdome exposto do xifoide ao púbis e genitália coberta."
  - "Examinador à direita do paciente, mãos e estetoscópio aquecidos."
  - "Inspeção estática: forma, volume, simetria, abaulamentos e retrações, com olhar também rasante ao plano da parede."
  - "Inspeção da pele: cicatrizes, estrias, equimoses, ostomias, fístulas e cicatriz umbilical."
  - "Inspeção do padrão venoso, com distinção entre o desenho venoso normal e a circulação colateral."
  - "Inspeção dinâmica: movimentos respiratórios, pulsações e ondas peristálticas."
  - "Manobra de esforço (elevar a cabeça ou tossir) para diástase dos retos e hérnias."
  - "Ausculta feita antes da percussão e da palpação, com registro de ruídos hidroaéreos presentes, aumentados, diminuídos ou ausentes."
  - "Pesquisa de sopros sobre a aorta, as artérias renais e as ilíacas."
:::

::: secao
titulo: O mapa do abdome
:::

::: conceito
titulo: Nove regiões, quatro quadrantes
texto: |
  Toda descrição abdominal precisa de um endereço. Existem duas maneiras de dar esse endereço, e ambas são usadas.
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <!-- contorno da parede abdominal: rebordos costais, flancos, pregas inguinais -->
    <path d="M 103 28 C 92 40, 74 58, 48 70 L 50 130 C 52 148, 60 166, 82 176 L 124 176 C 146 166, 154 148, 156 130 L 158 70 C 132 58, 114 40, 103 28 Z" />
    <!-- linhas horizontais: bicostal e bi-ilíaca -->
    <path d="M 49 76 L 157 76" stroke-width="1.2" stroke-dasharray="5 3" />
    <path d="M 51 130 L 155 130" stroke-width="1.2" stroke-dasharray="5 3" />
    <!-- linhas verticais ligeiramente oblíquas, até os tubérculos púbicos -->
    <path d="M 76 44 L 88 176" stroke-width="1.2" stroke-dasharray="5 3" />
    <path d="M 130 44 L 118 176" stroke-width="1.2" stroke-dasharray="5 3" />
    <!-- cicatriz umbilical -->
    <circle cx="103" cy="103" r="3.5" stroke-width="1.4" />
    <!-- números das regiões -->
    <g font-family="sans-serif" font-size="10" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="64" y="71">1</text>
      <text x="103" y="58">2</text>
      <text x="142" y="71">3</text>
      <text x="64" y="107">4</text>
      <text x="103" y="122">5</text>
      <text x="142" y="107">6</text>
      <text x="72" y="154">7</text>
      <text x="103" y="154">8</text>
      <text x="134" y="154">9</text>
    </g>
    <!-- legenda -->
    <g font-family="sans-serif" font-size="8" fill="currentColor" stroke="none">
      <text x="170" y="36">1 hipocôndrio D · fígado</text>
      <text x="170" y="52">2 epigástrio · estômago</text>
      <text x="170" y="68">3 hipocôndrio E · baço</text>
      <text x="170" y="84">4 flanco D · cólon ascendente</text>
      <text x="170" y="100">5 mesogástrio · delgado</text>
      <text x="170" y="116">6 flanco E · cólon descendente</text>
      <text x="170" y="132">7 fossa ilíaca D · ceco</text>
      <text x="170" y="148">8 hipogástrio · bexiga</text>
      <text x="170" y="164">9 fossa ilíaca E · sigmoide</text>
    </g>
    <!-- lado do paciente -->
    <g font-family="sans-serif" font-size="8.5" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="64" y="192">direita do paciente</text>
      <text x="142" y="192">esquerda</text>
    </g>
  </svg>
legenda: "As nove regiões e a víscera que cada uma anuncia primeiro. O endereço do achado é metade do raciocínio: dor que muda de região ao longo de horas conta uma história diferente da dor que fica onde nasceu."
:::

::: tabela
titulo: O que se projeta em cada região
colunas:
  - "Região"
  - "Principais vísceras projetadas"
linhas:
  - - "Hipocôndrio direito"
    - "Fígado (lobo direito), vesícula biliar, ângulo hepático do cólon"
  - - "Epigástrio"
    - "Estômago, duodeno, pâncreas, lobo esquerdo do fígado, aorta abdominal"
  - - "Hipocôndrio esquerdo"
    - "Baço, fundo gástrico, cauda do pâncreas, ângulo esplênico do cólon"
  - - "Flanco direito"
    - "Cólon ascendente, rim direito"
  - - "Mesogástrio (região umbilical)"
    - "Alças do intestino delgado, cólon transverso, aorta e sua bifurcação"
  - - "Flanco esquerdo"
    - "Cólon descendente, rim esquerdo"
  - - "Fossa ilíaca direita"
    - "Ceco e apêndice, íleo terminal, ureter e anexo direitos"
  - - "Hipogástrio"
    - "Bexiga, útero, alças do delgado"
  - - "Fossa ilíaca esquerda"
    - "Cólon sigmoide, ureter e anexo esquerdos"
:::
...
::: secao
titulo: A forma do abdome
:::

::: tabela
titulo: Tipos de abdome
colunas:
  - "Tipo"
  - "O que se vê"
  - "Quando aparece"
linhas:
  ...
  - - "Globoso ou protuberante"
    ...
    - "Obesidade, gravidez avançada, ascite, distensão gasosa, obstrução intestinal, grandes visceromegalias e tumores"
  - - "Em ventre de batráquio"
    - "Com o paciente deitado, o diâmetro transversal predomina sobre o anteroposterior"
    - "Ascite em regressão, quando o líquido escorre para os flancos e o centro se aplana"
  - - "Pendular ou ptótico"
    - "De pé, as vísceras empurram a parte inferior da parede e formam uma protrusão"
    - "Flacidez de parede no puerpério, pessoas emaciadas"
  - - "Em avental"
    - "A parede pende sobre as coxas, mais evidente com o paciente de pé"
    - "Obesidade de grau elevado, por acúmulo de tecido adiposo na parede"
  - - "Escavado (escafoide)"
    - "Parede nitidamente retraída"
    - "Emagrecimento acentuado e doenças consuntivas"
:::
...
::: manobra
titulo: Manobra de esforço para diástase e hérnias
passos:
  - "Com o paciente em decúbito dorsal, peça que levante a cabeça do travesseiro sem mover o tórax, ou que eleve os dois membros inferiores estendidos."
  - "Observe a linha média: uma proeminência longitudinal entre os músculos retos, acima ou abaixo do umbigo, é a diástase."
  - "Deslize a mão por toda a parede procurando áreas de menor resistência e tente insinuar as polpas digitais nesses pontos."
  - "Diferencie diástase de hérnia: na diástase não há saco herniário nem anel palpável por onde as alças se insinuem."
  - "Para as hérnias inguinais e crurais, peça que o paciente tussa; se necessário, peça que sopre com força contra a própria mão tapando a boca, o que aumenta a pressão intra-abdominal."
  - "Inspecione e palpe as regiões umbilical, inguinal e femoral durante o esforço, dos dois lados."
observar: |
...
::: tabela
titulo: Íleo × obstrução mecânica na beira do leito
nivel: avancado
colunas:
  - "Elemento"
  - "Íleo paralítico"
...
linhas:
  ...
  - - "Inspeção"
    ...
    - "Relevo de alças e peristaltismo visível nos magros"
  - - "Contexto"
    - "Pós-operatório além de 72 h, peritonite, hipopotassemia, isquemia, causas extra-abdominais"
    - "Bridas, hérnias, vólvulo, tumores, fecaloma, intussuscepção"
:::
...
texto: |
  ...
  **Para aneurisma da aorta abdominal**, o sopro abdominal não teve valor diagnóstico no estudo disponível. O achado que serve é palpatório, e está no tópico de palpação.

  Vale ainda registrar o **atrito hepático**: fora do contexto de biopsia recente, associa-se repetidamente a neoplasia intra-hepática, primária ou metastática; em uma série de tumores metastáticos para o fígado, 10% dos pacientes o apresentavam.
:::
...
texto: |
  1. **Palpar antes de auscultar.** A palpação e a percussão estimulam o peristaltismo e podem mascarar a hipoatividade dos ruídos. No abdome, o estetoscópio vem antes das mãos.
...
perguntas:
  ...
  - id: insp-abd-2
    ...
    corretaIndex: 0
    explicacao: "Peristaltismo visível é o achado de maior poder no exame do abdome agudo, com razão de verossimilhança 18,8 para obstrução intestinal, mas com sensibilidade de apenas 6%: sua ausência não tranquiliza. Ondas visíveis podem aparecer em pessoas muito magras sem doença, e ganham valor quando são constantes e vêm com dor em cólica e ruídos aumentados. A localização e o sentido das ondas ajudam a situar o obstáculo, mas nenhum segmento tem exclusividade sobre o achado."
  - id: insp-abd-3
    enunciado: Uma paciente com cirrose apresenta rede venosa periumbilical intensa, com veias sinuosas irradiando do umbigo, e fluxo dirigido de baixo para cima. Que tipo de circulação colateral é esse e o que ele indica?
    alternativas:
      - "Tipo cava superior, por obstáculo mediastinal, em que a rede ocupa a metade superior do tórax e o fluxo é toracoabdominal"
      - "Tipo braquicefálico, por compressão do tronco venoso braquicefálico"
  ...
  - id: insp-abd-4
    ...
    alternativas:
      - "Achado que exige investigação imediata de aneurisma da aorta abdominal"
      - "Achado que ocorre em pessoas saudáveis, sobretudo abaixo dos 40 anos, e costuma vir da artéria celíaca"
      - "Achado que praticamente firma o diagnóstico de hipertensão renovascular"
      - "Achado sempre patológico, pois o abdome normal não gera sopros audíveis entre o apêndice xifoide e a cicatriz umbilical"
    corretaIndex: 1
    explicacao: "Sopros abdominais ocorrem em 4% a 20% das pessoas saudáveis, com predomínio abaixo dos 40 anos. O sopro do indivíduo sadio é sistólico, de tonalidade média a baixa, audível entre o apêndice xifoide e o umbigo, e raramente se espalha para os lados; em arteriografias, a fonte mais comum é a artéria celíaca. O achado que praticamente firma hipertensão renovascular é o sopro que se estende à diástole, e o sopro abdominal não se mostrou útil para aneurisma da aorta."
  - id: insp-abd-5
    enunciado: Que manobra de inspeção separa uma diástase dos músculos retos abdominais de uma hérnia da parede, e em que se baseia essa separação?
    alternativas:
  ...
  - id: insp-abd-6
    ...
    alternativas:
      - "Ruído metálico, sugerindo obstrução incompleta por bridas precoces, que costumam aparecer já nos primeiros dias após a laparotomia"
      - "Patinhação, sugerindo estase gástrica por obstrução do antro"

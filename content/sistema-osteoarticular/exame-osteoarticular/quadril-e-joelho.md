...
tags:
  ...
  - manobra de Trendelenburg do quadril
  ...
  - regra de Ottawa do joelho
  - razão de verossimilhança
  - concordância entre observadores
  - estação OSCE
referencias:
  - "Semiologia Clínica, 1ª ed., cap. 16 (Exame osteoarticular), seções Joelho e Quadril e pelve — anatomia funcional do joelho, com as articulações patelofemoral e tibiofemoral, os estabilizadores capsulares e ligamentares e os meniscos; valor da idade na anamnese e a localização da dor em anterior, posterior, lateral ou medial; inspeção com e sem carga, alinhamento em varo e valgo, trofismo e sinais flogísticos; sinal da tecla nos derrames volumosos; palpação dos mecanismos extensores e das estruturas periarticulares, com bursite pré-patelar, infrapatelar e anserina; doença de Osgood-Schlatter; movimentação ativa e passiva e o joelho recurvado até 10 graus; a exigência de comparar todo teste ligamentar com o lado contralateral pela variabilidade da elasticidade do tecido conectivo; teste de Lachman a 20 graus, teste da gaveta anterior a 90 graus e teste do pivot shift, com o estalo por volta de 30 graus; lesões meniscais com dor, bloqueio e instabilidade, dor à palpação da interlinha nas rupturas anteriores, e os testes de Smillie, marcha de pato, McMurray, Appley em compressão e distração e Steinmann; composição da cintura pélvica em coxofemoral, sacroilíaca e sínfise púbica; inspeção do equilíbrio, do alinhamento das cristas ilíacas e da marcha, e a medida do comprimento dos membros inferiores; palpação da crista ilíaca, do trocanter maior, da tuberosidade isquiática, da sínfise púbica e das espinhas ilíacas, com exame da região inguinal e dos pulsos; mobilidade passiva e ativa em flexão, extensão, adução, abdução e rotações; bursite trocantérica com piora noturna; sacroileítes e as manobras de Gaenslen e de Patrick ou Fabere, com dor posterior contralateral sugerindo sacroilíaca e dor ipsilateral sugerindo doença coxofemoral; síndrome do piriforme; disfunção do trato iliotibial; meralgia parestésica"
  - "Semiologia Clínica, 1ª ed., cap. 15 (O exame do sistema locomotor), seção Membros inferiores — divisão do membro inferior em seis segmentos; inspeção estática com postura, assimetria, inclinação da bacia, discrepância de comprimento, desvios de eixo e alterações de pele; inspeção dinâmica iniciada pela marcha; Tabela 6 (movimentos a avaliar no quadril, joelho, tornozelo e pé); Tabela 7 (palpação por segmento, com trocanter maior, espinhas ilíacas, tuberosidade isquiática, crista ilíaca, sacroilíaca posterior, artéria femoral, tendões patelar, quadricipital e da pata de ganso, epicôndilos, tíbia proximal, tuberosidade anterior da tíbia, patela, cabeça da fíbula e artéria poplítea)"
  - "Semiologia Clínica, 1ª ed., cap. 28 (Artrites e artralgias) — cisto de Baker na região poplítea entre os achados da artrite reumatoide, com sintomas compressivos e a trombose venosa profunda como diagnóstico diferencial de sua rotura; osteoartrite de joelhos, quadris e mãos"
  - "Porto — Exame Clínico, 8ª ed., cap. 19 (Exame dos Ossos, da Coluna Vertebral, das Articulações e Extremidades) — amplitudes do quadril e do joelho; joelho varo e joelho valgo, sua aparência e suas causas; encurtamento de um dos membros inferiores e suas causas; afecções mais comuns dos joelhos; os dezoito pontos dolorosos da fibromialgia, entre eles trocânteres maiores e joelhos acima da linha articular medial"
...
::: conceito
titulo: Duas juntas grandes, dois problemas opostos
texto: |
...
::: perola
texto: "Um paciente com dor no joelho merece que o quadril seja examinado antes de o joelho ser tocado. A coxofemoral é funda demais para localizar a própria dor, e projeta-a com frequência na coxa e no joelho. Rodar internamente o quadril leva cinco segundos e resolve um erro que custa meses."
:::
...
::: manobra
titulo: Exame do quadril e do joelho
passos:
  - "Comece com o paciente de pé e vestido apenas o suficiente: observe o equilíbrio, o nível das cristas ilíacas e o alinhamento dos dois membros."
  - "Peça alguns passos e observe a marcha, procurando desvio lateral do tronco, queda da hemipelve oposta e passo contralateral encurtado."
  - "Ainda em ortostase, classifique o eixo dos joelhos em normal, varo ou valgo, e compare o trofismo das coxas."
  - "Meça o comprimento dos dois membros inferiores quando houver assimetria da bacia ou suspeita de dismetria."
  ...
  - "Avalie flexão e extensão ativas e passivas do joelho, com atenção à crepitação e à hiperextensão."
...
itens:
  ...
  - "Os quatro ligamentos testados — valgo, varo, Lachman ou gaveta anterior, gaveta posterior — sempre contra o lado oposto."
  - "Oco poplíteo palpado e pulsos femoral, poplíteo e distais registrados."
:::
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none">
      <text x="10" y="16">O mesmo estresse em dois ângulos de flexão</text>
    </g>
    <path d="M 12 132 L 308 132" stroke-width="1" stroke-dasharray="4 3" />
    <path d="M 22 132 L 74 87" stroke-width="2.4" />
    <path d="M 74 87 L 112 132" stroke-width="2.4" />
    <circle cx="74" cy="87" r="5" stroke-width="1.5" />
    <path d="M 96 100 L 120 86" stroke-width="1.6" />
    <path d="M 120 86 L 113 87 M 120 86 L 116 92" stroke-width="1.6" />
    <path d="M 186 132 L 244 132" stroke-width="2.4" />
    <path d="M 244 132 L 296 113" stroke-width="2.4" />
    <circle cx="244" cy="132" r="5" stroke-width="1.5" />
    <path d="M 268 124 L 264 102" stroke-width="1.6" />
    <path d="M 264 102 L 262 109 M 264 102 L 268 108" stroke-width="1.6" />
    <g font-family="sans-serif" font-size="7" fill="currentColor" stroke="none">
      <text x="126" y="84">tíbia puxada para a frente</text>
    </g>
    <g font-family="sans-serif" font-size="7" fill="currentColor" stroke="none" text-anchor="end">
      <text x="258" y="98">tíbia puxada para a frente</text>
    </g>
    <g font-family="sans-serif" font-size="8.5" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="67" y="156">gaveta anterior</text>
      <text x="241" y="156">Lachman</text>
    </g>
    <g font-family="sans-serif" font-size="7.5" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="67" y="169">joelho a 90°, quadril fletido</text>
      <text x="67" y="180">RV 13,6 · ausente 0,4</text>
      <text x="241" y="169">joelho a 20°, quadril estendido</text>
      <text x="241" y="180">RV 19,5 · ausente 0,2</text>
    </g>
...
causas:
  ...
  - "Complicação de artroplastia de quadril por via lateral, com lesão do nervo glúteo superior ou do glúteo médio"
  - "Luxação congênita do quadril e coxa vara, em que o deslocamento do trocanter maior horizontaliza as fibras do glúteo médio"
  - "Rotura do tendão do glúteo médio, sob o rótulo clínico de bursite trocantérica"
  - "Falso-positivo por deformidade acentuada do membro, como o genu varum grave"
:::

::: conceito
titulo: A bursite trocantérica que talvez não seja bursite
texto: |
...
colunas:
  ...
  - "RV se ausente"
linhas:
  - - "Agachar provoca dor na região posterior do quadril"
    - "24%"
    - "96%"
    - "6,1"
    - "não significativa"
  - - "Abdução ou adução provoca dor na virilha"
    - "33%"
    - "94%"
    - "5,7"
    - "não significativa"
  - - "Flexão ativa do quadril provoca dor lateral"
    - "43%"
    - "88%"
    - "3,6"
    - "não significativa"
  - - "Extensão ativa do quadril provoca dor"
    - "52%"
    - "80%"
    - "2,7"
    - "0,6"
  - - "Rotação interna passiva de 25 graus ou menos"
    - "76%"
    - "61%"
    - "1,9"
    - "0,4"
  - - "Rotação interna passiva abaixo de 15 graus"
    - "39%"
    - "96%"
    - "9,9"
    - "0,6"
...
texto: |
  ...
  **A linha decisiva é a última, e ela tem um ponto de corte.** A **rotação interna passiva abaixo de 15 graus** rende razão de verossimilhança **9,9** — o maior número do exame do quadril e um dos maiores deste capítulo. Repare no contraste com a linha imediatamente acima: **rotação interna de 25 graus ou menos** rende apenas **1,9**. **O mesmo movimento, dois cortes, cinco vezes de diferença.** O corte generoso captura quase todo mundo com quadril doente — sensibilidade 76% — mas também muita gente sem doença; o corte estreito quase não erra para mais, com especificidade de 96%.
  ...
  Isso tem uma consequência de registro que vale para todo o guia: **um achado com ponto de corte precisa do valor, não do adjetivo**. "Rotação interna limitada" não permite escolher entre 1,9 e 9,9. "Rotação interna passiva de 10 graus à direita e 35 à esquerda" permite.
...
colunas:
  ...
  - "RV se ausente"
linhas:
  - - "Gaveta posterior, para rotura do cruzado posterior"
    - "90% a 95%"
    - "99%"
    - "97,8"
    - "0,1"
  - - "Sinal de Lachman, para rotura do cruzado anterior"
    - "48% a 96%"
    - "90% a 99%"
    - "19,5"
    - "0,2"
  - - "Frouxidão ao estresse em varo, para lesão do colateral lateral"
    - "25%"
    - "98%"
    - "16,2"
    - "não significativa"
  - - "Gaveta anterior, para rotura do cruzado anterior"
    - "27% a 94%"
    - "91% a 99%"
    - "13,6"
    - "0,4"
  - - "Pivot shift, para rotura do cruzado anterior"
    - "6% a 61%"
    - "95% a 99%"
    - "8,8"
    - "0,7"
  - - "Frouxidão ao estresse em valgo, para lesão do colateral medial"
    - "79% a 89%"
    - "49% a 99%"
    - "7,7"
    - "0,2"
  - - "Sinal de McMurray, para lesão meniscal"
    - "17% a 80%"
    - "77% a 98%"
    - "4,0"
    - "0,6"
  - - "Bloqueio à extensão completa, para lesão meniscal"
    - "44%"
    - "86%"
    - "3,2"
    - "0,7"
  - - "Dor à palpação da interlinha, para lesão meniscal"
    - "55% a 92%"
    - "30% a 83%"
    - "1,8"
    - "0,5"
  - - "Dor à extensão forçada, para lesão meniscal"
    - "47% a 51%"
    - "67% a 70%"
    - "1,6"
    - "0,7"
...
::: conceito
titulo: O joelho agudo — a regra de Ottawa e o que ela muda
nivel: avancado
texto: |
  ...
  **A regra, com os cinco preditores.** Indica-se radiografia se **qualquer um** estiver presente:
  ...
  2. dor à palpação da **cabeça da fíbula**;
  3. dor à palpação **isolada da patela** — isto é, sem dor óssea em nenhum outro ponto do joelho;
...
texto: |
  ...
  **Os achados isolados.**
  ...
  - **Aumento de volume ósseo palpável** — **11,8**. É o achado mais forte, e a razão é a especificidade de **95%**: osso proliferado se palpa em quem tem osteoartrite e quase em mais ninguém.
  - **Deformidade em varo** — **3,4**. E, do outro lado, a **deformidade em valgo não alcança significância**: ocorre com a mesma frequência nos dois grupos.
  - **Rigidez de menos de 30 minutos** — **3,0** quando presente e **0,2** quando ausente. É o relógio do primeiro tópico deste capítulo aparecendo com número: rigidez **acima** de 30 minutos aponta para o outro lado.
  ...
  **Um último número, de outro estudo.** Em 598 pacientes idosos com juntas dolorosas e rígidas, a **incapacidade de fletir o joelho além de 120 graus** detectou alterações radiográficas de osteoartrite com sensibilidade de 13%, especificidade de 96% e razão de verossimilhança **3,4**. É o mesmo estudo que produziu o **9,9** da rotação interna do quadril, e mostra o mesmo desenho: **amplitude com ponto de corte definido, alta especificidade, baixa sensibilidade** — um achado que confirma e não exclui.
:::

::: conceito
titulo: Onde este tópico encontra os outros
texto: |
  - **Os princípios gerais** — artralgia e artrite, padrão de acometimento, articular contra periarticular, crepitação, deformidade — estão no primeiro tópico deste capítulo.
  - **As marchas** estão em marcha e sinais meníngeos: a **antálgica** e o passo contralateral curto, a **coxálgica** com seu desvio lateral do tronco, a **marcha de Trendelenburg** com a queda da hemipelve oposta e a **anserina**. É lá que a técnica do sinal de Trendelenburg é ensinada; aqui ela é retomada pelo lado do quadril, com a desambiguação do epônimo e com o número da rotura do glúteo médio.
...
::: conceito
titulo: Seis erros no exame do quadril e do joelho
texto: |
  1. **Ler a manobra de Trendelenburg pelo lado errado.** O lado testado é **o que suporta o peso**, não o que está no ar. Inverter isso inverte o diagnóstico — e o guia usa o mesmo sobrenome em outros dois lugares, a marcha de Trendelenburg e a manobra venosa de Brodie-Trendelenburg, que nada têm em comum com esta.
  2. **Escrever "rotação interna do quadril limitada".** O ponto de corte muda tudo: **25 graus ou menos** rende 1,9; **abaixo de 15 graus**, rende 9,9. Sem o valor em graus e sem a posição em que a medida foi feita, o achado não é interpretável — e as fontes nem sequer concordam sobre o efeito da extensão do quadril na rotação.
  3. **Examinar o joelho de quem tem dor no joelho sem examinar o quadril.** A coxofemoral é profunda demais para localizar a própria dor e a projeta na coxa e no joelho. E a doença do quadril compromete **todo** o repertório de movimentos, o que a separa das causas extra-articulares.
  4. **Decidir sobre o menisco pela dor na interlinha.** É o gesto mais fácil e rende apenas **1,8**, possivelmente porque a dor ali reflete lesão da cápsula ou dos colaterais. McMurray rende 4,0 e o bloqueio à extensão, 3,2 — e nenhum dos três exclui.
  5. **Aceitar um exame ligamentar negativo feito no joelho agudo e contraído.** A sensibilidade desses sinais cai na lesão parcial, na fase aguda e no paciente tenso — a ponto de aumentar sob anestesia. Um exame negativo nessas condições pede reexame marcado, não alta.
  6. **Usar a regra de Ottawa do joelho para confirmar fratura.** Positiva, ela rende apenas **1,7**. O valor dela está no negativo, **0,1**: serve para **dispensar** a radiografia, e é para isso que foi construída.
:::
...
perguntas:
  - id: osteo-quadril-1
    enunciado: Um homem de 68 anos com dor na virilha direita tem rotação interna passiva do quadril direito de 10 graus, contra 35 graus à esquerda. Que peso esse achado tem para osteoartrite de quadril?
    alternativas:
      - "Nenhum isoladamente, porque a rotação interna depende da posição do quadril e do joelho e não foi padronizada nos estudos"
      - "Pequeno: a rotação interna reduzida rende razão de verossimilhança 1,9, valor que não altera a conduta"
  ...
  - id: osteo-quadril-2
    ...
    alternativas:
      - "Os abdutores do quadril direito, porque o lado testado é o que suporta o peso"
      - "Os abdutores do quadril esquerdo, porque o achado é a queda da hemipelve desse lado"
  ...
  - id: osteo-quadril-3
    ...
    alternativas:
      - "A gaveta anterior, porque a 90 graus os isquiotibiais ficam relaxados e não se opõem à translação da tíbia"
      - "O sinal de Lachman, porque a hemartrose impede a flexão a 90 graus exigida pela gaveta e os isquiotibiais se opõem menos a 20 graus"
  ...
  - id: osteo-quadril-6
    ...
    alternativas:
      - "Dor à palpação da tuberosidade isquiática, que confirmaria bursite isquioglútea como causa da dor lateral"
      - "Sinal e marcha de Trendelenburg presentes do lado sintomático, que sugerem rotura do tendão do glúteo médio, com razão de verossimilhança 3,2"

...
texto: |
  ...
  1. **Que forma tem esta caixa torácica?** Simetria, curvatura da coluna, relação entre os diâmetros, deformidades do esterno.
  2. **Como esta pessoa está respirando?** Que parte do corpo se move, com que amplitude, e se os dois lados se movem igual.
  3. **Quanto está custando respirar?** Tiragem, musculatura acessória, lábios semicerrados, batimento de asa do nariz.
  4. **O corpo denuncia doença pulmonar crônica?** Cianose, baqueteamento digital, circulação colateral no tórax.

  O paciente deve estar sentado sempre que possível, despido até a cintura, e o examinador circula ao redor dele. Uma parte da inspeção se faz de pé, junto ao paciente; outra, à distância, olhando o tórax de frente e de perfil contra a luz.
:::
...
::: secao
titulo: O mapa da parede torácica
:::

::: conceito
titulo: Linhas verticais e regiões
texto: |
  Descrever um achado torácico sem endereço é desperdiçá-lo. O vocabulário de referência é curto e vale memorizar.

  **Na face anterior**, quatro linhas verticais desenhadas a partir do meio: a **medioesternal**, que divide os dois hemitórax; a **esternal lateral**, rente à margem do esterno; a **hemiclavicular**, que desce do ponto médio da clavícula; e a **paraesternal**, a meio caminho entre as duas últimas.

  **Na face lateral**, três: a **axilar anterior**, que desce da prega formada pela borda inferior do peitoral maior; a **axilar posterior**, que desce da prega do grande dorsal; e a **axilar média**, equidistante das outras duas, descendo do ápice da axila.
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <!-- títulos dos dois painéis -->
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="85" y="16">face anterior</text>
      <text x="240" y="16">face posterior</text>
    </g>
    <!-- painel A: parede torácica anterior -->
    <path d="M 45 26 C 41 62, 47 112, 58 158 L 112 158 C 123 112, 129 62, 125 26" stroke-width="2" />
    <path d="M 50 34 L 80 41" stroke-width="1.5" />
    <path d="M 90 41 L 120 34" stroke-width="1.5" />
    <path d="M 80.5 43 L 89.5 43 L 89.5 108 L 85 120 L 80.5 108 Z" stroke-width="1.2" />
    <g stroke-width="1.2">
      <path d="M 90 54 C 104 56, 114 62, 121 72" />
      <path d="M 90 70 C 104 72, 115 80, 122 92" />
      <path d="M 90 86 C 104 89, 115 98, 121 112" />
      <path d="M 90 102 C 103 106, 112 116, 117 130" />
    </g>
    <!-- linhas verticais anteriores -->
    <g stroke-width="1.5" stroke-dasharray="5 4">
      <path d="M 85 24 L 85 162" />
      <path d="M 105 36 L 105 160" />
      <path d="M 119 44 L 119 152" />
    </g>
    <g font-family="sans-serif" font-size="9.5" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="85" y="172">1</text>
      <text x="105" y="172">2</text>
      <text x="121" y="172">3</text>
    </g>
    <!-- painel B: parede torácica posterior -->
    <path d="M 200 26 C 196 62, 202 112, 213 158 L 267 158 C 278 112, 284 62, 280 26" stroke-width="2" />
    <!-- escápulas -->
    <g stroke-width="1.2">
      <path d="M 212 46 L 234 50 L 226 88 Z" />
      <path d="M 268 46 L 246 50 L 254 88 Z" />
    </g>
    <!-- processos espinhosos -->
    <g stroke-width="1.2">
      <path d="M 236 36 L 244 36" />
      <path d="M 236 54 L 244 54" />
      <path d="M 236 72 L 244 72" />
      <path d="M 236 90 L 244 90" />
      <path d="M 236 108 L 244 108" />
      <path d="M 236 126 L 244 126" />
    </g>
    <!-- linhas verticais posteriores -->
    <g stroke-width="1.5" stroke-dasharray="5 4">
      <path d="M 240 24 L 240 162" />
      <path d="M 254 42 L 254 160" />
    </g>
    <g font-family="sans-serif" font-size="9.5" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="240" y="172">4</text>
      <text x="256" y="172">5</text>
    </g>
    <!-- legenda -->
    <g font-family="sans-serif" font-size="9" fill="currentColor" stroke="none">
      <text x="16" y="188">1 medioesternal</text>
      <text x="102" y="188">2 hemiclavicular</text>
      <text x="196" y="188">3 axilar anterior</text>
      <text x="16" y="198">4 vertebral</text>
      <text x="102" y="198">5 escapular</text>
    </g>
  </svg>
legenda: "As linhas verticais de referência. Na face anterior ficam ainda a esternal lateral e a paraesternal, entre 1 e 2; na face lateral, as axilares média e posterior, atrás de 3."
:::

::: entendimento
titulo: Onde os pulmões realmente estão
texto: |
  ...
  A consequência prática é direta: quem ausculta o dorso parando na ponta da escápula deixa de examinar boa parte dos lobos inferiores. O ângulo inferior da escápula é o começo do território das bases, não o fim.
:::
...
passos:
  ...
  - "Observe se o paciente expira com os lábios semicerrados e se há batimento das asas do nariz."
...
::: checklist
titulo: Inspeção do tórax em 10 passos
itens:
  - "Paciente sentado, tórax descoberto, examinador circulando ao redor."
  - "Inspeção estática: simetria dos hemitórax, forma do tórax e curvatura da coluna."
  - "Registro de cicatrizes, abaulamentos, retrações localizadas e lesões de pele."
  - "Tipo respiratório definido pela região que mais se move (costal ou diafragmático)."
  - "Comparação da amplitude dos movimentos entre os dois hemitórax."
  - "Pesquisa de tiragem intercostal, supraclavicular, supraesternal e epigástrica."
  - "Inspeção do pescoço para uso de escalenos e esternocleidomastóideos na inspiração."
  - "Pesquisa de respiração com lábios semicerrados e de batimento das asas do nariz."
  - "Pesquisa de movimento abdominal paradoxal com o paciente em decúbito dorsal."
  - "Pesquisa de cianose em lábios, língua e mucosa oral, e de baqueteamento digital."
:::

::: secao
titulo: A forma do tórax
:::
...
::: tabela
titulo: Formas do tórax e o que sugerem
colunas:
  - "Forma"
  - "O que se vê"
  - "Contextos habituais"
linhas:
  - - "Chato ou plano"
    - "Parede anterior perde a convexidade e o diâmetro anteroposterior diminui; costelas mais oblíquas, espaços intercostais estreitos, escápulas salientes"
    - "Longilíneos; alguns pacientes com doença pulmonar crônica"
  - - "Em tonel ou globoso"
    - "Diâmetro anteroposterior cresce até quase igualar o transversal; arcos costais horizontalizados e dorso curvado, o que encurta o tórax"
    - "Enfisema pulmonar; esboça-se também no envelhecimento normal, sem prejuízo funcional"
  - - "Infundibuliforme (pectus excavatum)"
    - "Depressão do terço inferior do esterno e da região epigástrica"
    - "Em geral congênito; borra o contorno do átrio direito na radiografia e pode simular lesão do lobo médio"
  - - "Cariniforme (pectus carinatum)"
    - "Esterno proeminente e costelas horizontalizadas, no formato do peito de uma ave"
    - "Congênito ou sequela de raquitismo; não compromete a função pulmonar"
  - - "Em sino ou cônico"
    - "Alargamento exagerado da porção inferior do tórax"
    - "Hepatoesplenomegalias e ascite volumosa"
  - - "Cifótico"
    - "Curvatura posterior da coluna torácica, formando gibosidade"
    - "Postura, mal de Pott, osteomielite, neoplasias"
  - - "Cifoescoliótico"
    - "Cifose somada a desvio lateral da coluna"
    - "Formas leves são comuns e sem significado; formas acentuadas restringem a expansão torácica"
:::
...
texto: |
  ...
  Conclusão prática: registre o achado, mas não o transforme em diagnóstico. Ele vale como peça de um conjunto, ao lado da hipersonoridade, dos estertores protoinspiratórios e da redução do murmúrio vesicular.
:::

::: secao
titulo: A dinâmica da respiração
:::

::: conceito
titulo: Tipo respiratório
texto: |
...
causas:
  ...
  - "Tiragem bilateral por estreitamento difuso dos pequenos brônquios: crise de asma, enfisema"
  - "Tiragem localizada: atelectasia do território subjacente"
:::
...
texto: |
  ...
  Muitos pacientes com obstrução crônica descobrem sozinhos que **expirar com os lábios semicerrados** alivia a dispneia. A manobra reduz a frequência respiratória, aumenta o volume corrente e cria uma pequena pressão positiva expiratória contra o colapso das vias aéreas. Outro alívio instintivo é **inclinar-se para a frente apoiando os braços**, o que comprime o conteúdo abdominal e empurra o diafragma de volta à forma de cúpula, mais eficiente para inspirar.
:::
...
::: conceito
titulo: Paradoxo costal, respiração assíncrona e movimento abdominal paradoxal
nivel: avancado
texto: |
  Três padrões parecidos e frequentemente confundidos. O que os separa é *o que* se move ao contrário e *quando*.
...
nivel: avancado
texto: |
  A inspeção detecta desigualdade antes de a radiografia mudar. No início de muitas pleuropneumopatias, os movimentos respiratórios perdem a simetria: um hemitórax se move menos, ou fica imóvel, e essa imobilidade aponta a lesão subjacente. Quando os dois hemitórax estão parados, pense em espondilite anquilosante.

  Alguns achados localizados têm nome próprio e valem o olhar.
...
titulo: Cianose
texto: |
  Cianose é a cor azulada da pele e das mucosas produzida por sangue azul circulando nos capilares e vênulas superficiais. Quase sempre o pigmento responsável é a desoxi-hemoglobina.
...
::: sinal
nome: Baqueteamento digital (hipocratismo digital)
descricao: |
  Alargamento indolor do tecido conjuntivo das falanges terminais, em geral simétrico e mais evidente nas mãos do que nos pés. Três definições se sustentam em dados.

  - **Razão de profundidade interfalangiana maior que 1**: compara-se a espessura do dedo na junção entre a unha e a pele com a espessura na articulação interfalangiana distal. Em pessoas normais essa razão gira em torno de 0,9.
...
texto: |
  1. **Inspecionar apenas de frente.** A face posterior é onde os pulmões têm mais território e onde a assimetria de movimentos aparece melhor. Se o paciente pode sentar, olhe o dorso.
  2. **Olhar só a forma e esquecer a dinâmica.** A forma do tórax é um dado de moldura; o esforço respiratório é um dado de gravidade. Um tórax perfeitamente normal com tiragem e escalenos contraídos é muito mais grave do que um tórax em tonel tranquilo.
  3. **Concluir doença obstrutiva a partir do tórax em tonel.** O achado é pouco discriminante, aparece em idosos saudáveis e pode ser ilusão de contraste com um abdome magro.
  4. **Procurar movimento abdominal paradoxal com o paciente sentado.** O sinal depende do peso das vísceras e costuma sumir na posição ereta. Examine em decúbito dorsal.
  5. **Tranquilizar-se com a ausência de cianose.** No anêmico, a cianose só surge com hipoxemia profunda. Pele rosada não é sinônimo de oxigenação adequada.
:::
...
perguntas:
  - id: insp-torax-1
    enunciado: Um paciente é examinado em decúbito dorsal e, a cada inspiração, o tórax se expande enquanto a parede abdominal afunda. Qual é a interpretação?
    alternativas:
  ...
  - id: insp-torax-3
    ...
    alternativas:
      - "Obstáculo acima da bifurcação traqueal"
      - "Estreitamento difuso dos pequenos brônquios dos dois pulmões"
  ...
  - id: insp-torax-4
    ...
    corretaIndex: 1
    explicacao: "A impressão global de tórax em tonel eleva pouco a probabilidade de obstrução (razão de verossimilhança em torno de 1,5) e a razão anteroposterior/transversal ≥ 0,9 chega a 2,0. O índice torácico normal do adulto fica entre 0,70 e 0,75, com limite superior próximo de 0,9. O achado também aparece no envelhecimento e, em parte dos pacientes, é apenas o contraste entre um tórax de dimensão normal e um abdome emagrecido."
  - id: insp-torax-5

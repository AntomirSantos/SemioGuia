...
tags:
  ...
  - estação OSCE
referencias:
  - "Porto — Semiologia Médica, 8ª ed., Parte 3, cap. 6 (Anamnese) — Queixa principal ou motivo da consulta; História da doença atual: normas para se obter uma boa HDA, sintoma-guia, esquema para análise de um sintoma (Quadro 6.3)"
  - "Porto — Semiologia Médica, 8ª ed., Parte 4, cap. 9 (Dor | Definição, Fisiopatologia e Características Semiológicas) — Características semiológicas da dor: localização, irradiação, intensidade e escalas (Figura 9.10), duração, evolução, relação com funções orgânicas, fatores desencadeantes e agravantes, manifestações concomitantes"
  - "Porto — Exame Clínico, 8ª ed., cap. 4 (Anamnese) — Queixa principal; História da doença atual: normas fundamentais, sintoma-guia, esquema para análise de um sintoma (Quadro 4.2)"
...
::: conceito
titulo: Duas peças que se encaixam
texto: |
...
::: perola
texto: "Uma HDA sem cronologia não é uma história — é uma lista. A ordem em que os sintomas apareceram costuma carregar mais informação diagnóstica do que a soma deles."
:::

::: secao
titulo: A queixa principal
:::
...
::: tabela
titulo: Queixa principal — o que escrever e o que não escrever
colunas:
  - "O paciente diz"
  - "Registro inadequado"
  - "Registro adequado"
linhas:
  - - "\"Estou com uma dor de cabeça horrível desde ontem\""
    - "Enxaqueca"
    - "Dor de cabeça há 1 dia"
  - - "\"Meu problema é pressão alta\""
    - "Hipertensão arterial"
    - "O sintoma que aparece ao esclarecer o rótulo (por exemplo, cefaleia occipital há 3 meses) ou, se não houver sintoma, o motivo real da consulta"
  - - "\"Saiu sangue quando fui ao banheiro\""
    - "Hemorroidas"
    - "Sangramento anal há 2 semanas"
  - - "\"O doutor do posto mandou eu vir por causa deste exame\""
    - "Anemia"
    - "Encaminhado para avaliação de alteração em exame laboratorial"
  - - "\"Doutor, eu tenho tosse, dor nas pernas, insônia e azia\""
    - "Múltiplas queixas"
    - "A queixa que ele identifica como a que mais o incomoda, com a duração; as demais entram na HDA ou no interrogatório"
:::
...
::: manobra
titulo: Construção da história da doença atual
passos:
  - "Permita que o paciente fale livremente sobre a doença antes de qualquer pergunta dirigida."
  - "Identifique o sintoma-guia — na dúvida, a queixa de mais longa duração, a mais salientada por ele ou a própria queixa principal."
  - "Estabeleça a época de início desse sintoma: quando o senhor começou a sentir isso?"
  - "Se a memória falhar, ancore a data em eventos que não se esquecem — casamento, gravidez, mudança de casa, um acidente."
  - "Caracterize o sintoma-guia item por item, sem pular nenhum atributo do esquema."
  - "Investigue como o sintoma evoluiu desde o início: o que mudou, quando mudou e em que sentido."
  - "Articule as demais queixas ao sintoma-guia, em ordem cronológica, explicitando as relações entre elas."
  - "Apure os exames e tratamentos já realizados por causa deste quadro, e o que aconteceu depois deles."
  - "Pergunte como o sintoma está agora, no momento da entrevista."
...
::: checklist
titulo: Queixa principal e HDA em 10 passos
itens:
  - "Queixa principal registrada nas palavras do paciente, com duração e sem rótulo diagnóstico."
  - "Narrativa livre permitida antes de qualquer pergunta dirigida."
  - "Sintoma-guia explicitamente identificado."
  - "Época de início estabelecida, ancorada em evento memorável quando a data exata falhar."
  - "Sintoma-guia caracterizado em todos os atributos do esquema, sem omissões."
  - "Intensidade avaliada com escala nomeada, e não por adjetivo isolado."
  - "Evolução do sintoma desde o início até hoje descrita, incluindo mudanças de padrão."
  - "Demais queixas articuladas ao sintoma-guia em ordem cronológica."
  - "Exames e tratamentos já realizados para este quadro apurados, com o resultado de cada um."
  - "Situação atual e impacto na funcionalidade registrados, e resumo devolvido ao paciente."
:::

::: secao
titulo: O sintoma-guia
:::
...
::: entendimento
titulo: Por que ancorar datas em eventos
texto: |
...
linhas:
  - - "Início"
    - "Época de aparecimento; se foi súbito ou gradativo; se houve fator desencadeante"
  - - "Características do sintoma"
    - "Localização, duração, intensidade, frequência e tipo — ou seja, os atributos próprios daquele sintoma"
  - - "Fatores de melhora ou piora"
    - "O que alivia e o que agrava: posição, ambiente, esforço ou repouso, alimentos, tratamentos já usados"
  - - "Relação com outras queixas"
    - "Manifestações que acompanham o sintoma, em geral ligadas ao segmento anatômico ou funcional acometido"
  - - "Evolução"
    - "Como o sintoma se comportou ao longo do tempo, incluindo mudanças de característica e influência dos tratamentos"
  - - "Situação atual"
    - "Como o sintoma está no momento da anamnese"
:::
...
svg: |
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <!-- núcleo -->
    <rect x="126" y="86" width="68" height="30" rx="9" stroke-width="1.8" />
    <g font-family="sans-serif" font-size="10" fill="currentColor" stroke="none" text-anchor="middle">
      <text x="160" y="105">o sintoma</text>
    </g>
    <!-- raios -->
    <g stroke-width="1.3">
      <path d="M 160 86 L 160 40" />
      <path d="M 132 89 L 74 58" />
      <path d="M 126 101 L 70 101" />
      <path d="M 132 113 L 74 144" />
      <path d="M 188 89 L 246 58" />
      <path d="M 194 101 L 250 101" />
      <path d="M 188 113 L 246 144" />
      <path d="M 148 116 L 112 164" />
      <path d="M 172 116 L 208 164" />
    </g>
    <!-- rótulos -->
    <g font-family="sans-serif" font-size="8.5" fill="currentColor" stroke="none">
      <text x="160" y="34" text-anchor="middle">início</text>
      <text x="70" y="54" text-anchor="end">localização</text>
      <text x="66" y="104" text-anchor="end">irradiação</text>
      <text x="70" y="150" text-anchor="end">qualidade</text>
      <text x="250" y="54">intensidade</text>
      <text x="254" y="104">duração</text>
      <text x="250" y="150">evolução</text>
      <text x="104" y="176" text-anchor="middle">melhora e piora</text>
      <text x="216" y="176" text-anchor="middle">sintomas associados</text>
    </g>
    <!-- fecho -->
...
texto: |
  ...
  - **Ritmicidade** — variação de intensidade dentro de um mesmo dia. O exemplo clássico é a úlcera duodenal, cuja dor segue o ciclo dói–come–passa, porque o alimento tampona o efeito do ácido clorídrico.
...
texto: |
  ...
  A escolha entre as três não se faz na hora de perguntar; faz-se depois, com a história inteira na mão. Na hora de perguntar, o trabalho é outro: caracterizar cada uma como se fosse a única.

  O mesmo raciocínio se aplica a sintomas não dolorosos que aparecem juntos. A pergunta que costuma desatar o nó é temporal: **qual apareceu primeiro?** Um edema que precede a dispneia conta uma história diferente de uma dispneia que precede o edema, ainda que o paciente relate os dois "há uns dois meses".
:::

::: conceito
titulo: O paciente crônico que agudizou
nivel: avancado
texto: |
  Este é o cenário em que a HDA mais frequentemente descarrila. O paciente convive com um sintoma há anos, procurou o serviço hoje, e a história sai como uma repetição do prontuário antigo.

  A saída é escrever **duas cronologias sobrepostas**.
...
::: secao
titulo: Armadilhas da HDA
:::

::: conceito
titulo: Cinco erros que arruínam uma boa história
texto: |

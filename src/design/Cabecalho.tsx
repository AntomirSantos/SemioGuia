...
// (44pt, acessível) + título display. `cor` permite tingir o botão com o
// acento do sistema (ex.: sistema.cor); sem ela usa o acento do tema.
export function Cabecalho({ titulo, aoVoltar, cor }: { titulo: string; aoVoltar: () => void; cor?: string }) {
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: espaco.l }}>
      ...
      >
        <ChevronLeft size={22} color={acento} />
      </Pressable>
      <Text

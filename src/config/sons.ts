...
export const FONTES_DE_SOM = {
  ...
  'som-traqueal': require('../../assets/sons/som-traqueal.wav'),
  'som-bronquico': require('../../assets/sons/som-bronquico.wav'),
  'som-broncovesicular': require('../../assets/sons/som-broncovesicular.wav'),
...
export const ORIGEM_DE_SOM: Record<ChaveDeSom, 'sintetizado' | 'gravacao'> = {
  ...
  'som-traqueal': 'sintetizado',
  'som-bronquico': 'sintetizado',
  'som-broncovesicular': 'sintetizado',

...
2. **Valores pediátricos sem âncora**: o caso da febre usa FC 168 a 174 bpm e
   FR 44 a 48 irpm numa criança de 3 anos; os tópicos aprovados só trazem
...
5. **Ajustes menores sugeridos pela revisão médica** (não aplicados para não
   ...
   edema agudo (~110 a 120 seria mais típico); menção a UTI/VNI no desfecho
...
6. **Faixa 37,6 a 37,8 °C ambígua**: a tabela de intensidade mantém
   ...
   criança SBP ≥37,5, estado febril 37,3 a 37,5). Harmonizar na revisão.
...
14. **Escala de intensidade de sopros**: Levine 1 a 6 (McGee/Semiologia
...
15. **Política para divergências entre as próprias referências**: hoje o
    ...
    palpabilidade do ictus (Porto ~70% × McGee 25 a 40% supino), ictus do

...
- **L6** (resolvido): Runs herdados da Fase 7 no abdome agudo
- **O8** (resolvido): Runs herdados em cranio-e-face

## Por sistema

### Anamnese — 4/4 aprovados

- [x] A entrevista clínica (`anamnese/entrevista-clinica/a-entrevista-clinica`)
...
- [x] Pressão arterial (`exame-fisico-geral/sinais-vitais/pressao-arterial`)
- [x] Frequência cardíaca e pulso (`exame-fisico-geral/sinais-vitais/frequencia-cardiaca-e-pulso`)
- [x] Temperatura e frequência respiratória (`exame-fisico-geral/sinais-vitais/temperatura-e-frequencia-respiratoria`)
- [x] Ectoscopia (`exame-fisico-geral/avaliacao-geral/ectoscopia`)
- [x] Antropometria e hidratação (`exame-fisico-geral/avaliacao-geral/antropometria-e-hidratacao`)

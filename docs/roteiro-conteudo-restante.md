...
integralmente: **só se escreve o que as fontes ancoram**.

## O que a biblioteca sustenta
...
nenhuma das outras três obras. Escrever um capítulo obstétrico com essa
base violaria o padrão de ancoragem múltipla que o guia mantém desde a
Fase 5. **Recomendação: deixar fora**, e reavaliar caso o autor
acrescente à biblioteca uma obra obstétrica de referência (Rezende ou
Zugaib). O mesmo vale, em menor grau, para a semiologia pediátrica: dá
para escrever um capítulo curto e honesto sobre as particularidades do
exame da criança, mas não um capítulo de puericultura.
...
Ordem final dos sistemas na home (crânio-caudal, com o psíquico ao
lado do nervoso e a criança por último):

anamnese · exame físico geral · cabeça e pescoço · cardiovascular ·
respiratório · abdome · vascular periférico · **osteoarticular** ·
**mamas e geniturinário** · nervoso · **psíquico** · **criança**

Ao fim da Fase 15 o guia terá cerca de **55 tópicos**, e só então o
autor faz a revisão médica em uma passada única, como pediu.

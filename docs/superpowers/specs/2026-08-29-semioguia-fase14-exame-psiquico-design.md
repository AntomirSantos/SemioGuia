...
## 3. Tópicos (capítulo único, ordem 1 a 4)
...
3. `escalas-cognitivas-a-beira-do-leito`, PAGA A DÍVIDA: miniexame do
   ...
   forca-tonus:96) com o que o McGee der; o kappa 0,28 a 0,80 do MEEM já
...
O consolidado (Fases 5 a 13). Notas específicas:
...
- Quiz 6/tópico = 24 no capítulo, corretaIndex 6/6/6/6, mais-longa
  ...
  por tópico; 3 a 6 avançados; ≥2 ilustrações (candidatas: mapa das

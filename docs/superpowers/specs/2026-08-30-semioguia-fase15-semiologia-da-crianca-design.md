...
na criança; o checklist C4 registra FC 168 a 174 e FR 44 a 48 do caso
...
O consolidado (Fases 5 a 14). Notas:
- **Fontes**: Porto SM Parte 20, cap. 179 Semiologia da Infância
  ...
  2×; o texto diz isso ao leitor, precedente das fases 12 a 14).
...
- Sem fármacos/doses; sem calendário vacinal (moldura nomeada); sem
  ...
  datada com data.
- Quiz 6/tópico = 18, corretaIndex 4 a 5 por índice (~18/4), mais-longa
  ≈25% (4 a 5/18) espalhada; checklist 10 itens ×3; avançados 3 a 6;

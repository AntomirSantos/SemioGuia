...
### Anamnese · A entrevista clínica (ordem 1–4)
...
### Exame físico geral · Avaliação geral (ordem 1–4)
...
- Por tópico: 1 `checklist` (vira estação OSCE — na anamnese, o roteiro da
  entrevista/HDA é a estação), quiz 4–6 perguntas com `explicacao`, 3–6
...
- Âncoras: Porto — Semiologia Médica 8ª (Partes 1–3 e caps. de anamnese,

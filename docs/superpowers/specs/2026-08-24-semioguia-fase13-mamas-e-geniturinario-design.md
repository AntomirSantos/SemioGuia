...
### Capítulo 1 · Exame das mamas (ordem 1 a 2)
...
### Capítulo 2 · Exame geniturinário e retal (ordem 1 a 3)
...
O consolidado (Fases 5 a 12). Notas específicas desta fase:
...
- Quiz 6/tópico. Balanço por capítulo: mamas 12 questões (~3 por
  índice), GU 18 (4 a 5 por índice); mais-longa ≈25% em cada capítulo.
  1 checklist de 10 itens por tópico; 3 a 6 avançados; ≥3 ilustrações no

...
### Sistema nervoso · Exame neurológico (ordem 1–6)
...
4. `forca-tonus-e-reflexos` — inspeção e trofismo, tônus (hipotonia,
   ...
   graduação 0–5 e manobras deficitárias (Mingazzini/braços estendidos),
...
O consolidado (Fases 5–9): seções "O essencial" → técnica com
...
referências posicionais; 3–6 avançados/tópico; ≥4 ilustrações no

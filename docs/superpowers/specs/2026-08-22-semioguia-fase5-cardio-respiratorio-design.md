...
3. `sopros-cardiacos`: mecanismo, classificação (sistólicos ×
   ...
   (Levine 1 a 6), irradiação, manobras dinâmicas (Rivero-Carvallo,
...
- Cada tópico: 1 `checklist` (vira estação OSCE), quiz com 4 a 6 perguntas
  (alimenta o SM-2), 3 a 6 blocos `nivel: avancado`, `perola` onde couber.

...
### Sistema osteoarticular · Exame osteoarticular (ordem 1 a 6)
...
O consolidado (Fases 5 a 11), com **uma correção registrada em pleno voo**:
...
balanceado (nenhum índice >~12/36) e resposta-mais-longa ≈25%; 3 a 6
...
graduação 0 a 5 → força, tônus e reflexos; sensibilidade do pé e

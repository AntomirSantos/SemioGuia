...
### Sistema vascular periférico · Exame vascular periférico (ordem 1 a 4)
...
O consolidado (Fases 5 a 10): seções "O essencial" → "Como examinar" com
...
base, sem referências posicionais; 3 a 6 avançados/tópico; ≥3 ilustrações

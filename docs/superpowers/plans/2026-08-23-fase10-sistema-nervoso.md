...
- As das Fases 5–9 + spec §4 desta fase.
...
### Task 2: Tópicos 1–3 (consciência, pares I–VI, pares VII–XII)
...
### Task 3: Tópicos 4–6 (força/tônus/reflexos, sensibilidade/coordenação, marcha/meníngeos)

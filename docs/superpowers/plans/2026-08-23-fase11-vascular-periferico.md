...
- As das Fases 5–10 + spec §4 desta fase.
...
**Review: revisão médica independente (opus) + re-revisão escopada, critérios das Fases 5–10 (hostilidade a lateralidade/direção, cada número conferido na fonte, divergências atribuídas dos dois lados, promessas e cruzadas verificadas nas duas pontas).**

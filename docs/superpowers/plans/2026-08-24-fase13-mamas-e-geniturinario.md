...
- As das Fases 5 a 12 + spec §4. Em especial: profissionalismo dos exames íntimos como conteúdo ancorado; não forçar números (McGee sem capítulo de mamas/genital/retal, varredura corrigida); `pdftotext -layout` para tabelas; offset PDF↔impresso do McGee varia por capítulo, mapear antes de citar página; barra de originalidade em **zero runs ≥9 palavras** (N=10 e N=9).
